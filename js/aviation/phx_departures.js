phx_departures = function (arvl = "XXX", tail = null, ac_type = null, result = "") {
	switch(arvl) {
		...
		case "CLT": // PHX-CLT // Updated 11-08-2025
			...
			result += "<br/><br/>NRP: <input style=\"width:75%\"; value=\"KPHX BROAK1 MAXXO TCC J6 IRW FSM ARG J46 BNA TAZZA FILPZ4 KCLT\" readonly>";
			result += "<br/><b>Fkeys tries to cut thru ZKC- Use IRW to stay south of ZKC<\/b>";
			...
			result += "<br/>ST<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHX STRRM1 TUS J2 ELP J50 ABI J4 FUZ J42 TXK J52 SUTTN IZAAC Q30 VLKNN THRSR BESTT JONZE5 KCLT\" readonly>";
