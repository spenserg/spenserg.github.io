...
KCLT BOBZY5 BNA MEM FSM IRW TCC KIIDD COLTR4 KABQ
KCLT BOBZY5 BNA MEM J66 LIT J6 TCC KIIDD COLTR4 KABQ
...
*/
		...
		case "ALB": // Updated 05-07-2025 // Mandatory Routes checked
			...
			break;
		case "ATL": // Updated 04-19-2025 // Mandatory Routes checked
		...
		case "AUS": // Updated 02-21-2025
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCLT BOBZY BRAYN GQO DEVAC GAGLE ELD LFK WEEED WLEEE7 KAUS\" readonly>";
		...
		case "BNA": // Updated 01-28-2025
			...
			result += "<br/><br/><b>CDRS</b> Updated: 05-14-2025"; // Verified with ATCSCC on 05-14-2025
			result += "<!-- Verified with ATCSCC on 05-14-2025 -->";
			...
			break;
		case "BOS": // Updated 04-19-2025 // Mandatory Routes checked
			result += "<!-- Updated 04-19-2025 M -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "BUF": // Updated 07-30-2025
			...
			break;
		case "BWI": // Updated 05-27-2025 // Mandatory Routes checked
		...
		case "DEN": // Updated 02-01-2025
			result += "<!-- Updated 02-01-2025 -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KCLT BOBZY5 BNA FAM J112 BUM J110 GCK KIISS CLASH5 KDEN\" readonly>";
			result += "<br/><br/>North: <input style=\"width:75%\" value=\"KCLT JOJJO5 CUBIM EWO PXV FTZ MCI IKUME BRWRY LAWGR4 KDEN\" readonly>";
			result += "<br/>South: <input style=\"width:75%\" value=\"KCLT ESTRR5 IPTAY CHOPZ THRSR VLKNN KM24I KF27E KF30C MMB TOTOE HALEN NIIXX4 KDEN\" readonly>";
			result += "<br/><br/>GCK: <input style=\"width:75%\" value=\"KCLT ESTRR5 IPTAY CHOPZ THRSR VUZ J14 PNH ZIGEE NIIXX4 KDEN\" readonly>";
			result += "<br/>PNH: <input style=\"width:75%\" value=\"KCLT ESTRR5 IPTAY CHOPZ THRSR VUZ J14 PNH ZIGEE NIIXX4 KDEN\" readonly>";
			result += "<br/>TUL 1: <input style=\"width:75%\" value=\"KCLT BOBZY5 BNA J46 TUL GCK KIISS CLASH5 KDEN\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KCLT BNA FAM J112 BUM J110 GCK DANDD1 KDEN\" readonly>";
			result += "<br/><br/><b>CDRS</b>";
			result += "<br/>BE (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLT BEAVY6 GANDT DBN MGMRY MEM RZC PER GCK KIISS CLASH5 KDEN\" readonly>";
			result += "<br/>ES (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLT ESTRR5 IPTAY CHOPZ THRSR VLKNN Q116 SGF BUM J110 GCK KIISS CLASH5 KDEN\" readonly>";
			result += "<br/>JJ (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLT JOJJO5 CUBIM IIU J112 BUM J110 GCK KIISS CLASH5 KDEN\" readonly>";
			result += "<br/>RP (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLT BOBZY5 BNA FAM J112 BUM J110 GCK KIISS CLASH5 KDEN\" readonly>";
			result += "<br/>WE (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLT WEAZL5 CLAWD HVQ IIU J112 BUM J110 GCK KIISS CLASH5 KDEN\" readonly>";
			break;
		case "DFW": // Updated 06-03-2025
		...
		case "FLL": // Updated 02-01-2025
			...
			result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KCLT KER4 TREAL SAV OMN GISSH5 KFLL\" readonly>";
			result += "<br/><br/><b>CDRS</b>";
...
// GRB skipped			
		...
		case "IAD": // Updated 02-06-2025
			...
			break;
		case "IAH": // Updated 06-03-2025 // Mandatory Routes checked
			result += "<!-- Updated 06-03-2025 MP -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
...
/* TODO - FOS ROUTES: KCLT - KJAC
KCLT JOJJO5 DOOGE IIU J8 STL J24 MCI TKO LEWOY Q148 JUGIV DNW KJAC
KCLT JOJJO5 DOOGE Q93 OCASE BDF MCW J16 FSD J82 RAP JYMBO DNW KJAC
KCLT JOJJO5 DOOGE IIU J8 STL J151 RAP JYMBO DNW KJAC
KCLT JOJJO5 DOOGE IIU J8 STL J24 MCI TKO LEWOY Q148 JUGIV IDECA VUGUY KJAC
KCLT BOBZY5 BNA SGF ICT HYS HLC SNY DDY JYMBO DNW KJAC
KCLT JOJJO5 DOOGE IIU J8 STL J24 MCI J80 CUGGA Q148 MBW CKW DNW KJAC
KCLT JOJJO5 CUBIM Q50 IIU J89 OBK J90 MCW J16 FSD J82 RAP JYMBO DNW KJAC
KCLT BOBZY5 BNA Q36 RZC ICT J28 GCK HGO J52 FQF CKW DNW KJAC
KCLT BOBZY5 BNA Q36 RZC PER TOTOE LAA J52 FQF CKW DNW KJAC
*/
...
// CLT-JAN skipped
		...
		case "LAS": // Updated 06-29-2025
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCLT JOJJO5 DOOGE FLM J24 VHP J80 GLD J146 HBU J28 HVE GGAPP CHOWW3 KLAS\" readonly>";
			...
			result += "<br/>North/ZKC Avoid<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCLT JOJJO5 DOOGE FLM J24 VHP RBS LEONG Q114 BUGGG GGAPP CHOWW3 KLAS\" readonly>";
		...
		case "LAX": // Updated 07-07-2025
			...
			result += "<br/>South via IAH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KCLT ESTRR5 IPTAY CHOPZ MGMRY CATLN Q22 GUSTI Q56 HRV J2 IAH J86 ELP J50 SSO J4 WLVRN ESTWD HLYWD1 KLAX\" readonly>";
		...
		case "LEX": // Updated 02-06-2025
			...
			// result += "<br/><br/><b>CDRS</b>";
			break;
		case "LGA": // Updated 04-29-2025 // Mandatory Routes checked
...
// MLI SKIPPED
		...
		case "ORF": // Updated 09-11-2025
			...
			break;
		case "PBI": // Updated 06-03-2025 // Mandatory Routes checked
			result += "<!-- Updated 06-03-2025 MP -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
...
// CLT-PSM skipped
		...
		case "PVD": // Updated 05-10-2025 // Mandatory Routes checked
...
// CLT-SHV skipped
		...
		case "TLH": // Updated 02-06-2025
			...
			break;
		case "TPA": // Updated 05-07-2025 // Mandatory Routes checked
			result += "<!-- Updated 05-07-2025 MP -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "TUL": // Updated 09-17-2025
			...
			break;
		case "TYS": // Updated 4-16-2025
			result += "<!-- Updated 4-16-2025 -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL260):</b>";
			...
			break;
		case "VPS": // Updated 05-10-2025 // Mandatory Routes checked
			result += "<!-- Updated 05-10-2025 MP -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/>South: <input style=\"width:75%\" value=\"KCLT BEAVY6 JENDO WADEB TAY SZW CORKY KVPS\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
