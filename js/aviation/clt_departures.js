clt_departures = function (arvl = "XXX", tail = null, ac_type = null, result = "") {
	switch(arvl) {
		...
		case "AUS": // Updated 02-21-2025
			...
			result += "<br/>South/ZTL Avoid<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCLT ICONS5 NOOKS CAE SAV AMG DEFUN J2 LCH Q24 MOLLR DBOYS WLEEE7 KAUS\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
		...
		case "CLE": // Updated 02-01-2025
			...
			break;
		case "CMH": // Updated 04-28-2025 // Mandatory Routes checked
...
// GRB skipped			
		...
		case "IAH": // Updated 06-03-2025 // Mandatory Routes checked
			...
			result += "<br/>JJ<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLT JOJJO5 CUBIM BWG LIT DHART SWB ZEEKK3 KIAH\" readonly>";
			...
			result += "<br/>WE<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLT WEAZL5 CLAWD ZIEBR YOCKY Q68 LITTR DHART SWB ZEEKK3 KIAH\" readonly>";
			break;
...
// CLT-PSM skipped
		...
		case "RSW": // Updated 02-06-2025
			...
			result += "<br/><br/>East/OW: <input style=\"width:75%\" value=\"KCLT KWEEN5 PITRW Y436 OGGRE AR17 HIBAC SHFTY6 KRSW\" readonly>";
...
// CLT-SHV skipped
		...
		case "SLC": // Updated 05-01-2025 // Mandatory Routes checked
			...
			result += "<br/><br/>South: <input style=\"width:75%\" value=\"KCLT JOJJO5 DOOGE FLM J24 VHP BRL OVR OBH BFF J94 OCS CARTR1 KSLC\" readonly>";
			...
			result += "<br/>EWM 1: <input style=\"width:75%\" value=\"KCLT ESTRR5 IPTAY CHOPZ THRSR VLKNN Q30 IZAAC SUTTN EIC J4 ABI J66 EWM DMN GREBE J86 BAVPE CORKR J11 BCE QWENN6 KSLC\" readonly>";
