clt_departures = function (arvl = "XXX", tail = null, ac_type = null, result = "") {
	switch(arvl) {
		...
		case "DSM": // CLT-DSM // Updated 02-19-2026
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"\" readonly>";
			result += "<br/><br/>South via VUZ<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KCLT ESTRR5 IPTAY CHOPZ THRSR VLKNN Q116 SGF LMN KDSM\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
...
// CLT-PSM skipped
		...
		case "SAV": // CLT-SAV // Updated 09-30-2025
			...
			break;
		case "SDF": // CLT-SDF // Updated 02-18-2026
			result += "<!-- Updated 02-18-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL280):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KCLT JOJJO5 CUBIM LAFOX LEDDL1 KSDF\" readonly>"; // CDR RP
			result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KCLT WEAZL5 CLAWD HVQ J24 FLM DLAMP DLAMP8 KSDF\" readonly>";
