dfw_departures = function (arvl = "XXX", tail = null, ac_type = null, result = "") {
	switch(arvl) {
		case "ABI": // DFW-ABI // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-08-2026
			result += "<!-- Verified with ATCSCC on 05-08-2026 -->";
		...
		case "ABQ": // DFW-ABQ // Updated 09-27-2025
			...
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO RECKN COLTR4 KABQ\" readonly>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO MIERA2 KABQ\" readonly>";
			...
			break;
		case "ACT": // DFW-ACT // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL120):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW NELYN6 NELYN KACT\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 05-08-2026
			break;
		case "AGS": // DFW-AGS // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR AHN IRQ KAGS\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 MEMFS GQO IRQ KAGS\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI CATLN MGMRY IRQ KAGS\" readonly>"; // CDR 1S
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI CATLN MGMRY IRQ KAGS\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-08-2026
			result += "<!-- Verified with ATCSCC on 05-08-2026 -->";
			...
			result += "<br/>1S<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI CATLN MGMRY IRQ KAGS\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "ALB": // DFW-ALB // Updated 05-25-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J24 VHP DUTSH Q29 JHW Q82 LOXXE KALB\" readonly>";
			result += "<br/><b>Via FAM: .. RZC FAM SAM ROD KLYNE Q29 ...<\/b>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 LLUND Q133 GANDE KALB\" readonly>"; // Based on CDR MH
			result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "AMA": // DFW-AMA // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><br/><b>Faa Pref Route (Avg FL320):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH KAMA\" readonly>"; // CDR 0P
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-08-2026
			result += "<!-- Verified with ATCSCC on 05-08-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH KAMA\" readonly>";
			...
			break;
		case "ATL": // DFW-ATL // Updated 12-11-2025
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN ORRKK HOBTT3 KATL\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEM HUTCC KNSAW RUSSA GLAVN2 KATL\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH Q24 PAYTN SHYRE HOBTT3 KATL\" readonly>";
			...
			result += "<br/>ME<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM HUTCC KNSAW RUSSA GLAVN2 KATL\" readonly>";
			result += "<br/>NM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB GARTS PAYTN SHYRE HOBTT3 KATL\" readonly>";
			break;
		case "AUS": // DFW-AUS // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			...
			break;
		case "AVL": // DFW-AVL // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM VXV SOT KAVL\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA VXV SOT KAVL\" readonly>"; // CDR 1N
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN RMG ODF KAVL\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MERDN VLKNN THRSR HRTWL KAVL\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-08-2026
			result += "<!-- Verified with ATCSCC on 05-08-2026 -->";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MERDN VLKNN THRSR HRTWL KAVL\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "BDL": // DFW-BDL // Updated 12-22-2025
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD KLYNE Q29 JHW Q82 MEMMS WILET STELA1 KBDL\" readonly>"; // Based on CDR SP
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BEARI FAK AML Q227 KONJE J190 KODEY RAHKS STELA1 KBDL\" readonly>"; // CDR MH
			// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI BNA SWAPP Q34 RBV Q419 DPK DPK3 KBDL\" readonly>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI BNA SWAPP Q34 RBV Q419 DPK DPK3 KBDL\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			result += "<br/>MH<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BEARI FAK AML Q227 KONJE J190 KODEY RAHKS STELA1 KBDL\" readonly>";
			...
			break;
		case "BFL": // DFW-BFL // Updated 05-13-2026
			result += "<!-- Updated 05-13-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 05-13-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J6 PMD FASTO2 KBFL\" readonly>";
			...
			break;
		case "BGR": // DFW-BGR // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC STL BVT CRL J554 JHW Q29 KRAZZ DAVID FRIAR KBGR\" readonly>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BEARI FAK AML Q221 BIGEO J49 ALB ENE KBGR\" readonly>"; // CDR MH
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "BHM": // DFW-BHM // Updated 11-22-2025
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM MSL NULLS KBHM\" readonly>";
			result += "<br/>South/ZME Avoid<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB GCV MGM WANDS KBHM\" readonly>";
			...
			break;
		case "BIL": // DFW-BIL // Updated 10-22-2025
			result += "<!-- Updated 10-22-2025 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 10-22-2025
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA PNH PUB DVV DDY CUSGA BGHRN3 KBIL\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 MCI EYHUX J45 FSD J16 DPR CONUK KUSTR3 KBIL\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 PUB BJC MBW J170 DDY CUSGA BGHRN3 KBIL\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
		...
		case "BNA": // DFW-BNA // Updated 10-05-2025
			...
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 TXK MEM GHM KBNA\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 10-05-2025
			result += "<!-- Verified with ATCSCC on 10-05-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEMFS CHSNE3 KBNA\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG LOPPY CHSNE3 KBNA\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI IGB KISTS CHSNE3 KBNA\" readonly>";
			break;
		case "BOI": // DFW-BOI // Updated 07-29-2025
			...
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J15 TWF BROPH SPUUD4 KBOI\" readonly>";
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX ABQ J15 RSK KU54Q TCH J12 TWF BROPH SPUUD4 KBOI\" readonly>";
			...
			break;
		case "BOS": // DFW-BOS // Updated 05-01-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD KLYNE Q29 JHW Q82 PONCT JFUND2 KBOS\" readonly>"; // CDR J3
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP BURGG Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>"; // CDR 1P
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>CEW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 POLYY DADDS Q87 GEARS BBOBO Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>";
			result += "<br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>";
			result += "<br/>MGM 1<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO TWOUP Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>";
			result += "<br/>MGM 3<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 POLYY DADDS Q87 GEARS BBOBO Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>";
			result += "<br/>VLKNN<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			...
			result += "<br/>M3<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 POLYY DADDS Q87 GEARS BBOBO Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>"; // MGM 3
			...
			result += "<br/>VS<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV J87 IAH J2 LCH J138 SJI Q56 CATLN Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>"; // VLKNN
			result += "<br/>WC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 POLYY DADDS Q87 GEARS BBOBO Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>"; // CEW
			result += "<br/>WM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO TWOUP Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>"; // MGM 1
			result += "<br/>WV<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 RBV Q419 JFK ROBUC3 KBOS\" readonly>"; // VLKNN
			break;
		case "BRO": // DFW-BRO // Updated 05-11-2026
			result += "<!-- Updated 05-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW NELYN6 HOARY CRP J25 BRO KBRO\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV PSX CRP KBRO\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 SAT J21 LRD MFE KBRO\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW JPOOL7 SAT THX KBRO\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 05-11-2026
			break;
		case "BTR": // DFW-BTR // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH KBTR\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-08-2026
			result += "<!-- Verified with ATCSCC on 05-08-2026 -->";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH KBTR\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "BTV": // DFW-BTV // Updated 05-11-2026
			result += "<!-- Updated 05-11-2026 P -->";
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD KLYNE Q29 JHW LAGGS KBTV\" readonly>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BEARI FAK AML Q221 BIGEO J49 HNK LAGGS BTV KBTV\" readonly>"; // CDR MH
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 LIT J131 PXV ROD DJB JHW LAGGS KBTV\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-11-2026
			result += "<!-- Verified with ATCSCC on 05-11-2026 -->";
			result += "<br/>MH<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BEARI FAK AML Q221 BIGEO J49 HNK LAGGS BTV KBTV\" readonly>";
			break;
		case "BUF": // DFW-BUF // Updated 03-11-2026
			result += "<!-- Updated 03-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD DJB DKK KBUF\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL BVT CRL FARGN KBUF\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK SQS BNA DACOS APE WWSHR Q82 JHW KBUF\" readonly>";
			...
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB HITMN Q139 RINTE DJB DKK KBUF\" readonly>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB HITMN Q139 RINTE DJB DKK KBUF\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "BUR": // DFW-BUR // Updated 09-06-2026
			result += "<!-- Updated 09-06-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J74 SJN DRK J6 EED JANNY5 KBUR\" readonly>"; // Based on CDR 0P
			result += "<br/><b>SUA 2501C: .. EED WNCHL JANNY5 KBUR<\/b>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J6 EED JANNY5 KBUR\" readonly>";
			...
			result += "<br/><b>If Jackal sua active: .. J4 SSO J50 TFD J212 BXK PHRED THRNE4 KBUR<\/b>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J74 SJN J231 DRK J6 EED JANNY5 KBUR\" readonly>";
			result += "<br/>1N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW LOWGN8 ADM MRMAC CRUSR J6 PNH J6 EED JANNY5 KBUR\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT J86 ELP J50 TFD J212 BXK PHRED THRNE4 KBUR\" readonly>";
			result += "<br/>2S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 SAT DLF FST J86 ELP J50 TFD J212 BXK PHRED THRNE4 KBUR\" readonly>";
			result += "<br/>3S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 SAT FST J86 ELP J50 TFD J212 BXK PHRED THRNE4 KBUR\" readonly>";
			break;
		case "BWI": // DFW-BWI // Updated 07-22-2026
			result += "<!-- Updated 07-22-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR CJAAE RAVNN9 KBWI\" readonly>"; // CDR 0P
			...
			result += "<br/>South <span style=\"color:red\">(Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR KBLER KELLN Q58 PEETT THHMP RAVNN9 KBWI\" readonly>"; // CDR WV
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL9 TXK MEM BNA BKW J213 KERRE CSN RIPKN2 KBWI\" readonly>";
			result += "<br/><br/><b>Playbooks:</b>";
			result += "<br/>CEW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 OGRAE GOOOB THHMP RAVNN9 KBWI\" readonly>";
			result += "<br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI BNA SWAPP Q34 SITTR CJAAE RAVNN9 KBWI\" readonly>";
			result += "<br/>HITMN<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR CJAAE RAVNN9 KBWI\" readonly>";
			result += "<br/>MGM 1<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO KBLER KELLN Q58 PEETT THHMP RAVNN9 KBWI\" readonly>";
			result += "<br/>MGM 3<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 OGRAE GOOOB THHMP RAVNN9 KBWI\" readonly>";
			result += "<br/>VLKNN<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR KBLER KELLN Q58 PEETT THHMP RAVNN9 KBWI\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-22-2026
			result += "<!-- Verified with ATCSCC on 07-22-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR CJAAE RAVNN9 KBWI\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA SWAPP Q34 SITTR CJAAE RAVNN9 KBWI\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI BNA SWAPP Q34 SITTR CJAAE RAVNN9 KBWI\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			...
			result += "<br/>M3<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 OGRAE GOOOB THHMP RAVNN9 KBWI\" readonly>"; // MGM 3
			...
			result += "<br/>VS<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV J87 IAH J2 LCH J138 SJI Q56 CATLN Q56 KELLN Q58 PEETT THHMP RAVNN9 KBWI\" readonly>"; // VLKNN
			result += "<br/>WB<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR CJAAE RAVNN9 KBWI\" readonly>"; // HITMN
			result += "<br/>WC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 OGRAE GOOOB THHMP RAVNN9 KBWI\" readonly>"; // CEW
			result += "<br/>WM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO KBLER KELLN Q58 PEETT THHMP RAVNN9 KBWI\" readonly>"; // MGM 1
			result += "<br/>WV<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR KBLER KELLN Q58 PEETT THHMP RAVNN9 KBWI\" readonly>"; // VLKNN
			break;
		case "BZN": // DFW-BZN // Updated 05-13-2026
			result += "<!-- Updated 05-13-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 05-13-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\"; value=\"KDFW HUDAD3 HUDAD PNH J17 PUB CKW TOCUD LOSST1 KBZN\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW END HLC BFF BIL POWDA POWDA2 KBZN\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TCC ALS J206 HBU OCS TOCUD LOSST1 KBZN\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW CYOTE4 ABI J65 CME J15 TANER MTJ OCS LVM KBZN\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 05-13-2026
			break;
		case "CAE": // DFW-CAE // Updated 05-15-2026
			result += "<!-- Updated 05-15-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR IRQ KCAE\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM GQO IRQ KCAE\" readonly>";
			result += "<br/>South: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB TOI MCN KCAE\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 SOLDO ELD SQS VUZ IRQ KCAE\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MERDN VLKNN THRSR WANSA KCAE\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-15-2026
			result += "<!-- Verified with ATCSCC on 05-15-2026 -->";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MERDN VLKNN THRSR WANSA KCAE\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "CAK": // DFW-CAK // Updated 01-23-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC KK48I SPI RBS FWA MSKTS HUUVR1 KCAK\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD Q32 BNA SWAPP Q34 KONGO Q145 HVQ JPU ZZIPS1 KCAK\" readonly>";
		...
		case "CID": // DFW-CID // Updated 03-25-2026
			...
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW GRABE8 OKM BUM IOW CID KCID\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J101 STL IOW KCID\" readonly>"; // Based on CDR 1E
			result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH SLN DSM KCID\" readonly>"; // Based on CDR 1W
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 IRK KCID\" readonly>";
			break;
		case "CLE": // DFW-CLE // Updated 01-23-2026
			result += "<!-- Updated 01-23-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/><br/>NW Arrival<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC SGF BAYLI PIA JOT J146 GIJ J554 BENJO BRWNZ4 KCLE\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM PXV DRUGA ROKNN4 KCLE\" readonly>"; // CDR 1S
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM PXV DRUGA ROKNN4 KCLE\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
...
// DFW-CLL skipped
		...
		case "CLT": // DFW-CLT // Updated 06-03-2025 // Mandatory Routes checked
			...
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR BESTT JONZE8 KCLT\" readonly>"; // CDR 0P
			result += "<br/><br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB J50 CEW ALLMA ISUZO CHECR STOCR7 KCLT\" readonly>"; // CDR FP
			result += "<br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA TAZZA FILPZ7 KCLT\" readonly>"; // CDR 1N
			result += "<br/><b>To get a bit farther north, replace ARG with KM42K ..RZC KM42K BNA..<\/b>";
			// result += "<br/><br/>CLT NO FILPZ PARQR<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB J50 CEW ALLMA ISUZO CHECR STOCR5 KCLT\" readonly>";
			// result += "<br/>CLT NO JONZE<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM BNA TAZZA FILPZ5 KCLT\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH LSU MERDN JAMMR THRSR BESTT JONZE8 KCLT\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 EIC SQS VUZ GQO SOT LIINN1 KCLT\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-03-2025
			result += "<!-- Verified with ATCSCC on 06-03-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR BESTT JONZE8 KCLT\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA TAZZA FILPZ7 KCLT\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH LSU MERDN JAMMR THRSR BESTT JONZE8 KCLT\" readonly>";
			result += "<br/>FP<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB J50 CEW ALLMA ISUZO CHECR STOCR7 KCLT\" readonly>";
			result += "<br/>NJ<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM BNA TAZZA FILPZ7 KCLT\" readonly>";
			break;
		case "CMH": // DFW-CMH // Updated 03-24-2026
			result += "<!-- Updated 03-24-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV GETTA JAKTZ2 KCMH\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC SGF J8 STL J110 VHP JADUB DUBLN1 KCMH\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD Q32 HITMN Q139 GETTA JAKTZ2 KCMH\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM J29 PXV GETTA JAKTZ2 KCMH\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM J29 PXV GETTA JAKTZ2 KCMH\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		...
		case "COS": // DFW-COS // Updated 03-07-2026
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 TBE DBRY5 KCOS\" readonly>"; // CDR 0P
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 TBE DBRY5 KCOS\" readonly>";
...
// CPR skipped
		...
		case "CRP": // DFW-CRP // Updated 05-15-2026
			result += "<!-- Updated 05-15-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW NELYN6 SAT J25 CRP KCRP\" readonly>"; // CDR 0P
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV ELA CRP KCRP\" readonly>";
			result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 DOSXX SJT JCT SAT J25 CRP KCRP\" readonly>"; // CDR 1W
			result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "CVG": // DFW-CVG // Updated 01-23-2026
			result += "<!-- Updated 01-23-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 HUMBO TERGE SARGO5 KCVG\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM TERGE SARGO5 KCVG\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN GQO VXV JAKIE7 KCVG\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM J29 TINGS TERGE SARGO5 KCVG\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 LIT J131 PXV IIU FLM KCVG\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 01-23-2026
			result += "<!-- Verified with ATCSCC on 01-23-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 HUMBO TERGE SARGO5 KCVG\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG TERGE SARGO5 KCVG\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM J29 TINGS TERGE SARGO5 KCVG\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
/*
		case "CYS": // DFW-CYS // Updated 04-08-2025
			...
			result += "<br/><br/>South: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH LAA AKO KCYS\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
...
/*
		case "DAB": // DFW-DAB // Updated 04-08-2025
			...
			break;
*/
		case "DAY": // DFW-DAY // Updated 05-15-2026
			result += "<!-- Updated 05-15-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV SHB RID KDAY\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J24 VHP KDAY\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD Q32 HITMN IIU KDAY\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW TEX4 TUL J98 SGF J8 STL J24 VHP KDAY\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM J29 PXV SHB RID KDAY\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-15-2026
			result += "<!-- Verified with ATCSCC on 05-15-2026 -->";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM J29 PXV SHB RID KDAY\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "DCA": // DFW-DCA // Updated 05-06-2026
			result += "<!-- Updated 05-06-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR TRUPS6 KDCA\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J24 VHP ROD APE J30 LUISE FRDMM7 KDCA\" readonly>"; // Based on CDR J3
			result += "<br/><b>As of 05-06-2026 Fkeys throws Mandatory Route violation unless ..VHP J80 AIR J34 BUCKO.. but this route is ok to file<\/b>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR KBLER KELLN Q56 KIWII WAVES CAPSS4 KDCA\" readonly>"; // CDR WV
			result += "<br/><br/>South via CEW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q109 PANDY SARKY Q113 AARNN WAVES CAPSS4 KDCA\" readonly>"; // CDR WC
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 TXK J131 PXV J78 HVQ ESL DRUZZ AML KDCA\" readonly>";
			result += "<br/><br/><b>Playbooks:</b>";
			result += "<br/>CEW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q109 PANDY SARKY Q113 AARNN WAVES CAPSS4 KDCA\" readonly>";
			result += "<br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI BNA SWAPP Q34 SITTR TRUPS6 KDCA\" readonly>";
			result += "<br/>HITMN<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR TRUPS6 KDCA\" readonly>";
			result += "<br/>MGM 1<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO KBLER KELLN Q56 KIWII WAVES CAPSS4 KDCA\" readonly>";
			result += "<br/>MGM 3<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 OGRAE FUUFF WAVES CAPSS4 KDCA\" readonly>";
			result += "<br/>VLKNN<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR KBLER KELLN Q56 KIWII WAVES CAPSS4 KDCA\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-08-2026
			result += "<!-- Verified with ATCSCC on 07-08-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR TRUPS6 KDCA\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA SWAPP Q34 SITTR TRUPS6 KDCA\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI BNA SWAPP Q34 SITTR TRUPS6 KDCA\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			result += "<br/>J3<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD APE J30 LUISE FRDMM7 KDCA\" readonly>";
			result += "<br/>LT<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD APE J30 LUISE FRDMM7 KDCA\" readonly>";
			result += "<br/>M3<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 OGRAE FUUFF WAVES CAPSS4 KDCA\" readonly>"; // MGM 3
			result += "<br/>RD<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEMFS Q29 CREEP OTMAN J30 LUISE FRDMM7 KDCA\" readonly>";
			result += "<br/>VS<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV J87 IAH J2 LCH J138 SJI Q56 CATLN Q56 KIWII WAVES CAPSS4 KDCA\" readonly>"; // VLKNN
			result += "<br/>WB<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR TRUPS6 KDCA\" readonly>"; // HITMN
			result += "<br/>WC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q109 PANDY SARKY Q113 AARNN WAVES CAPSS4 KDCA\" readonly>"; // CEW
			result += "<br/>WM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO KBLER KELLN Q56 KIWII WAVES CAPSS4 KDCA\" readonly>"; // MGM 1
			result += "<br/>WV<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR KBLER KELLN Q56 KIWII WAVES CAPSS4 KDCA\" readonly>"; // VLKNN
			break;
		case "DEN": // DFW-DEN // Updated 05-15-2026
			result += "<!-- Updated 05-15-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE HALEN NIIXX4 KDEN\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK KIISS CLASH5 KDEN\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ZIGEE NIIXX4 KDEN\" readonly>"; // CDR 1W
			...
			result += "<br/>DEN GCK 2<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX GNDLA TBARR4 KDEN\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-15-2026
			result += "<!-- Verified with ATCSCC on 05-15-2026 -->";
			...
			result += "<br/>1W<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ZIGEE NIIXX4 KDEN\" readonly>";
			...
			result += "<br/>GC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX GNDLA TBARR4 KDEN\" readonly>"; // DEN GCK 2
			break;

// DLH skipped

		case "DJT": // DFW-DJT // Updated 09-06-2026
			result += "<!-- Updated 09-06-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA HRV Q105 BLVNS Y290 GAWKS VUUDU2 KDJT\" readonly>"; // CDR 0P
			result += "<br/><br/>Non OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN VUUDU2 KDJT\" readonly>";
			result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK MERDN ACORI VUUDU2 KDJT\" readonly>";
			result += "<br/><br/>Full OW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV MUSYL KELPP ALGAE MINOW M580 MARCI RACNO VUUDU2 KDJT\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 DEFUN VUUDU2 KDJT\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 EIC MCB J50 CEW SZW TAY CRG OMN MLB STOOP4 KDJT\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 09-06-2026
			result += "<!-- Verified with ATCSCC on 09-06-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK MERDN DEFUN VUUDU2 KDJT\" readonly>";
			result += "<br/>1N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MERDN DEFUN VUUDU2 KDJT\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 DEFUN VUUDU2 KDJT\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "DRO": // DFW-DRO // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD YACUL DRO KDRO\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE PUB DRO KDRO\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN CME J15 RSK DRO KDRO\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "DSM": // DFW-DSM // Updated 11-24-2025
			result += "<!-- Updated 11-24-2025 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 DSM KDSM\" readonly>"; // CDR 0P
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J180 FTZ IRK KDSM\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW J21 ICT PWE KDSM\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT PWE KDSM\" readonly>";
			break;
		...
		case "EGE": // DFW-EGE // Updated 03-25-2026
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO ABQ KA36S MAESA AAVON1 KEGE\" readonly>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE SELLS J154 AVVVS HUGGS CULCH KEGE\" readonly>";
			// result += "<br/><br/>West (Max FL280 at AVVVS): <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH LAA HGO AVVVS HUGGS RLG KEGE\" readonly>";
			// result += "<br/><br/>SKI COUNTRY 1: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO ABQ KA36S BUGGG EKR RLG KEGE\" readonly>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-25-2026
			result += "<!-- Verified with ATCSCC on 03-25-2026 -->";
			result += "<br/>AB<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO ABQ KA36S IBSKI AAVON1 KEGE\" readonly>";
		...
		case "ELP": // DFW-ELP // Updated 03-06-2026
			...
			result += "<br/><br/>NW Arrival<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J58 FTI J104 ONM J57 TCS J13 RUTER J86 ELP KELP\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "EUG": // DFW-EUG // Updated 05-15-2026
			result += "<!-- Updated 05-15-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 05-15-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TCC J76 FTI J58 MLF ELY BAM LKV KEUG\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK TXC LAR J54 BOI DSD KEUG\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 BLD J92 LMT KEUG\" readonly>";
			result += "<br/><br/>South via EWM<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN BGS J66 EWM Q2 HEDVI BLH J65 LANDO J6 AVE J189 LMT KEUG\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 05-15-2026
			break;
		case "EVV": // DFW-EVV // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV KEVV\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM PXV KEVV\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM J29 PXV KEVV\" readonly>";
			// result += "<br/>South: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD Q32 CRAMM PXV KEVV\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 LIT J131 PXV KEVV\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-26-2026
			result += "<!-- Verified with ATCSCC on 06-26-2026 -->";
		...
		case "EYW": // DFW-EYW // Updated 10-11-2025
			...
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA HRV Q105 BLVNS Y290 GAWKS PIKKR KRAKN1 KEYW\" readonly>";
			result += "<br/><br/>Non OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN KRAKN1 KEYW\" readonly>";
			result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS LDK MGM ACORI BULZI KRAKN1 KEYW\" readonly>";
			result += "<br/><br/>Full OW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV VUH L207 MUSYL PEGLG ALGAE MINOW M580 SHAQQ KRAKN1 KEYW\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 04-11-2025
			break;
		case "FAR": // DFW-FAR // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 06-26-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA PER LNK FSD FAR KFAR\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC SGF LMN RWF FAR KFAR\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK HCT ABR KFAR\" readonly>";
			result += "<br/><br/>East via LIT<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT VIH IRK J45 DSM RWF FAR KFAR\" readonly>";
			result += "<br/>West via PNH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN PNH GCK HLC ONL KFAR\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
		...
		case "FAT": // DFW-FAT // Updated 07-21-2026
			...
			result += "<br/><br/>Standard: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 BLD J86 BTY KENNO CABAB FRA KFAT\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 ILC OAL KFAT\" readonly>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J74 SJN J231 DRK J6 HEC PMD J65 LANDO TTE ALTTA9 KFAT\" readonly>";
		...
		case "GPI": // DFW-GPI // Updated 06-29-2025
			...
			result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J15 TCH J9 DLN KGPI\" readonly>";
		...
		case "FLG": // DFW-FLG // Updated 07-22-2026
			result += "<!-- Updated 07-22-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 06-29-2025
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 MIERA INW V572 MAZDA KFLG\" readonly>";
		...
		case "FLL": // DFW-FLL // Updated 12-15-2025
			...
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA HRV Q105 BLVNS Y290 OCHHO VNECK TEEKY4 KFLL\" readonly>";
			result += "<br/><b>To keeps flight within ZJX/ZMA: .. BLVNS Y290 BACCA VNECK ..<\/b>";
			result += "<br/><br/>Non OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN TEEKY4 KFLL\" readonly>";
			result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS LDK MGM ACORI TEEKY4 KFLL\" readonly>";
			result += "<br/>East Coast<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS LDK LGC YANTI Q89 PRMUS CUUDA3 KFLL\" readonly>";
			result += "<br/><br/>Full OW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV MUSYL KELPP ALGAE MINOW M580 MARCI TEEKY4 KFLL\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH): <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH HRV Q105 BLVNS Y290 BACCA VNECK TEEKY4 KFLL\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW EIC MCB CEW SZW PIE FORTL KFLL\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 12-15-2025
			result += "<!-- Verified with ATCSCC on 12-15-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP HRV Q105 BLVNS Y290 OCHHO VNECK TEEKY4 KFLL\" readonly>"; // 
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEMFS DEFUN TEEKY4 KFLL\" readonly>"; // 
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH J86 LEV Y290 OCHHO VNECK TEEKY4 KFLL\" readonly>"; // 
			break;
		case "FNT": // DFW-FNT // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 06-26-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J19 RBS GIJ KFNT\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J87 IRK IOW DBQ BAE KFNT\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV VHP FWA JXN KFNT\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW TEX5 OKM RZC FTZ RBS GIJ KFNT\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 06-26-2026
			break;
		case "FOE": // DFW-FOE // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 06-26-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL KFOE\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC BUM KFOE\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW J21 ICT KFOE\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
		...
		case "FSD": // DFW-FSD // Updated 11-25-2025
			...
			result += "<br/>West via PNH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH HLC OBH KFSD\" readonly>";
		...
		case "FSM": // DFW-FSM // Updated 10-22-2025
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC KFSM\" readonly>";
			...
			result += "<br/>1W<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD CDS BFV IRW KFSM\" readonly>";
			break;
		case "GEG": // DFW-GEG // Updated 03-14-2026
			...
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 PUB CHE J163 OCS J52 GEG KGEG\" readonly>";
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 MLF ELY J523 REO J153 GEG KGEG\" readonly>";
			...
			break;
		case "GGG": // DFW-GGG // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL170):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 MRSSH GGG KGGG\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW GARL6 GGG KGGG\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 06-26-2026
			break;
		case "GJT": // DFW-GJT // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 06-26-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC KGJT\" readonly>";
			result += "<br/><br/>North: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW J98 MMB TOTOE LAA PUB J28 HBU V484 BATTZ KGJT\" readonly>";
			result += "<br/>South: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO ABQ DVC JNC KGJT\" readonly>";
			...
			result += "<br/>SKI COUNTRY 3: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX ABQ KA36S DVC JNC KGJT\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW CYOTE4 PNH ALS JNC KGJT\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-26-2026
			result += "<!-- Verified with ATCSCC on 06-26-2026 -->";
			result += "<br/>AB<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO ESPAN DVC JNC KGJT\" readonly>";
			...
			break;
		case "GPT": // DFW-GPT // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP KGPT\" readonly>"; // CDR 0P
			result += "<br/><br/>North: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MHZ KGPT\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH KGPT\" readonly>"; // CDR 1S
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH KGPT\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH KGPT\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "GRB": // DFW-GRB // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 06-26-2026
			...
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 06-26-2026
			break;
		case "GRK": // DFW-GRK // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			...
			break;
		case "GRR": // DFW-GRR // Updated 08-11-2026
			result += "<!-- Updated 08-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J101 SPI JOT OBK SMUUV KGRR\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J87 MZV OBK PMM KGRR\" readonly>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-11-2026
			result += "<!-- Verified with ATCSCC on 08-11-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J101 SPI JOT OBK SMUUV KGRR\" readonly>";
			result += "<br/>1E<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J101 SPI JOT OBK SMUUV KGRR\" readonly>";
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT BUM STL J101 SPI JOT OBK SMUUV KGRR\" readonly>";
			break;
		case "GSO": // DFW-GSO // Updated 05-06-2026
			result += "<!-- Updated 05-06-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM VXV TRAKS TRAKS4 KGSO\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM J78 IIU OTONE TRAKS4 KGSO\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS HRISN Q30 VLKNN THRSR BURGG TRAKS4 KGSO\" readonly>";
			result += "<br/><br/>South/ZTL Avoid<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN CABLO AMG CAE BLOCC2 KGSO\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN TWOUP BURGG TRAKS4 KGSO\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM VXV TRAKS TRAKS4 KGSO\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA VXV TRAKS TRAKS4 KGSO\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN TWOUP BURGG TRAKS4 KGSO\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "GSP": // DFW-GSP // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR BESTT WORXS2 KGSP\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM VXV DAJPI RCTOR3 KGSP\" readonly>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN MGMRY THRSR BESTT WORXS2 KGSP\" readonly>"; // CDR 1S
			result += "<br/><br/>North via PXV<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM J78 PXV LOZ DAJPI RCTOR3 KGSP\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN MGMRY THRSR BESTT WORXS2 KGSP\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW EIC J20 MEI VUZ RMG KGSP\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-26-2026
			result += "<!-- Verified with ATCSCC on 06-26-2026 -->";
			...
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA BALNN BURGG KGSP\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN MGMRY THRSR BESTT WORXS2 KGSP\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "GUC": // DFW-GUC // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 04-15-2025
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 PUB J28 HBU KGUC\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK DAAYE KGUC\" readonly>"; // CDR KC
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE ESPAN HELPS KGUC\" readonly>"; // CDR ED
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-26-2026
			result += "<!-- Verified with ATCSCC on 06-26-2026 -->";
			result += "<br/>ED<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE ESPAN HELPS KGUC\" readonly>";
			...
			break;
		case "GUS": // DFW-GUS // Updated 03-21-2026
			result += "<!-- Updated 03-21-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 03-21-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV KGUS\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC SGF SPI KGUS\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 03-21-2026
			break;
		case "HDN": // DFW-HDN // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 06-26-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK DVV CHE KHDN\" readonly>"; // Based on CDR KC
			result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA PER HYS BFF LAR KHDN\" readonly>"; // CDR PH
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE ESPAN DRO EKR KHDN\" readonly>"; // CDR AB
			result += "<br/>SKI COUNTRY 3: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX ABQ KA36S EKR KHDN\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW TEX5 IRW GCK GLD DVV CHE KHDN\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-26-2026
			result += "<!-- Verified with ATCSCC on 06-26-2026 -->";
			result += "<br/>AB<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE ESPAN DRO EKR KHDN\" readonly>";
			...
			break;
		case "HRL": // DFW-HRL // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW NELYN6 SAT J25 CRP KHRL\" readonly>"; // CDR 0P
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV PSX J22 CRP KHRL\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "HSV": // DFW-HSV // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI IGB IRRTH KHSV\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI IGB IRRTH KHSV\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "IAD": // DFW-IAD // Updated 10-12-2025
			result += "<!-- Updated 10-12-2025 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // FAA pref seems wrong
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT SOPIE Q68 SPAYD JARLO GIBBZ6 KIAD\" readonly>";
			result += "<br/><b>Pref is .. TRYTN4 LOOSE Q34 HITMN JARLO GIBBZ5 .. not sure why its using Q34 if arvl is JARLO<\/b>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J110 AIR J162 MGW GIBBZ6 KIAD\" readonly>"; // Based on CDR J3
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN TWOUP Q22 BURGG Q60 JAXSN DORRN CAVLR7 KIAD\" readonly>"; // Based on CDR WM
			result += "<br/><br/>South via CEW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB J50 CEW ALLMA TEEEM Q99 OGRAE BZNGA DORRN CAVLR7 KIAD\" readonly>"; // Based on CDR WC
			result += "<br/><br/><b>Playbooks:</b>";
			result += "<br/>BNA<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 HITMN JARLO GIBBZ6 KIAD\" readonly>";
			result += "<br/>CEW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 OGRAE BZNGA DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/>MGM 1<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO TWOUP Q22 BURGG Q60 JAXSN DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/>MGM 3<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 OGRAE BZNGA DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/>VUZ<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BURGG Q60 JAXSN DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>0P<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR GIBBZ6 KIAD\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA SWAPP Q34 SITTR GIBBZ6 KIAD\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MEI BNA SWAPP Q34 SITTR GIBBZ6 KIAD\" readonly>";
			result += "<br/>J3<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD APE AIR J162 MGW GIBBZ6 KIAD\" readonly>";
			result += "<br/>LT<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD APE AIR J162 MGW GIBBZ6 KIAD\" readonly>";
			result += "<br/>M3<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 OGRAE BZNGA DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/>RD<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEMFS Q29 CREEP J80 AIR J162 MGW GIBBZ6 KIAD\" readonly>";
			result += "<br/>VS<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV J87 IAH J2 LCH J138 SJI Q56 CATLN Q22 BURGG Q60 JAXSN DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/>WB<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 HITMN JARLO GIBBZ6 KIAD\" readonly>";
			result += "<br/>WC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 OGRAE BZNGA DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/>WM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO TWOUP Q22 BURGG Q60 JAXSN DORRN CAVLR7 KIAD\" readonly>";
			result += "<br/>WV<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BURGG Q60 JAXSN DORRN CAVLR7 KIAD\" readonly>";
			break;
		case "IAH": // DFW-IAH // Updated 06-26-2026
			result += "<!-- Updated 06-26-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL250):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW DARTZ9 TORNN DRLLR5 KIAH\" readonly>"; // CDR 0P
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>2E<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 MRSSH BDDAY AEX ZEEKK3 KIAH\" readonly>";
			...
			break;
		case "ICT": // DFW-ICT // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA PER KICT\" readonly>"; // CDR 0P
			result += "<br/><br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE MMB KICT\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 TXK KICT\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-30-2026
			result += "<!-- Verified with ATCSCC on 06-30-2026 -->";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT KICT\" readonly>";
			break;
		case "ILM": // DFW-ILM // Updated 12-21-2025
			...
			break;
		case "IND": // DFW-IND // Updated 06-09-2026
			result += "<!-- Updated 06-09-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT TERGE SMUKE3 KIND\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM WIDAM SMUKE3 KIND\" readonly>";
			result += "<br/><b>Via STL: .. RZC STL JAAVE KOLTS2 KIND<\/b>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 HITMN HAGAL GIIBS4 KIND\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM TERGE SMUKE3 KIND\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 LIT J131 PXV RACYR6 KIND\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-09-2026
			result += "<!-- Verified with ATCSCC on 06-09-2026 -->";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB J35 MEM TERGE SMUKE3 KIND\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "JAC": // DFW-JAC // Updated 02-19-2026
			...
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH DBL OCS DNW KJAC\" readonly>";
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 RSK J15 JNC BPI KJAC\" readonly>";
			...
			result += "<br/>South via ABQ<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J15 JNC BPI KJAC\" readonly>";
			...
			break;
		case "JAN": // DFW-JAN // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 MRSSH MHZ KJAN\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEM SQS KJAN\" readonly>"; // CDR 1N
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB KJAN\" readonly>"; // CDR 1S
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB KJAN\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB KJAN\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "JAX": // DFW-JAX // Updated 12-15-2025
			result += "<!-- Updated 12-15-2025 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 04-16-2025
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN CABLO ZOOSS MARQO3 KJAX\" readonly>"; // CDR 0P
			result += "<br/><br/>OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA HRV Q105 REDFN Y280 REMIS PIE ORL POGIE2 KJAX\" readonly>";
			result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MEI MGMRY CABLO CAPPS MARQO3 KJAX\" readonly>";
			result += "<br/><br/>Full OW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV MUSYL KELPP ALGAE DTSCK CIGAR PIE ORL POGIE2 KJAX\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 until LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 DEFUN CABLO CAPPS MARQO3 KJAX\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 11-10-2025
			result += "<!-- Verified with ATCSCC on 11-10-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MEI MGMRY CABLO ZOOSS MARQO3 KJAX\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEMFS Q116 VLKNN MGMRY CABLO ZOOSS MARQO3 KJAX\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 DEFUN CABLO ZOOSS MARQO3 KJAX\" readonly>";
			break;
		case "JFK": // DFW-JFK // Updated 09-23-2025
			...
			result += "<br/><br/>North via DTW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J19 RBS GSH SVM J70 JHW Q476 WLKES PUCKY1 KJFK\" readonly>";
			result += "<br/><br/><b>Playbooks:</b>";
			...
			result += "<br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q64 SAWED Q108 SIE CAMRN5 KJFK\" readonly>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 12-20-2025
			result += "<!-- Verified with ATCSCC on 12-20-2025 -->";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q64 SAWED Q108 SIE CAMRN5 KJFK\" readonly>"; // COWBOY EAST (FL230 TO LCH)
			result += "<br/>J3<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD KLYNE Q29 JHW Q476 WLKES PUCKY1 KJFK\" readonly>";
			result += "<br/>LT<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD KLYNE Q29 JHW Q476 WLKES PUCKY1 KJFK\" readonly>";
			result += "<br/>M3<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS PANDY Q109 DFENC SAWED Q108 SIE CAMRN5 KJFK\" readonly>"; // MGM 3
			result += "<br/>RD<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEMFS Q29 JHW Q476 WLKES PUCKY1 KJFK\" readonly>";
			result += "<br/>VS<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV J87 IAH J2 LCH J138 SJI Q56 CATLN Q64 SAWED Q108 SIE CAMRN5 KJFK\" readonly>"; // VLKNN
			result += "<br/>WC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q109 DFENC SAWED Q108 SIE CAMRN5 KJFK\" readonly>"; // CEW
			result += "<br/>WM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO FIGEY Q64 SAWED Q108 SIE CAMRN5 KJFK\" readonly>"; // MGM 1
			result += "<br/>WV<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR FIGEY Q64 SAWED Q108 SIE CAMRN5 KJFK\" readonly>"; // VLKNN
			break;
		case "LAS": // DFW-LAS // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 GUP HAHAA RKSTR4 KLAS\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS LBL PUB DVC TYEGR CHOWW4 KLAS\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 WSTEX ABI J50 ELP J86 INW HAHAA RKSTR4 KLAS\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW CYOTE4 CNX ZUN PGS ISHEE2 KLAS\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-30-2026
			result += "<!-- Verified with ATCSCC on 06-30-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 GUP HAHAA RKSTR4 KLAS\" readonly>";
			...
			break;
		case "LAX": // DFW-LAX // Updated 11-22-2025
			result += "<!-- Updated 11-22-2025 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN INK EWM J4 WLVRN ESTWD HLYWD1 KLAX\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J78 DRK GABBL HLYWD1 KLAX\" readonly>";
			...
			result += "<br/>EE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX ONM PXR BXK J4 WLVRN ESTWD HLYWD1 KLAX\" readonly>";
			break;
		case "LAW": // DFW-LAW // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL160):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW KING5 SPS KLAW\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 06-30-2026
			break;
		case "LBB": // DFW-LBB // Updated 01-29-2026
			result += "<!-- Updated 01-29-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL300):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA KLBB\" readonly>"; // CDR 0P
			...
			result += "<br/><br/>COWBOY WEST (Max FL220)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT KLBB\" readonly>"; // CDR 1S
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA KLBB\" readonly>";
			...
			break;
		case "LCH": // DFW-LCH // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 BDDAY PLANB KLCH\" readonly>";
			result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TORNN LFK KLCH\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW GARL6 TYR LFK KLCH\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 06-30-2026
			break;
		case "LEX": // DFW-LEX // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 WAKOL BNA HYK KLEX\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM PXV KLEX\" readonly>"; // Based on CDR 1N
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS BNA HYK KLEX\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MERDN VLKNN VXV KLEX\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MERDN VLKNN VXV KLEX\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "LGA": // DFW-LGA // Updated 05-12-2026
			result += "<!-- Updated 05-12-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // FAA pref route is not a good choice here
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD KLYNE Q29 WWSHR TEESY Q186 WEVEL ETG MIP4 KLGA\" readonly>"; // CDR LT
			result += "<br/><b style=\"color:orange\">As of 04-18-2025 only two routes wont flag mandatory route violation: CDR 1P and CDR LT<\/b>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD KLYNE Q29 WWSHR TEESY J146 ETG MIP4 KLGA\" readonly>"; // CDR J3
			...
			// DFW-BOS is now too// result += "<br/><b style=\"color:orange\">As of 04-18-2025 LGA-DFW is the only city pair where CDR 0P is not the preferred route<\/b>";
			result += "<br/><br/><b>Playbooks:</b>";
			result += "<br/>CEW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 POLYY DADDS Q87 HURTS PROUD2 KLGA\" readonly>";
			result += "<br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q22 BURGG Q60 HURTS PROUD2 KLGA\" readonly>";
			result += "<br/>HITMN<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 GVE PROUD2 KLGA\" readonly>";
			result += "<br/>MGM 1<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO TWOUP Q22 BURGG Q60 HURTS PROUD2 KLGA\" readonly>";
			result += "<br/>MGM 3<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 POLYY DADDS Q87 HURTS PROUD2 KLGA\" readonly>";
			result += "<br/>VLKNN<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BURGG Q60 HURTS PROUD2 KLGA\" readonly>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q22 BURGG Q60 HURTS PROUD2 KLGA\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			result += "<br/>J3<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD KLYNE Q29 WWSHR TEESY Q186 WEVEL ETG MIP4 KLGA\" readonly>";
			result += "<br/>LT<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD KLYNE Q29 WWSHR TEESY Q186 WEVEL ETG MIP4 KLGA\" readonly>";
			result += "<br/>M3<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO NOKIE TWINS BLAAN Q99 POLYY DADDS Q87 HURTS PROUD2 KLGA\" readonly>"; // MGM 3
			result += "<br/>RD<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEMFS Q29 WWSHR TEESY Q186 WEVEL ETG MIP4 KLGA\" readonly>";
			result += "<br/>VS<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV J87 IAH J2 LCH J138 SJI Q56 CATLN Q22 BURGG Q60 HURTS PROUD2 KLGA\" readonly>"; // VLKNN
			result += "<br/>WB<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 GVE PROUD2 KLGA\" readonly>"; // HITMN
			result += "<br/>WC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 POLYY DADDS Q87 HURTS PROUD2 KLGA\" readonly>"; // CEW
			result += "<br/>WM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO TWOUP Q22 BURGG Q60 HURTS PROUD2 KLGA\" readonly>"; // MGM 1
			result += "<br/>WV<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BURGG Q60 HURTS PROUD2 KLGA\" readonly>"; // VLKNN
			break;
		case "LIT": // DFW-LIT // Updated 11-23-2025
			...
			result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC FSM KLIT\" readonly>"; // CDR 1N
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH J2 LCH J22 MCB J35 SQS LIT KLIT\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "LRD": // DFW-LRD // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL300):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW NELYN6 SAT KLRD\" readonly>"; // CDR 0P
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV ELA VCT KLRD\" readonly>";
			result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 DOSXX SJT JCT SAT J21 LRD KLRD\" readonly>"; // CDR 1W
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "MAF": // DFW-MAF // Updated 07-22-2026
			result += "<!-- Updated 07-22-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL300):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN KMAF\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA UNEKE KMAF\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 ACT SJT KMAF\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "MCI": // DFW-MCI // Updated 05-13-2026
			result += "<!-- Updated 05-13-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/><br/>East via LIT<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT SGF NELVY MHOMS3 KMCI\" readonly>"; // CDR 1E
			result += "<br/>West via PNH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT ZOURA WUTNG3 KMCI\" readonly>"; // CDR 1W
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TEX5 TUL EMP JHAWK8 KMCI\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-13-2026
			result += "<!-- Verified with ATCSCC on 05-13-2026 -->";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT ZOURA WUTNG3 KMCI\" readonly>";
			break;
		case "MCO": // DFW-MCO // Updated 08-25-2026
			...
			break;
		case "MDT": // DFW-MDT // Updated 06-30-2026
			result += "<!-- Updated 06-30-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 SITTR ESL BAMMY T299 HAR KMDT\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL VHP ROD J152 JST HAR KMDT\" readonly>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN NIOLA Q40 MAULS MRB KMDT\" readonly>";
			result += "<br/><br/>South/ZTL Avoid<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA TEEEM Q99 RAANE LYH MOL UCREK T299 HAR KMDT\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "MEM": // DFW-MEM // Updated 02-01-2026
			...
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MEVEE HOBRK4 KMEM\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J22 MCB MEVEE HOBRK4 KMEM\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "MFE": // DFW-MFE // Updated 10-30-2025
			...
			result += "<br/>West via SJT<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 WSTEX SJT RSG LRD FATOR KMFE\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "MGM": // DFW-MGM // Updated 07-22-2026
			result += "<!-- Updated 07-22-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MERDN Q184 ARNNY FRDDO KMGM\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM MSL VUZ KMGM\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB GCV CATLN MGMRY KMGM\" readonly>";
			result += "<br/><br/>North via ARG<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEM VUZ KMGM\" readonly>"; // CDR 1N
			result += "<br/>South via IAH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN MGMRY KMGM\" readonly>"; // CDR 1S
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN MGMRY KMGM\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "MIA": // DFW-MIA // Updated 12-15-2025
			result += "<!-- Updated 12-15-2025 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP HRV Q105 BLVNS Y290 DOWRY FROGZ5 KMIA\" readonly>";
			result += "<br/><br/>Non OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN FROGZ5 KMIA\" readonly>";
			result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS LDK LGC HONID FROGZ5 KMIA\" readonly>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 09-11-2025
			result += "<!-- Verified with ATCSCC on 09-11-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP HRV Q105 BLVNS Y290 DOWRY FROGZ5 KMIA\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MERDN DEFUN FROGZ5 KMIA\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH J86 LEV Y290 GAWKS FROGZ5 KMIA\" readonly>";
			break;
		case "MKE": // DFW-MKE // Updated 07-22-2026
			result += "<!-- Updated 07-22-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-22-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL CHZHD GOPAC3 KMKE\" readonly>"; // Based on CDR 0P
			result += "<br/><b>FAA PREF uses .. JOT LEEDN GOPAC3 KMKE</b>";
			...
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 DSM OGECA GOPAC3 KMKE\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 IRK BYLAW LEEDN GOPAC3 KMKE\" readonly>";
			break;

// DFW-MLB skipped

		case "MLI": // DFW-MLI // Updated 01-23-2026
			result += "<!-- Updated 01-23-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC MZV KMLI\" readonly>"; // CDR 0P
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT MZV KMLI\" readonly>"; // CDR 1E
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J87 IRK KMLI\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 01-23-2026
			result += "<!-- Verified with ATCSCC on 01-23-2026 -->";
		...
		case "MOB": // DFW-MOB // Updated 09-11-2025
			...
			break;
		case "MRY": // DFW-MRY // Updated 07-22-2026
			result += "<!-- Updated 07-22-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-22-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 BLD J92 BTY KENNO CABAB FRA SNS KMRY\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 ILC OAL FRA SNS KMRY\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN EWM J4 SSO J50 BLH J65 PMD J6 AVE SNS KMRY\" readonly>";
			result += "<br/><br/>COWBOY WEST 1 (FL220 to JCT)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT FST ELP J50 BLH J65 PMD J6 AVE SNS KMRY\" readonly>";
			result += "<br/>COWBOY WEST 2 (FL220 to SAT)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY SAT DLF FST ELP J50 BLH J65 PMD J6 AVE SNS KMRY\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 07-22-2026
			break;
		case "MSN": // DFW-MSN // Updated 05-12-2026
			result += "<!-- Updated 05-12-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC SGF MZV KMSN\" readonly>"; // CDR 0P
			...
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 MCI CID KMSN\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
		...
		case "MSO": // DFW-MSO // Updated 07-17-2025
			...
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 PUB HAHNS QUIRT WAIDE KMSO\" readonly>";
			...
			result += "<br/>West/HUDAD<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J15 TCH PIH LKT KMSO\" readonly>";			
			result += "<br/>West/KATZZ<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J15 RSK DVC PUC TCH PIH LKT KMSO\" readonly>";
		...
		case "MSP": // DFW-MSP // Updated 09-28-2025
			...
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 MCI ROKKK NITZR4 KMSP\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J101 STL IOW MNOSO BLUEM5 KMSP\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ADM TOTOE GCK HLC OBH FSD SSWAN TORGY4 KMSP\" readonly>";
			result += "<br/><br/>West via LAA<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH KENTO LAA HCT ONL J114 FSD SSWAN TORGY4 KMSP\" readonly><\/b>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TEX5 TUL J25 DSM MCW KASPR8 KMSP\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-24-2026
			result += "<!-- Verified with ATCSCC on 03-24-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA PER PWE OVR ROKKK NITZR4 KMSP\" readonly>";
			result += "<br/>1E<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT SGF J41 OVR ROKKK NITZR4 KMSP\" readonly>";
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT PWE OVR ROKKK NITZR4 KMSP\" readonly>";
		...
		case "MSY": // DFW-MSY // Updated 05-01-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MHZ MCB TRSSH2 KMSY\" readonly>";
			...
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEM J35 MCB TRSSH2 KMSY\" readonly>";
			...
			break;
		case "MTJ": // DFW-MTJ // Updated 07-22-2026
			result += "<!-- Updated 07-22-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-22-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS HBU KMTJ\" readonly>";
			result += "<br/><b>Fkeys uses KA39W instead of ALS. Not sure why<\/b>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK PUB MTJ KMTJ\" readonly>"; // CDR KC
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE ESPAN KMTJ\" readonly>"; // CDR EM
			result += "<br/><br/>SKI COUNTRY 2<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK PUB MTJ KMTJ\" readonly>"; // CDR KC
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-22-2026
			result += "<!-- Verified with ATCSCC on 07-22-2026 -->";
			result += "<br/>AB<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO TCC FTI MTJ KMTJ\" readonly>";
			result += "<br/>EM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE ESPAN KMTJ\" readonly>";
			...
			break;
		case "MYR": // DFW-MYR // Updated 08-14-2026
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB CEW ALLMA SAV CHS KMYR\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI CATLN MGMRY IRQ CAE FLO CRE KMYR\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "OKC": // DFW-OKC // Updated 05-11-2026
			result += "<!-- Updated 05-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL260):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA TSDEL3 KOKC\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>Low Level: <input style=\"width:75%\" value=\"KDFW LOWGN8 ADM V17 IRW KOKC\" readonly>";
			result += "<br/><br/>East for Wx<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT RZC TUL GULLI3 KOKC\" readonly>"; // CDR 1E
			result += "<br/>West for Wx<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD CDS HBR IRW KOKC\" readonly>"; // CDR 1W
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD CDS HBR IRW KOKC\" readonly>";
			break;
		case "OMA": // DFW-OMA // Updated 05-11-2026
			result += "<!-- Updated 05-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA PER HTHWY TIMMO1 KOMA\" readonly>"; // CDR 0P
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 MCI STJ MARWI4 KOMA\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW J98 MMB GCK HLC GRI HOWRY3 KOMA\" readonly>";
			result += "<br/><br/>East via SGF<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT SGF J41 MCI STJ MARWI4 KOMA\" readonly>"; // CDR 1E
			result += "<br/>West via PNH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT HTHWY TIMMO1 KOMA\" readonly>"; // CDR 1W
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT HTHWY TIMMO1 KOMA\" readonly>";
			break;
		case "ONT": // DFW-ONT // Updated 07-08-2025
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J78 DRK DAFNY SCBBY2 KONT\" readonly>";
			...
			break;
		case "ORD": // DFW-ORD // Updated 08-14-2026
			result += "<!-- Updated 08-14-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 IRK BENKY6 KORD\" readonly>";
			...
			break;
		case "ORF": // DFW-ORF // Updated 05-07-2026
			result += "<!-- Updated 05-07-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR HRTWL Q54 NUTZE KOHLS1 KORF\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 MEMFS VXV BZM RDU NUTZE KOHLS1 KORF\" readonly>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q64 HRTWL Q54 NUTZE KOHLS1 KORF\" readonly>"; // CDR 1S
			result += "<br/><br/>North via IIU<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM J78 IIU Q108 MAULS OUTLA1 KORF\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q64 HRTWL Q54 NUTZE KOHLS1 KORF\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR HRTWL Q54 NUTZE KOHLS1 KORF\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA SWAPP Q34 MAULS OUTLA1 KORF\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J138 SJI Q56 CATLN Q64 HRTWL Q54 NUTZE KOHLS1 KORF\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "PDX": // DFW-PDX // Updated 03-24-2026
			result += "<!-- Updated 03-24-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J15 IMB JOTBA HHOOD6 KPDX\" readonly>"; // CDR 0P
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-24-2026
			result += "<!-- Verified with ATCSCC on 03-24-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J15 IMB JOTBA HHOOD6 KPDX\" readonly>";
		...
		case "PHL": // DFW-PHL // Updated 08-06-2025
			...
			break;
		case "PHX": // DFW-PHX // Updated 05-11-2026
			result += "<!-- Updated 05-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN INK EWM DRRVR PINNG1 KPHX\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J78 ZUN EAGUL6 KPHX\" readonly>";
			...
			result += "<br/>EE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX ONM DRRVR PINNG1 KPHX\" readonly>";
		...
		case "PNS": // DFW-PNS // Updated 04-30-2026
			...
			break;
		case "PSP": // DFW-PSP // Updated 06-07-2026
			result += "<!-- Updated 06-07-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN INK J4 BXK J212 CURIV RDBUL1 KPSP\" readonly>"; // Based on CDR 0P
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J78 PKE RDBUL1 KPSP\" readonly>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT J86 ELP J50 SSO J4 BXK J212 HRRBR CURIV RDBUL1 KPSP\" readonly>"; // CDR 1S
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN INK EWM J4 BXK J212 HRRBR CURIV RDBUL1 KPSP\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW LOWGN8 ADM MRMAC CRUSR J6 DRK YORRK RDBUL1 KPSP\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT J86 ELP J50 SSO J4 BXK J212 HRRBR CURIV RDBUL1 KPSP\" readonly>";
			result += "<br/>2S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 SAT DLF FST J86 ELP J50 SSO J4 BXK J212 HRRBR CURIV RDBUL1 KPSP\" readonly>";
			result += "<br/>3S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 SAT FST J86 ELP J50 SSO J4 BXK J212 HRRBR CURIV RDBUL1 KPSP\" readonly>";
			break;
/* Is this a city pair we do?
		case "PUB": // DFW-PUB // Updated 01-27-2025
			result += "<!-- Updated 01-27-2025 -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS J52 LAA KPUB\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
...
// DFW-PVD skipped
		...
		case "PVU": // DFW-PVU // Updated 04-13-2026
			result += "<!-- Updated 04-13-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 03-01-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J12 HELPR YMONT TAYTR4 KPVU\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE LAA JNC J12 HELPR YMONT TAYTR4 KPVU\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J15 RSK DVC HELPR YMONT TAYTR4 KPVU\" readonly>";
			result += "<br/><br/>North via FQF<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW END PENUT Q148 LEWOY GLL RIDJE J56 CHE J24 MTU TAYTR4 KPVU\" readonly>";
			result += "<br/>South via ELP<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN INK J50 ELP J86 INW CORKR J11 BCE TAYTR4 KPVU\" readonly>";
			result += "<br/><br/>COWBOY WEST (FL220 to SAT)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY SAT DLF FST ELP J86 INW CORKR J11 BCE TAYTR4 KPVU\" readonly>";
		...
		case "PWM": // DFW-PWM // Updated 03-01-2026
			...
			result += "<br/>MH<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR TWOUP Q22 BEARI FAK AML Q221 BIGEO J49 ALB CAM CDOGG4 KPWM\" readonly>";
			break;
		 case "RAP": // DFW-RAP // Updated 03-01-2026
			result += "<!-- Updated 03-01-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 03-01-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW HLC KEOTA KRAP\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 MCI OVR ONL J151 RAP KRAP\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 RAP KRAP\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 03-01-2026
			break;
		case "RDM": // DFW-RDM // Updated 03-01-2026
			result += "<!-- Updated 03-01-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 03-01-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TCC J76 FTI J58 MLF ELY J523 REO KRDM\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW END PENUT Q148 LEWOY LAR J54 BOI IMB ROAMS ARNOY KRDM\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 BLD J92 FMG J5 LKV KRDM\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 03-01-2026
			break;
		case "RDU": // DFW-RDU // Updated 12-15-2025
			result += "<!-- Updated 12-15-2025 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM VXV KPASS ALDAN4 KRDU\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM J78 HVQ FRIKY ALDAN4 KRDU\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN THRSR IRQ PYRES DMSTR2 KRDU\" readonly>";
			result += "<br/><br/>COWBOY EAST (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH MCB MGMRY IRQ PYRES DMSTR2 KRDU\" readonly>"; // CDR 1S
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW EIC MHZ MEI LGC IRQ CAE BUZZY1 KRDU\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 12-15-2025
			result += "<!-- Verified with ATCSCC on 12-15-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM VXV KPASS ALDAN4 KRDU\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG BNA VXV KPASS ALDAN4 KRDU\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH MCB MGMRY IRQ PYRES DMSTR2 KRDU\" readonly>";
			break;
...
// RFD skipped
		...
		case "RIC": // DFW-RIC // Updated 09-13-2025
			...
			break;
		case "RNO": // DFW-RNO // Updated 03-24-2026
			result += "<!-- Updated 03-24-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 RSK ILC J198 MVA SCOLA1 KRNO\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE ZAROS Q128 JSICA MVA SCOLA1 KRNO\" readonly>";
			...
			result += "<br/><br/>North via SLC<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE LAA J20 OCS J94 LCU MAGPY Q132 MYBAD WADOL4 KRNO\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW CYOTE4 TXO TCC J76 FTI J58 RSK ILC J198 MVA RYANN2 KRNO\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-24-2026
			result += "<!-- Verified with ATCSCC on 03-24-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO TCC J76 FTI J58 RSK ILC MVA RYANN2 KRNO\" readonly>";
			...
			break;
		case "ROC": // DFW-ROC // Updated 03-01-2026
			result += "<!-- Updated 03-01-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD KLYNE Q29 JHW KROC\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J87 JOT J146 GIJ J554 JHW KROC\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN GQO SMTTH Q67 HNN AIR JHW KROC\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-01-2026
			result += "<!-- Verified with ATCSCC on 03-01-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD KLYNE Q29 JHW KROC\" readonly>";
			result += "<br/>1N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG PXV ROD KLYNE Q29 JHW KROC\" readonly>";
			break;
...
// RST skipped
		...
		case "SAN": // DFW-SAN // Updated 03-14-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J78 PKE LUCKI1 KSAN\" readonly>";
			// result += "<br/>Weekend/Holiday: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA KA21W TMACK GBN J2 HOGGZ LUCKI1 KSAN\" readonly>";
			...
			result += "<br/>EE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX ONM SSO GBN J2 HOGGZ LUCKI1 KSAN\" readonly>";
			break;
		case "SAT": // DFW-SAT // Updated 05-25-2026
			result += "<!-- Updated 05-25-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL230):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW JASPA7 WINDU QERVO3 KSAT\" readonly>"; // CDR 0P
			result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IDU WEMAR KSAT\" readonly>";
			result += "<br/><b>Only use east if hazardous weather prevents all western routes. Expect CDR1E but you can request this route<\/b>";
			result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 DOSXX SJT TRVLL DNKIN2 KSAT\" readonly>"; // CDR 1W
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW JPOOL7 ACT MARCS2 KSAT\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-25-2026
			result += "<!-- Verified with ATCSCC on 05-25-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW JASPA7 WINDU QERVO3 KSAT\" readonly>";
			result += "<br/>1E<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP DAS CAAGE QERVO3 KSAT\" readonly>";
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW WSTEX2 DOSXX SJT TRVLL DNKIN2 KSAT\" readonly>";
			result += "<br/>2W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN WUNIL SJT TRVLL DNKIN2 KSAT\" readonly>";
			result += "<br/>3W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW WSTEX2 WSTEX DILLO POPPO2 KSAT\" readonly>";
			break;
		case "SAV": // DFW-SAV // Updated 09-27-2025
			result += "<!-- Updated 09-27-2025 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK MHZ MERDN Q184 ARNNY FRDDO DBN V154 OCONE T408 LOTTS KSAV\" readonly>";
			...
			break;
		case "SBA": // DFW-SBA // Updated 07-21-2026
			result += "<!-- Updated 07-21-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			// .. TNP FIM KWANG KSBA
			// .. HEC PTBL2 KSBA
			result += "<br/><input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J74 PKE TNP PORPS PITBL2 KSBA\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 PGS J64 HEC PITBL2 KSBA\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN BGS J66 EWM J4 TNP PORPS PITBL2 KSBA\" readonly>";
			result += "<br/><br/>North via Pueblo<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE LAA DAAYE Q90 JASSE PGS J64 HEC PITBL2 KSBA\" readonly>"; // Based on CDR 1N
			result += "<br/><br/>COWBOY WEST 1 (FL220 to JCT)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT J86 ELP J50 SSO J4 TNP PORPS PITBL2 KSBA\" readonly>"; // CDR 1S
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW CYOTE4 TXO J72 ABQ J6 HEC PTBL2 KSBA\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-21-2026
			result += "<!-- Verified with ATCSCC on 07-21-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J74 PKE TNP FIM KWANG KSBA\" readonly>";
			result += "<br/>1N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW LOWGN8 ADM MRMAC CRUSR J6 DRK J231 TNP FIM KWANG KSBA\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT J86 ELP J50 SSO J4 TNP FIM KWANG KSBA\" readonly>";
			break;

// DFW-SBN skipped

		case "SBP": // DFW-SBP // Updated 01-13-2026
			result += "<!-- Updated 01-13-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 01-13-2026
			// PMD MQO KSBP
			// CNDOR CADAB KSBP
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 ABQ J6 PMD MQO KSBP\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ADM MRMAC CRUSR AGGIY Q162 GUP J8 EED J6 PMD MQO KSBP\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN BGS J66 EWM J4 SSO J50 TFD J169 LAX J88 RZS KSBP\" readonly>";
			result += "<br/><br/>North via GCK<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK J110 RSK J64 HEC J6 PMD MQO KSBP\" readonly>";
			result += "<br/><br/>COWBOY WEST 1 (FL220 to JCT)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY JCT J86 ELP J50 TFD J169 LAX J88 RZS KSBP\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW CYOTE4 CNX J74 LAX J88 RZS KSBP\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 01-13-2026
			break;
		case "SDF": // DFW-SDF // Updated 08-29-2025
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC FAM IMOUT MBELL5 KSDF\" readonly>"; // CDR 1N
		...
		case "SEA": // DFW-SEA // Updated 03-14-2026
			result += "<!-- Updated 03-14-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>";
			// result += "<br/><input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 FQF J20 PDT CHINS5 KSEA\" readonly>"; // CDR 0P
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH KD48U MTU OGD PDT CHINS5 KSEA\" readonly>";
			...
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 MLF ELY J523 REO PDT CHINS5 KSEA\" readonly>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-14-2026
			result += "<!-- Verified with ATCSCC on 03-14-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 FQF J20 PDT CHINS5 KSEA\" readonly>";
			...
			result += "<br/>2S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 SAT DLF INK J15 BOI PDT CHINS5 KSEA\" readonly>";
			result += "<br/>3S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW NELYN6 SAT FST PEQ CME J15 BOI PDT CHINS5 KSEA\" readonly>";
			break;

// SFB skipped

		case "SFO": // DFW-SFO // Updated 05-12-2026
			result += "<!-- Updated 05-12-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO FTI J58 OAL INYOE DYAMD5 KSFO\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS LBL LAA BRK EKR J173 TCH J154 BAM J32 LLC LEGGS BDEGA4 KSFO\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN ELP Q4 SPTFR DECAS J65 PMD AVE MAKRS SERFR SERFR4 KSFO\" readonly>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-12-2026
			result += "<!-- Verified with ATCSCC on 05-12-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO TCC FTI J58 OAL INYOE DYAMD5 KSFO\" readonly>";
			...
			break;
		case "SGF": // DFW-SGF // Updated 03-04-2026
			result += "<!-- Updated 03-04-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC V63 BILIE KSGF\" readonly>"; // Based on CDR 0P
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT KSGF\" readonly>"; // CDR 1E
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA HUSKA CNU KSGF\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC KSGF\" readonly>";
			result += "<br/>1E<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT KSGF\" readonly>";
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH MMB PER EOS KSGF\" readonly>";
			break;
		case "SHV": // DFW-SHV // Updated 03-04-2026
			result += "<!-- Updated 03-04-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-04-2026
			result += "<!-- Verified with ATCSCC on 03-04-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 MRSSH KSHV\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC FSM TXK EIC KSHV\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LFK EMG KSHV\" readonly>";
			break;
		case "SJC": // DFW-SJC // Updated 09-06-2026
			result += "<!-- Updated 09-06-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 09-06-2026
			result += "<!-- Verified with ATCSCC on 09-06-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO TCC FTI J58 ILC KNGRY RAZRR5 KSJC\" readonly>";
			result += "<br/>1N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW LOWGN8 ADM MRMAC CRUSR J6 PNH J58 ILC KNGRY RAZRR5 KSJC\" readonly>";
			...
			break;
		case "SLC": // DFW-SLC // Updated 03-24-2026
			result += "<!-- Updated 03-24-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J12 HELPR JAZZZ1 KSLC\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE LAA JNC J12 HELPR JAZZZ1 KSLC\" readonly>"; // CDR 1N
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX J15 RSK DVC HELPR JAZZZ1 KSLC\" readonly>";
			...
			result += "<br/>South via ELP (FL220 to SAT)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW NELYN6 HOARY SAT DLF FST ELP J86 INW CORKR J11 BCE QWENN7 KSLC\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW CYOTE4 PNH ALS JNC J12 HELPR SPANE8 KSLC\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-24-2026
			result += "<!-- Verified with ATCSCC on 03-24-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH ALS JNC J12 HELPR JAZZZ1 KSLC\" readonly>";
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS TOTOE LAA JNC J12 HELPR JAZZZ1 KSLC\" readonly>";
		...
		case "SMF": // DFW-SMF // Updated 07-18-2025
			...
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO FTI J58 MLF TATOO CRASY SLMMR5 KSMF\" readonly>"; // CDR 0P
			...
			result += "<br/>South Arvl<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TCC GUP J96 PKE J4 RUSTT BOILE J50 LANDO J65 EHF NURAY SUUTR4 KSMF\" readonly>";
			result += "<br/><br/>South via EWM<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN ELP Q4 SPTFR DECAS J65 EHF NURAY SUUTR4 KSMF\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO TCC FTI J58 MLF TATOO CRASY SLMMR5 KSMF\" readonly>";
			...
			break;
		case "SNA": // DFW-SNA // Updated 03-11-2026
			result += "<!-- Updated 03-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN INK EWM J4 BXK EMLLD DSNEE6 KSNA\" readonly>"; // CDR 0P
			result += "<br/><b>If Jackal sua active: .. J4 SSO J50 TFD J212 BXK EMLLD DSNEE6 KSNA<\/b>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J74 SJN DRK HIMDU ROOBY3 KSNA\" readonly>";
			...
			result += "<br/>EE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW KATZZ3 BRHMA CNX ONM SSO J4 BXK EMLLD DSNEE6 KSNA\" readonly>";
			break;
		case "SPS": // DFW-SPS // Updated 03-04-2026
			result += "<!-- Updated 03-04-2026 -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL080): </b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW KING5 SPS KSPS\" readonly>";
			result += "<br/><br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 WSTEX KSPS\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
		...
		case "SRQ": // DFW-SRQ // Updated 03-24-2026
			...
			result += "<br/><br/>Full OW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV MUSYL KELPP ALGAE DTSCK CIGAR RAYZZ3 KSRQ\" readonly>";
			...
			break;
		case "STL": // DFW-STL // Updated 08-14-2026
			result += "<!-- Updated 08-14-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 ICT BUM KAYLA3 KSTL\" readonly>";
			break;
		case "STS": // DFW-STS // Updated 03-04-2026
			result += "<!-- Updated 03-04-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 03-04-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J72 BTY RUSME VNYRD1 KSTS\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 RSK ROCCY Q164 KATTS Q136 OAL YOSEM VNYRD1 KSTS\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN EWM J4 SSO J50 TFD J212 DECAS J65 EHF RGOOD VNYRD1 KSTS\" readonly>";
			result += "<br/><br/>North via DEN<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA PER HLC BBULL Q136 OAL YOSEM VNYRD1 KSTS\" readonly>";
...
// SWF skipped
		...
		case "SYR": // DFW-SYR // Updated 05-11-2026
			result += "<!-- Updated 05-11-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 KONGO Q71 PSB J59 SYR KSYR\" readonly>";
			result += "<br/><b>CDR 0P uses ZACHH4 BSKAT but ZACHH4 to new england destinations will red brick unless restrictions are disabled<\/b>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J110 VHP ROD KLYNE Q29 GONZZ KSYR\" readonly>"; // Based on CDR 1N
			result += "<br/><b>Via FAM: ... RZC FAM SAM ROD KLYNE Q29 ...<\/b>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD IZAAC Q30 VLKNN GQO BOBBD Q71 PSB J59 KSYR\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "TLH": // DFW-TLH // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB J50 CEW KTLH\" readonly>"; // CDR 0P
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS LDK MGM SZW KTLH\" readonly>";
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 CEW KTLH\" readonly>"; // CDR 1S
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 CEW KTLH\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-08-2026
			result += "<!-- Verified with ATCSCC on 05-08-2026 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB J50 CEW KTLH\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 CEW KTLH\" readonly>"; // COWBOY EAST 1 (FL230 to LCH)
			break;
		case "TPA": // DFW-TPA // Updated 12-15-2025
			result += "<!-- Updated 12-15-2025 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/>OW: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP HRV Q105 REDFN Y280 CHRGE RAYZZ3 KTPA\" readonly>";
			result += "<br/><br/>Non OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN MAATY6 KTPA\" readonly>";
			result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS LDK MGM ACORI MAATY6 KTPA\" readonly>";
			result += "<br/><br/>Full OW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV MUSYL KELPP ALGAE DTSCK CIGAR RAYZZ3 KTPA\" readonly>";
			result += "<br/><br/>COWBOY EAST 1 (FL230 to LCH)<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 DEFUN MAATY6 KTPA\" readonly>"; // CDR 1S
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW ARDIA7 CLL TNV IAH LCH J2 DEFUN MAATY6 KTPA\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 12-15-2025
			result += "<!-- Verified with ATCSCC on 12-15-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK MERDN DEFUN MAATY6 KTPA\" readonly>"; // 
			result += "<br/>1N<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MERDN DEFUN MAATY6 KTPA\" readonly>"; // 
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 DEFUN MAATY6 KTPA\" readonly>"; // COWBOY EAST (FL230 TO LCH)
			break;
		case "TUL": // DFW-TUL // Updated 05-25-2026
			result += "<!-- Updated 05-25-2026 P -->";
			result += "<br/><br/><b>Faa Pref Route (Avg FL250):</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW GRABE8 EAKER KTUL\" readonly>"; // CDR 0P
			result += "<br/><br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW HUDAD3 PGLET SPS FILGO IRW OKM KTUL\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD CDS IRW KTUL\" readonly>";
			break;
		case "TUS": // DFW-TUS // Updated 08-05-2025
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TXO J74 CNX ONM J104 SSO ZONNA2 KTUS\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "TVC": // DFW-TVC // Updated 05-08-2026
			result += "<!-- Updated 05-08-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 05-08-2026
			result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL BDF BAE KTVC\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEMFS Q29 SIDAE VHP PMM KTVC\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW J21 OVR FOD RST GRB KTVC\" readonly>";
			// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 05-08-2026
			break;
		case "TYS": // DFW-TYS // Updated 10-30-2025
			...
			break;
		case "VPS": // DFW-VPS // Updated 11-25-2025
			result += "<!-- Updated 11-25-2025 P -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB MUURY CEW KVPS\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MEI CEW KVPS\" readonly>"; // CDR 0P
			result += "<br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 CEW KVPS\" readonly>"; // CDR 1S
			result += "<br/><br/>North via VUZ<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD SQS VUZ MGM CEW KVPS\" readonly>";
			result += "<br/>North via ARG<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEM VLKNN Q139 MGMRY CEW KVPS\" readonly>"; // CDR 1N
			result += "<br/><br/><b>Non RNAV</b>";
			result += "<br/><input style=\"width:75%\" value=\"KDFW DALL3 EIC MCB J50 CEW KVPS\" readonly>";
			result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 11-25-2025
			result += "<!-- Verified with ATCSCC on 11-25-2025 -->";
			result += "<br/>0P<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW FORCK3 FORCK ELD MEI CEW KVPS\" readonly>";
			result += "<br/>1N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC ARG MEM VLKNN Q139 MGMRY CEW KVPS\" readonly>";
			result += "<br/>1S<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW DARTZ9 TNV IAH LCH J2 CEW KVPS\" readonly>";
			break;
		case "XNA": // DFW-XNA // Updated 08-23-2025
			...
			result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J26 MMB TUL RZC KXNA\" readonly>";
			break;
		case "YEG": // DFW-YEG // Updated 04-10-2026
			result += "<!-- Updated 04-10-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 04-10-2026
			result += "<br/><br/>CFS: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK CYS J13 GTF J516 YQL MIREK Q995 OILRS OILRS2 CYEG\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 ZEMMA PER SLN ONL MOT Q971 TAGOT Q819 CAMRA IGSOX3 CYEG\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 MLF ELY J523 REO J153 GEG YXC MIREK Q995 OILRS OILRS2 CYEG\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
...
// YQB skipped
		...
		case "YUL": // DFW-YUL // Updated 04-10-2026
			result += "<!-- Updated 04-10-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 04-10-2026
			result += "<br/><br/>CFS: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL J19 RBS GSH SVM Q907 AGNOB MIGLO HABBS7 CYUL\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 DSM J144 DBQ BAE J36 DABJU MONEE Q935 HOCKE Q905 SIKBO Q907 AGNOB MIGLO HABBS7 CYUL\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE Q34 KONGO Q71 PSB J49 HNK ALB PBERG CARTR5 CYUL\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
		...
		case "YVR": // DFW-YVR // Updated 09-15-2025
			...
			result += "<br/><br/>CFS: <input style=\"width:75%\" value=\"KDFW HUDAD3 HUDAD PNH J17 PUB CHE J163 OCS J52 GEG METOW GRIZZ1 CYVR\" readonly>";
			result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW GCK CYS MBW Q148 WEDAK GEG METOW GRIZZ1 CYVR\" readonly>";
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE TCC J76 FTI J58 MLF ELY J523 SEA PAE GRIZZ1 CYVR\" readonly>";
			result += "<br/><br/>West via ELP<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN INK J50 ELP J86 BAVPE CORKR Q35 IMB J523 SEA PAE GRIZZ1 CYVR\" readonly>";
			// result += "<br/><br/>North: <input style=\"width:75%\" value=\"KDFW BLECO8 IRW J21 ICT HCT BFF BOY DBS J52 GEG METOW GRIZZ1 CYVR\" readonly>";
			result += "<br/>West: <input style=\"width:75%\" value=\"KDFW WSTEX2 CIKAN CME J15 ABQ BCE J523 SEA PAE GRIZZ1 CYVR\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
		...
		case "YYC": // DFW-YYC // Updated 03-25-2026
			...
			result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW HRPER4 HULZE FTI J58 MLF ELY J523 REO J153 GEG ANTAK Q953 IGVEP IGVEP7 CYYC\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
			...
			break;
		case "YYZ": // DFW-YYZ // Updated 04-10-2026
			result += "<!-- Updated 04-10-2026 P -->";
			// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 04-10-2026
			result += "<br/><br/>CFS: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL BVT CRL QWERI NUBER6 CYYZ\" readonly>";
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW BLECO8 TUL J25 DSM J144 DBQ BAE J36 DABJU MONEE NUBER6 CYYZ\" readonly>";
			result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW ZACHH4 BSKAT LIT J131 PXV ROD J43 CRL QWERI NUBER6 CYYZ\" readonly>";
			// result += "<br/><br/><b>Non RNAV</b>";
