...
// DLH skipped
		...
		case "GRR": // DFW-GRR // Updated 09-28-2025
			...
			break;
		case "GSO": // DFW-GSO // Updated 11-10-2025
			result += "<!-- Updated 11-10-2025 P -->";
			...
			result += "<br/><br/>South/ZTL Avoid<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWEUP MCB J50 CEW KJ06Q AMG TEEEM Q75 FISHO CAE BLOCC2 KGSO\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
