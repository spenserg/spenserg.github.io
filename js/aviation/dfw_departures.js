dfw_departures = function (arvl = "XXX", tail = null, ac_type = null, result = "") {
	switch(arvl) {
		...
		case "CAE": // DFW-CAE // Updated 05-15-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW TRYTN4 LOOSE MEM GQO IRQ OSPRI7 KCHS\" readonly>";
...
// DLH skipped
		...
		case "GSO": // DFW-GSO // Updated 05-06-2026
			...
			result += "<br/><br/>South/ZTL Avoid<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA MCB J50 CEW J2 DEFUN CABLO AMG SAV CHECR STOCR5 KCLT\" readonly>";
		...
		case "IND": // DFW-IND // Updated 06-09-2026
			...
			result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDFW AKUNA9 MLC RZC STL JAAVE KOLTS2 KIND\" readonly>";
			result += "<br/><b>North of STL: .. RZC SGF USIRE KOLTS2 KIND<\/b>";
