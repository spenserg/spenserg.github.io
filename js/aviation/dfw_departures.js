dfw_departures = function (arvl = "XXX", tail = null, ac_type = null, result = "") {
	switch(arvl) {
		...
		case "AMA": // Updated 03-25-2025
			...
			break;
		case "ATL": // Updated 05-09-2025 // Mandatory Routes checked
			result += "<!-- Updated 05-09-2025 MP -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "CLE": // Updated 03-30-2025
			...
			break;
		case "CLT": // Updated 06-03-2025 // Mandatory Routes checked
			...
			result += "<br/><br/>South<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWB MCB J50 CEW ALLMA ISUZO CHECR STOCR4 KCLT\" readonly>"; // CDR FP
...
// TODO DLH
		...
		case "LEX": // Updated 04-18-2025 // Mandatory Routes checked
			...
			break;
		case "LGA": // Updated 05-09-2025 // Mandatory Routes checked
			result += "<!-- Updated 05-09-2025 MP -->";
		...
		case "ONT": // Updated 01-24-2025
			...
			break;
		case "ORD": // Updated 05-26-2025 // Mandatory Routes checked
...
// SFB skipped
		...
		case "SMF": // Updated 01-29-2025
			...
			break;
		case "SNA": // Updated 05-26-2025 // Mandatory Routes checked
			result += "<!-- Updated 05-26-2025 MP -->";
			result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "SRQ": // Updated 01-29-2025
			...
			// result += "<br/><br/><b>CDRS</b>";
			break;
		case "STL": // Updated 05-17-2025 // Mandatory Routes checked
