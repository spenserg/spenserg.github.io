...
// TODO DLH
		...
		case "IAH": // Updated 04-14-2025
			...
			result += "<br/>1E<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDFW MRSSH3 ZALEA SWB ZEEKK3 KIAH\" readonly>";
...
// SFB skipped
		...
		case "SJC": // Updated 06-22-2025
			...
			result += "<br/><br/>North/ZAB Avoid<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDFW LOWGN8 ROLLS LBL PUB J28 MLF J80 ILC KNGRY RAZRR5 KSJC\" readonly>";
			result += "<br/><br/><b>Non RNAV</b>";
