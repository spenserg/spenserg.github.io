		...
		case "PHL":
			switch(arvl) {
				...
				case "ORD": // Updated 03-10-2025
					...
					result += "<br/><br/><b>CDRS</b>" // Verified with ATCSCC on 03-10-2025
					result += "<br/>36<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 HNNAH LAAYK Q436 EMMMA WYNDE2 KORD\" readonly>";
					...
					result += "<br/>95<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 HNNAH Q450 JFK CFB RAAKK Q436 EMMMA WYNDE2 KORD\" readonly>";
					result += "<br/>CA<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 LLUND CAM Q822 FNT WYNDE2 KORD\" readonly>";
				...
				case "PBI": // Updated 03-10-2025
					...
					result += "<br/>4C<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL STOEN REEFI EMI J48 MOL FLASK COREX SPA QUIWE Q93 KENLL CPTAN3 KPBI\" readonly>";
				...
				case "PDX": // Updated 03-10-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref listed
				...
				case "PVD": // Updated 02-28-2025
					...
					break;
				case "PIT": // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPHL MXE PENSY J110 VINSE DEMME5 KPIT\" readonly>"; // CDR PH
					result += "<br/><br/>PHLYER WEST (Max FL080):<input style=\"width:75%\"; value=\"KPHL MXE T456 VINSE LEJOY NESTO KPIT\" readonly>";
					result += "<br/>TEC: <input style=\"width:75%\"; value=\"KPHL FJC WLKES T440 STUBN ROC BUF ERI YTOWN JESEY5 KPIT\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "ROC": // Updated 03-10-2025
					...
					result += "<br/>DT<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 HNNAH Q450 JFK CFB V252 GIBBE KROC\" readonly>";
				...
				case "RSW": // Updated 03-10-2025
					...
					result += "<br/><br/>ATLANTIC S1: <input style=\"width:75%\"; value=\"KPHL OOD TEBEE HAYDO SIE WICKE LYNUS CUMBY LOZER WHOOS WEAKK BAHAA HIBAC SHFTY5 KRSW\" readonly>";
					result += "<br/>VACAPES S1: <input style=\"width:75%\"; value=\"KPHL OOD TEBEE HAYDO SIE B24 CORNE ECG WEAKK BAHAA HIBAC SHFTY5 KRSW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "SAN": // Updated 03-10-2025
					...
					result += "<br/>36<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 HNNAH LAAYK Q436 HERBA JHW Q29 KLYNE PXV J78 FAM J98 SGF IFI DANKS EZEEE GUP J96 PKE LUCKI1 KSAN\" readonly>";
					result += "<br/>60<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL PTW SARAA RAV PSB J60 HVE PROMT Q88 HAKMN Q73 LVELL LUCKI1 KSAN\" readonly>";
					...
					result += "<br/>J6<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL MXE PENSY J110 FLIRT J6 COLNS Q176 BUM ICT LBL FTI J18 HOGGZ LUCKI1 KSAN\" readonly>";
				...
				case "SEA": // Updated 03-10-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref listed 03-11-25
				...
				case "SFO": // Updated 01-16-2025
					...
					result += "<br/><br/><b>CDRS</b>" // Verified with ATCSCC on 03-10-2025
					result += "<br/>36<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 HNNAH LAAYK Q436 RAAKK Q438 RUBYY DABJU J36 BAE J16 FSD J82 CZI J32 LLC LEGGS BDEGA4 KSFO\" readonly>";
					result += "<br/>47<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 LLUND CAM HANAA Q816 HOCKE BAE J16 FSD J82 CZI J32 LLC LEGGS BDEGA4 KSFO\" readonly>";
					result += "<br/>60<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL PTW SARAA RAV PSB J60 DBL J80 OAL INYOE DYAMD5 KSFO\" readonly>";
					...
					result += "<br/>95<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH Q437 HNNAH Q450 JFK CFB Q818 DERLO HOCKE GRB GEP J70 ABR J32 LLC LEGGS BDEGA4 KSFO\" readonly>";
				...
				case "SYR": // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPHL PTW CHLSE T449 CFB T335 CORTA KSYR\" readonly>"; // CDR PH
					// result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><br/><b>CDRS</b>" // Verified with ATCSCC on 03-11-2025
				...
				case "TPA": // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPHL STOEN Q75 TEUFL BAAMF DADES1 KTPA\" readonly>"; // CDR PH
					result += "<br/><br/>OW: <input style=\"width:75%\"; value=\"KPHL OOD TEBEE HAYDO TRPOD Q409 CRPLR EARZZ Q131 PRONI WAALT Y289 BAHAA HIBAC DADES1 KTPA\" readonly>";
					result += "<br/>Full OW/ZDC Avoid<input style=\"width:75%\" value=\"KPHL OOD TEBEE HAYDO SIE B24 LYNUS SILLY Y485 STERN Y493 BAHAA HIBAC DADES1 KTPA\" readonly>"; // CDR AZ					
					result += "<br/><br/>East<input style=\"width:75%\" value=\"KPHL STOEN Q75 TEUFL BAAMF DADES1 KTPA\" readonly>"; // CDR PH
					...
					result += "<br/><br/>ATLANTIC SOUTH 1<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\"; value=\"KPHL OOD TEBEE HAYDO SIE WICKE LYNUS CUMBY LOZER WHOOS WEAKK BAHAA HIBAC DADES1 KTPA\" readonly>";
					result += "<br/>NE TO FL VIA J6: <input style=\"width:75%\"; value=\"KPHL MXE PENSY J110 FLIRT J6 HVQ SPAYD VXV THRSR HONID MAATY4 KTPA\" readonly>";
					result += "<br/>NE TO FL VIA J64: <input style=\"width:75%\"; value=\"KPHL PTW SARAA RAV J64 BURNI QUARM AIR HVQ J85 SPA BAAMF DADES1 KTPA\" readonly>";
					result += "<br/>NE TO FL VIA Q480: <input style=\"width:75%\"; value=\"KPHL MXE PENSY J110 AIR HVQ J85 SPA BAAMF DADES1 KTPA\" readonly>";
					result += "<br/>VACAPES SOUTH 1: <input style=\"width:75%\"; value=\"KPHL OOD TEBEE HAYDO SIE B24 CORNE ECG ADUCI BAHAA HIBAC DADES1 KTPA\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KPHL STOEN Q75 GVE SLOJO FLYNT CYNTA TAY LAL BRDGE BRDGE9 KTPA\" readonly>";
					result += "<br/><br/><b>CDRS</b>" // Verified with ATCSCC on 03-11-2025
					result += "<br/>48<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL STOEN REEFI EMI J48 MOL FLASK COREX SPA BAAMF DADES1 KTPA\" readonly>";
					...
					result += "<br/>80<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL MXE PENSY J110 AIR HVQ J85 SPA BAAMF DADES1 KTPA\" readonly>";
					result += "<br/>85<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL PTW SARAA RAV J64 BURNI TYROO QUARM AIR HVQ J85 SPA BAAMF DADES1 KTPA\" readonly>";
					...
					result += "<br/>AZ<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL OOD TEBEE HAYDO SIE B24 LYNUS SILLY Y485 STERN Y493 BAHAA HIBAC DADES1 KTPA\" readonly>";
					result += "<br/>DQ<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DQO BELAY MORTY LITME HIRCK JDUBB RRSIN GSO Q75 TEUFL BAAMF DADES1 KTPA\" readonly>";
					result += "<br/>J6<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL MXE PENSY J110 FLIRT J6 HVQ J85 SPA BAAMF DADES1 KTPA\" readonly>";
					result += "<br/>KA<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL OOD TEBEE HAYDO TRPOD Q409 PUPYY BAAMF DADES1 KTPA\" readonly>";
					result += "<br/>PH<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL STOEN Q75 TEUFL BAAMF DADES1 KTPA\" readonly>";
					break;
...
// PUB skipped
		...
		case "RDM":
			switch(arvl) {
				case "DFW": // Updated 03-11-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref listed as of 03-12-2025
		...
		case "SAT":
			switch(arvl) {
				case "CLT": // Updated 03-11-2025
					...
					result += "<br/><br/>North: <input style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ ELD IZAAC Q30 VLKNN THRSR BESTT JONZE5 KCLT\" readonly>"; // CDR 1X
					result += "<br/>South: <input style=\"width:75%\" value=\"KSAT SLENA1 BRENI LAMMY TBD HRV Q56 CATLN BESTT JONZE5 KCLT\" readonly>"; // CDR 5X
					result += "<br/><br/><b>Non RNAV</b>";
