		...
		case "OKC":
			switch(arvl) {
				...
				case "DCA": // Updated 08-04-2025
					...
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KOKC TRUPR3 DRLER SGF STL VHP RINTE APE J30 LUISE FRDMM6 KDCA \" readonly>";
