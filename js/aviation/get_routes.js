get_routes = function(dptr = "XXX", arvl = "XXX", tail = null, ac_type = null, result = "") {
	...
	switch(dptr) {
		...
		case "ABE":
			switch(arvl) {
				case "JFK": new_title=" U3/17/25"; // Updated 03-17-2025
					...
					break;
				case "PHL": new_title=" U3/17/25"; // Updated 03-17-2025
		...
		case "ABI":
			switch(arvl) {
				case "DFW": new_title=" U1/19/25"; // Updated 01-19-2025
		...
		case "ABQ":
			switch(arvl) {
				case "DFW": new_title=" U2/21/25"; // Updated 02-21-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "LAX": new_title=" U2/21/25"; // Updated 02-21-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U2/21/25"; // Updated 02-21-2025
		...
		case "AGS":
			switch(arvl) {
				case "CLT": new_title=" U1/30/25"; // Updated 01-30-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "DFW": new_title=" U2/6/25"; // Updated 02-06-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "ALB":
			switch(arvl) {
				case "CLT": new_title=" U2/21/25"; // Updated 02-21-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "AUS":
			switch(arvl) {
				case "DFW": // Updated 10-22-24
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-19-2025
				...
				case "CLT": // No faa pref  // Updated 10-22-24
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-29-2025
				...
				case "ORD": // Updated 10-22-24
					...
					break;
				case "JFK": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "AVP":
			switch(arvl) {
				case "CLT": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "BDL":
			switch(arvl) {
				case "DCA": new_title="M U4/19/25"; // Updated 04-19-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-19-2025
		...
		case "BFL":
			switch(arvl) {
				case "DFW": // Updated 10-22-24
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 02-22-2025
		...
		case "BGR":
			switch(arvl) {
				case "CLT": new_title=" U2/6/25"; // Updated 02-06-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "BHM":
			switch(arvl) {
				...
				case "CLT": // Updated 10-22-2024
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "MIA": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "BIL":
			switch(arvl) {
				case "DFW": new_title=" U2/23/25"; // Updated 02-23-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// BIL-PHX skipped
		...
		case "BOS":
			switch(arvl) {
				case "CLT": new_title="M U4/19/25"; // Updated 04-19-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DCA": // Updated 10-22-24
					...
					break;
				case "DFW": new_title="M U4/19/25"; // Updated 04-19-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MIA": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/>OW: <input style=\"width:75%\" value=\"KBOS SSOXS7 SSOXS Q167 RIFLE HEADI Q97 KALDA Q101 SKARP Y313 HOAGG BNFSH2 KMIA\" readonly>";
					result += "<br/><br/>Non OW: <input style=\"width:75%\" value=\"KBOS SSOXS7 SSOXS Q167 RIFLE HEADI Q97 DEBRL CSTAL2 KMIA\" readonly>";
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-17-2025
					...
					result += "<br/>A4<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS BLZZR6 BLZZR BAF Q448 PTW J48 EMI GVE Q75 GSO Q83 JEVED Q97 DEBRL CSTAL2 KMIA\" readonly>";
					...
					result += "<br/>DW<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS SSOXS7 SSOXS Q167 SPDEY Y488 STERN Y493 JENKS HOAGG BNFSH2 KMIA\" readonly>";
					...
					result += "<br/>F4<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS BLZZR6 BLZZR BAF Q448 PTW J48 MOL FLASK GOWBE BURGG QUIWE Q93 DEBRL CSTAL2 KMIA\" readonly>";
					result += "<br/>F8<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS BLZZR6 BLZZR BAF Q480 AIR HVQ J85 SPA QUIWE Q93 DEBRL CSTAL2 KMIA\" readonly>";
					result += "<br/>F9<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS HYLND7 HYLND CAM Q822 GONZZ Q29 WWSHR APE J83 SPA QUIWE Q93 DEBRL CSTAL2 KMIA\" readonly>";
					result += "<br/>FN<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS REVSS6 REVSS CTR HNK J49 PSB QUARM AIR HVQ J85 SPA QUIWE Q93 DEBRL CSTAL2 KMIA\" readonly>";
					...
					result += "<br/>PJ<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS SSOXS7 SSOXS Q167 RIFLE HEADI Q97 KALDA Q101 SKARP Y313 HOAGG BNFSH2 KMIA\" readonly>";
					result += "<br/>PL<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS SSOXS7 SSOXS Q167 RIFLE HEADI Q97 DEBRL CSTAL2 KMIA\" readonly>";
					result += "<br/>S5<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBOS PATSS7 PATSS NELIE Q75 GSO Q83 JEVED Q97 DEBRL CSTAL2 KMIA\" readonly>";
				...
				case "ORD": // Updated 12-22-24
					...
					break;
				case "PHL": new_title=" U4/8/25"; // Updated 04-08-2025
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-08-2025
		...
		case "BRO":
			switch(arvl) {
				case "DFW": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// BTR skipped
		...
		case "BTV":
			switch(arvl) {
				case "CLT": new_title=" U3/17/25"; // Updated 03-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KBTV PONCT BIZEX Q75 GVE AIROW CHSLY6 KCLT\" readonly>"; // CDR PJ
					// result += "<br/><br/><b>Non RNAV</b>"; // toddo
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-17-2025
					...
					break;
				case "DCA": new_title=" U3/17/25"; // Updated 03-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/>T7<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBTV BRATS ORCHA HEADI Q97 SAWED GUILD Q409 OKNEE MLLET3 KCLT\" readonly>";
					break;
				case "ORD": new_title=" U3/17/25"; // Updated 03-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// CAK skipped
		...
		case "CHS":
			switch(arvl) {
				case "DCA": new_title=" U4/16/25"; // Updated 04-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DFW": // Updated 12-23-24
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "CLT": new_title=" U4/16/25"; // Updated 04-16-2025
				...
				case "MIA": // Updated 12-23-24
					...
					break;
				case "PHL": new_title=" U4/16/25"; // Updated 04-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "CMH":
			switch(arvl) {
				case "DFW": // Updated 12-30-24
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "CLT": new_title="M U4/28/25"; // Updated 04-28-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "LAX": new_title=" U3/12/25"; // Updated 03-12-2025
		...
		case "CRP":
			switch(arvl) {
				case "DFW": new_title=" U3/17/25"; // Updated 03-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "CVG":
			switch(arvl) {
				case "CLT": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "DAB":
			switch(arvl) {
				...
				case "DFW": new_title=" U3/17/25"; // Updated 03-17-2025
					...
					// result += "<br/><br/><b>CDRS</b>"; // No CDRS as of 03-17-2025
					break;
				case "MIA": new_title=" U3/17/25"; // Updated 03-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "DCA":
			switch(arvl) {
				case "BDL": new_title=" U4/19/25"; // Updated 04-19-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "BOS": // Updated 12-30-24
					...
					break;
				case "BTV": new_title=" U4/16/25"; // Updated 04-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-16-2025
					...
					break;
				case "CHS": new_title=" U4/16/25"; // Updated 04-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "CLT": new_title=" U4/11/25"; // Updated 04-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-11-2025
				...
				case "DFW": // Updated 12-30-24
					...
					break;
				case "FLL": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "IND": new_title=" U4/10/25"; // Updated 04-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KDCA WYNGS5 RAMAY Q72 HACKS PLASH SNKPT2 KIND\" readonly>"; // CDR 00
					// result += "<br/><br/><b>Non RNAV</b>"; // TODO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-10-2025
					...
					break;
				case "JAX": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "LAS": new_title=" U1/4/25"; // Updated 01-04-2025 // No Faa pref
				...
				case "LAX": // No faa pref route
					...
					break;
				case "LGA": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "MCO":
					...
					//result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-11-2025
					...
					break;
				case "MIA": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MSY": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MSN": new_title="M U4/19/25"; // Updated 04-19-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "ORD": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PBI": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PHX": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 02-28-2025
					...
					break;
				case "RSW": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SRQ": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "STL": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SYR": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "TPA": new_title=" U4/10/25"; // Updated 04-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "VPS": new_title=" U4/11/25"; // Updated 04-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "DEN":
			switch(arvl) {
				case "CLT": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "ORD": new_title=" U1/4/25"; // Updated 01-04-2025
					...
					break;
				case "PHL": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PHX": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// DRO skipped
		...
		case "DSM":
			switch(arvl) {
				case "DFW": // Updated 12-30-24
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "CLT": new_title=" U1/5/25"; // Updated 01-05-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "ORD": new_title=" U1/5/25"; // Updated 01-05-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U1/5/25"; // Updated 01-05-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "DTW":
			switch(arvl) {
				...
				case "CLT": new_title=" U1/5/25"; // Updated 01-05-2025
					...
					break;
				case "MIA": new_title=" U1/5/25"; // Updated 01-05-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "ECP":
			switch(arvl) {
				case "CLT": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DFW": new_title=" U2/28/25"; // Updated 02-28-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "ORD": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "EGE":
			switch(arvl) {
				case "DFW": new_title=" U1/9/25"; // Updated 01-09-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "ELP":
			switch(arvl) {
				case "DFW": new_title=" U1/9/25"; // Updated 01-09-2025
					...
					break;
				case "PHX": new_title=" U1/9/25"; // Updated 01-09-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// EVV skipped
		...
		case "EWR":
			switch(arvl) {
				case "DFW": new_title=" U4/11/25"; // Updated 04-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "MIA":
					...
					break;
				case "ORD": new_title=" U1/9/25"; // Updated 01-09-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "EYW":
			switch(arvl) {
				case "DFW": new_title=" U1/9/25"; // Updated 01-09-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "CLT": new_title=" U1/9/25"; // Updated 01-09-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "FAT":
			switch(arvl) {
				case "DFW": new_title=" U1/9/25"; // Updated 01-09-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U3/25/25"; // Updated 03-25-2025
		...
		case "FCA":
			switch(arvl) {
				case "DFW": new_title=" U3/18/25"; // Updated 03-18-2025
					...
					break;
				case "LGA": new_title=" U3/18/25"; // Updated 03-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>"; // No CDRS as of 03-18-2025
					break;
				case "ORD": new_title=" U3/18/25"; // Updated 03-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "FLL":
			switch(arvl) {
				...
				case "ORD": new_title=" U1/9/25"; // Updated 01-09-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHL": new_title=" U1/9/25"; // Updated 01-09-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "GSP":
			switch(arvl) {
				case "CLT": new_title=" U1/9/25"; // Updated 01-09-2025
					...
					break;
				case "DFW": new_title="M U4/29/25"; // Updated 04-29-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// HRL skipped
		...
		case "IAD":
			switch(arvl) {
				case "DFW":
					...
					break;
				case "CLT": new_title=" U1/10/25"; // Updated 01-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "IAH":
			switch(arvl) {
				case "CLT": new_title=" U3/18/25"; // Updated 03-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-18-2025
					...
					break;
				case "DFW": new_title=" U1/10/25"; // Updated 01-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MIA": new_title=" U1/10/25"; // Updated 01-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "ORD": new_title=" U1/10/25"; // Updated 01-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PHL": new_title=" U1/10/25"; // Updated 01-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PHX": new_title=" U1/10/25"; // Updated 01-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "IND":
			switch(arvl) {
				case "CLT": new_title=" U1/10/25"; // Updated 01-10-2025
					...
					break;
				case "DCA": new_title=" U4/10/25"; // Updated 04-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DFW": new_title=" U1/10/25"; // Updated 01-10-2025
					...
					break;
				case "LAX": new_title=" U1/10/25"; // Updated 01-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "PHX": new_title=" U1/10/25"; // Updated 01-10-2025
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-01-2025
...
// JAN skipped
		...
		case "JAX":
			switch(arvl) {
				case "CLT": new_title=" U2/1/25"; // Updated 02-01-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DFW":
					...
					//result += "<br/><br/><b>CDRS</b>";
					break;
				case "DCA": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "MIA": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHL": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "JFK": // TODO double check JFK destinations
			switch(arvl) {
				case "AUS":
					...
					break;
				case "CLT": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DFW": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "LAS": new_title=" U1/12/25"; // Updated 01-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "LAX": new_title="M U4/28/25"; // Updated 04-28-2025 // Mandatory Routes checked
					...
					//result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-28-2025
				...
				case "MIA": new_title=" U1/11/25"; // Updated 01-11-2025
					...
					break;
				case "ORD": new_title="M U4/19/25"; // Updated 04-19-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "PHX": new_title=" U1/11/25"; // Updated 01-11-2025
					...
					break;
				case "SFO": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "LAS":
			switch(arvl) {
				case "CLT": new_title=" U4/8/25"; // Updated 04-08-2025
					...
					break;
				case "DCA": new_title=" U1/4/25"; // Updated 01-04-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DFW": new_title=" U1/12/25"; // Updated 01-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "JFK": new_title=" U1/12/25"; // Updated 01-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "LAX": new_title=" U1/10/25"; // Updated 01-10-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "MIA": new_title=" U4/9/25"; // Updated 04-09-2025
				...
				case "ORD": // Updated 2024-12-28
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-25-2025
					...
					break;
				case "PHL": new_title=" U1/12/25"; // Updated 01-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PHX": new_title=" U4/9/25"; // Updated 04-09-2025
					result += "<br/><br/><b>Faa Pref Route (Avg FL290):</b>";
...
// LCH skipped
		...
		case "LEX":
			switch(arvl) {
				case "CLT": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "LGA":
			switch(arvl) {
				case "CLT": new_title=" U1/12/25"; // Updated 01-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DCA": new_title=" U1/12/25"; // Updated 01-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DFW": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MCO": new_title=" U4/6/25"; // Updated 04-06-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-06-2025
					...
					break;
				case "MIA": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MSY": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "ORD": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PBI": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "RSW": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SRQ": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "TPA": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-31-2025
		...
		case "LIT":
			switch(arvl) {
				case "DFW": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "MCI":
			switch(arvl) {
				...
				case "ORD": new_title=" U1/15/25"; // Updated 01-15-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "MCO":
			switch(arvl) {
				case "CLT": new_title=" U1/15/25"; // Updated 01-15-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "DCA": new_title=" U1/9/25"; // Updated 01-09-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DFW": new_title=" U1/15/25"; // Updated 01-15-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "LAX": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "LGA": new_title=" U4/6/25"; // Updated 04-06-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "MIA": new_title=" U1/15/25"; // Updated 01-15-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "ORD": new_title=" U4/6/25"; // Updated 04-06-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>"; // None as of 04-06-2025
					break;
				case "PHL": new_title=" U1/15/25"; // Updated 01-15-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KMCO FATHE3 VIYAP Q87 JROSS Q135 RREGG Q117 SAWED Q97 ZJAAY JIIMS4 KPHL\" readonly>";
		...
		case "MDT":
			switch(arvl) {
				case "CLT": new_title=" U1/16/25"; // Updated 01-16-2025
					...
					break;
				case "DFW": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "MEM":
			switch(arvl) {
				case "CLT": new_title=" U4/17/25"; // Updated 04-17-2025
					...
					break;
				case "DCA": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "MIA": new_title=" U4/17/25"; // Updated 04-17-2025
					...
					result += "<br/><br/>Common: <input style=\"width:75%\"; value=\"KMEM BBKNG7 KERMI MGMRY ACORI FROGZ4 KMIA\" readonly>";
					result += "<br/><br/>North/East: <input style=\"width:75%\"; value=\"KMEM BBKNG7 KERMI BEATS J66 RMG THRSR HESPI Q89 PRMUS DEBRL CSTAL2 KMIA\" readonly>";
					result += "<br/>South/OW: <input style=\"width:75%\"; value=\"KMEM PIEPE6 IBUFY MCB HRV Q105 BLVNS Y290 GAWKS FROGZ4 KMIA\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // toddo
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "ORD": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>"; // No CDRS as of 04-17-2025
					break;
				case "PHL": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>"; // No CDRS as of 04-17-2025
					break;
				case "PHX": new_title=" U4/17/25"; // Updated 04-17-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 04-17-2025
		...
		case "MKE":
			switch(arvl) {
				...
				case "DFW": new_title=" U1/16/25"; // Updated 01-16-2025
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-30-2025
					...
					break;
				case "ORD": new_title=" U1/16/25"; // Updated 01-16-2025
					...
					break;
				case "PHX": new_title=" U3/30/25"; // Updated 03-30-2025
...
// MOB skipped
		...
		case "MRY":
			switch(arvl) {
				case "DFW": new_title=" U1/16/25"; // Updated 01-16-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "MSP":
			switch(arvl) {
				case "CLT": new_title=" U2/23/25"; // Updated 02-23-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 02-23-2025
					...
					break;
				case "DFW": new_title=" U1/4/25"; // Updated 01-04-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "MSY":
			switch(arvl) {
				case "CLT": new_title=" U1/16/25"; // Updated 01-16-2025
					...
					break;
				case "DCA": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DFW": new_title=" U1/16/25"; // Updated 01-16-2025
					...
					break;
				case "LGA": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "MIA": new_title=" U1/28/25"; // Updated 01-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PHL": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "OMA":
			switch(arvl) {
				...
				case "MIA": new_title=" U1/17/25"; // Updated 01-17-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "ORD": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "ONT":
			switch(arvl) {
				case "CLT": new_title=" U2/22/25"; // Updated 02-22-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DFW": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "ORF":
			switch(arvl) {
				case "CLT": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route (Avg FL220):</b>";
					...
					break;
				case "DFW": new_title="M U4/28/25"; // Updated 04-28-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "PBI":
			switch(arvl) {
				case "CLT": new_title=" U2/28/25"; // Updated 02-28-2025
					...
					break;
				case "DCA": new_title="M U4/28/25"; // Updated 04-28-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "LGA": new_title=" U3/18/25"; // Updated 03-18-2025
					...
					break;
					break;
				case "ORD": new_title="M U4/28/25"; // Updated 04-28-2025 // Mandatory Routes checked
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPBI TBIRD6 KPASA Q118 HEVAN BONNT VEECK5 KORD\" readonly>"; // CDR T0
					result += "<br/><b style=\"color:orange\">Anything other than CDR T0 will flag as AAL mandatory route violation<\/b>";
					...
					break;
				case "PHL": new_title=" U3/18/25"; // Updated 03-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "PHL":
			switch(arvl) {
				case "ATL": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "AUS": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "BDL": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "BNA": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "BOS": new_title=" U4/8/25"; // Updated 04-08-2025
					result += "<br/><br/><b>Faa Pref Route (Avg FL230):</b>";
					...
					break;
				case "BUF": new_title=" U2/7/25"; // Updated 02-07-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "CHS": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "CLE": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-02-2025
					...
					break;
				case "CLT": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "CMH": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "CVG": new_title=" U2/7/25"; // Updated 02-07-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DCA": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DEN": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
					break;
				case "DFW": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DSM": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DTW": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "FLL": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "GRR": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "IAH": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "IND": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "JAX": new_title=" U3/2/25"; // Updated 03-02-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "LAS": new_title=" U3/27/25"; // Updated 03-27-2025
					...
					break;
				case "LAX": new_title=" U3/10/25"; // Updated 03-10-2025
					...
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-10-2025
					...
					break;
				case "LGA": new_title=" U3/3/25"; // Updated 03-03-2025
					...
					break;
				case "MCI": new_title=" U3/3/25"; // Updated 03-03-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-03-2025
					...
					break;
				case "MCO": new_title=" U3/3/25"; // Updated 03-03-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MEM": new_title=" U3/3/25"; // Updated 03-03-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MIA": new_title=" U3/3/25"; // Updated 03-03-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MKE": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MSP": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MSY": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MYR": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "OMA": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "ORD": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "ORF": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PBI": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PDX": new_title=" U3/10/25"; // Updated 03-10-2025
					...
					break;					
				case "PIT": new_title=" U3/17/25"; // Updated 03-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "PVD": new_title=" U2/28/25"; // Updated 02-28-2025
					result += "<br/><br/><b>Faa Pref Route (Avg FL250):</b>";
					...
					break;
				case "PIT": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPHL MXE PENSY J110 VINSE DEMME5 KPIT\" readonly>"; // CDR PH
					...
					result += "<br/>PS<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL PTW SARAA PSB HAYNZ7 KPIT\" readonly>";
					break;
				case "RDU": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "RIC": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "ROC": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "RSW": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SAN": new_title=" U3/10/25"; // Updated 03-10-2025
					...
					break;
				case "SAT": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SAV": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SDF": new_title=" U3/10/25"; // Updated 03-10-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SEA": new_title=" U3/10/25"; // Updated 03-10-2025
					...
					break;
				case "SFO": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "SLC":
					...
					break;
				case "SRQ": new_title=" U3/11/25"; // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "STL": new_title=" U3/11/25"; // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "SYR": new_title=" U3/11/25"; // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "TPA": new_title=" U3/11/25"; // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// VPS skipped
				...
				case "YUL": new_title=" U3/11/25"; // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "YYZ": new_title=" U3/11/25"; // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "PIT":
			switch(arvl) {
				...
				case "MIA": new_title=" U1/17/25"; // Updated 01-17-2025
					...
					break;
				case "PHL": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// PUB skipped
		...
		case "PWM":
			switch(arvl) {
				case "DCA": new_title=" U3/12/25"; // Updated 03-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODdO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 03-12-2025
		...
		case "RAP":
			switch(arvl) {
				case "CLT": new_title=" U3/11/25"; // Updated 03-11-2025 // 
					...
					break;
				case "DFW": new_title=" U3/11/25"; // Updated 03-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "RDU":
			switch(arvl) {
				...
				case "DFW": new_title=" U1/17/25"; // Updated 01-17-2025
					...
					break;
				case "LAX": new_title=" U1/17/25"; // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// RFD skipped
		...
		case "RIC":
			switch(arvl) {
				case "CLT": new_title=" U3/12/25"; // Updated 03-12-2025
					result += "<br/><br/><b>Faa Pref Route: (Avg FL280)</b>";
					...
					break;
				case "DFW": new_title=" U3/12/25"; // Updated 03-12-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// RST skipped
		...
		case "SAN":
			switch(arvl) {
				...
				case "LAX": new_title=" U1/17/25"; // Updated 01-17-2025
					...
					break;
				case "MIA": new_title=" U1/16/25"; // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "ORD": new_title=" U1/11/25"; // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "SAT":
			switch(arvl) {
				...
				case "LAX": new_title=" U1/17/25"; // Updated 01-17-2025
					...
					break;
				case "MIA": new_title=" U1/18/25"; // Updated 01-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "SDF":
			switch(arvl) {
				case "BNA": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSDF HIDEY1 HIDEY LULOU RYYMN2 KBNA\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>";
					break;
				case "CLT": new_title=" U1/18/25"; // Updated 01-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DFW": new_title=" U4/17/25"; // Updated 04-17-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route listed as of 04-17-2025
				...
				case "MIA": new_title=" U1/18/25"; // Updated 01-18-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "OSU": new_title=" U4/17/25"; // Updated 04-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "SEA":
			switch(arvl) {
				case "CLT": new_title=" U1/18/25"; // Updated 01-18-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "DFW": new_title=" U1/18/25"; // Updated 01-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "LAX": new_title=" U1/18/25"; // Updated 01-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "SFO":
			switch(arvl) {
				case "CLT": new_title=" U3/16/25"; // Updated 03-16-2025
				...
				case "JFK": // TODO
					break;
				case "LAX": new_title=" U4/1/25"; // Updated 04-01-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "MIA": new_title=" U4/18/25"; // Updated 04-18-2025
					...
					break;
				case "ORD": new_title=" U1/18/25"; // Updated 01-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "PHL": new_title=" U1/16/25"; // Updated 01-16-2025
					...
					break;
				case "PHX": new_title=" U4/18/25"; // Updated 04-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// SHV skipped
		...
		case "SJC":
			switch(arvl) {
				case "DFW": new_title=" U1/11/25"; // Updated 01-11-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U1/18/25"; // Updated 01-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "SLC":
			switch(arvl) {
				case "CLT": // Updated 12-29-2024
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "DFW": new_title=" U4/9/25"; // Updated 04-09-2025
		...
		case "SNA":
			switch(arvl) {
				...
				case "DFW": // Updated 12-28-2024
					...
					break;
				case "JFK": new_title=" U4/18/25"; // Updated 04-18-2025
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 04-18-2025
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-18-2025
					result += "<br/>AD<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA TCATE IPL MXL AMUDI IMEXA AGNID OBGIY THX PSX HOODO BOWFN LEV SJI J2 CEW ALLMA TEEEM Q109 DFENC SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					result += "<br/>AM<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA TCATE IPL MXL AMUDI IMEXA JALIL VOKOM MRF JCT J86 IAH J2 CEW ALLMA TEEEM Q109 DFENC SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					...
					result += "<br/>BN<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY DRK J6 IRW FSM MEMFS Q34 SITTR Q108 SIE CAMRN4 KJFK\" readonly>";
					...
					result += "<br/>CE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 ELP J86 IAH J2 CEW ALLMA TEEEM Q109 DFENC SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					...
					result += "<br/>LV<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY DRK J96 GUP FTI EZEEE MMB PER SGF J98 FAM J78 IIU Q108 SIE CAMRN4 KJFK\" readonly>";
					result += "<br/>M1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 SSO J4 EWM J66 ABI J4 FUZ Q184 ARNNY FRDDO HRTWL Q64 TYI ORF SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					result += "<br/>M2<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 ELP J86 IAH J2 LCH J138 SJI Q56 CATLN Q64 SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					result += "<br/>M3<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 ELP J86 IAH J2 LCH J138 SJI Q56 CATLN FRDDO NOKIE TWINS PANDY Q109 DFENC SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					result += "<br/>MC<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY DRK J96 SLN J24 MCI J80 VHP ROD KLYNE Q29 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>MR<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA BLH PXR J18 ABQ J78 IIU Q108 SIE CAMRN4 KJFK\" readonly>";
					result += "<br/>PX<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY DRK J96 GUP FTI EZEEE MMB PER SGF J98 FAM J78 PXV ROD KLYNE Q29 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>RD<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY DRK J6 IRW FSM ARG PXV ROD KLYNE Q29 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>SP<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY DRK J96 SLN J24 MCI J80 SPI J80 VHP ROD KLYNE Q29 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>VH<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY DRK J96 SLN J24 MCI J80 VHP ROD KLYNE Q29 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>VU<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 SSO J4 EWM J66 ABI J4 FUZ UIM ELD IZAAC Q30 VLKNN THRSR HRTWL Q64 SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					result += "<br/>VY<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J50 GBN TUS VYLLA AGNID OBGIY THX PSX HOODO BOWFN LEV SJI J2 CEW ALLMA TEEEM Q109 DFENC SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					...
					result += "<br/>XC<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 SSO CUS AGNID OBGIY THX PSX HOODO BOWFN LEV SJI J2 CEW ALLMA TEEEM Q109 DFENC SAWED Q108 SIE CAMRN4 KJFK\" readonly>";
					break;
				case "MIA": new_title=" U1/18/25"; // Updated 01-18-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "SRQ":
			switch(arvl) {
				case "CLT": new_title=" U1/19/25"; // Updated 01-19-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "STL":
			switch(arvl) {
				...
				case "DFW": new_title=" U1/19/25"; // Updated 01-19-2025
					...
					break;
				case "LAX": new_title=" U1/19/25"; // Updated 01-19-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// TLH skipped
		...
		case "TPA":
			switch(arvl) {
				case "CLT": new_title=" U1/19/25"; // Updated 01-19-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "DCA": new_title=" U1/19/25"; // Updated 01-19-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DFW": new_title=" U1/19/25"; // Updated 01-19-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "MIA": new_title=" U1/19/25"; // Updated 01-19-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "ORD": new_title=" U1/19/25"; // Updated 01-19-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHL": new_title=" U1/19/25"; // Updated 01-19-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "PHX": new_title=" U1/19/25"; // Updated 01-19-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "TUL":
			switch(arvl) {
				...
				case "DFW": new_title=" U1/19/25"; // Updated 01-19-2025
					...
					break;
				case "TUL": new_title=" U1/19/25"; // Updated 01-19-2025
		...
		case "VPS":
			switch(arvl) {
				case "CLT": new_title=" U3/24/25"; // Updated 03-24-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					break;
				case "DFW": new_title=" U1/24/25"; // Updated 01-24-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "YYZ":
			switch(arvl) {
				case "CLT": new_title=" U4/14/25"; // Updated 04-14-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // toddo
					result += "<br/><br/><b>CDRS</b>"; new_title = "C" + new_title; // Verified with ATCSCC on 04-14-2025
					...
					break;
				case "DFW": new_title=" U4/14/25"; // Updated 04-14-2025
