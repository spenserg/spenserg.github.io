...
// ABE SKIPPED
		...
		case "ABQ":
			switch(arvl) {
				case "DFW": // Updated 10-22-24
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KABQ MNZNO3 TXO TURKI JOVEM6 KDFW\" readonly>";
					result += "<br/><br/>SW Arrival: <input style=\"width:75%\"; value=\"KABQ MNZNO3 CME BGS GEEKY SOCKK4 KDFW\" readonly>";
					result += "<br/><br/>BGTOE: <input style=\"width:75%\"; value=\"KABQ MNZNO3 CME FST JCT GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/>DFW WEST: <input style=\"width:75%\"; value=\"KABQ MNZNO3 CME ELP J86 JCT CWK TNV STUFT BEREE3 KDFW\" readonly>";
					...
					result += "<br/>BG (Ok to File): <input class=\"cdr_input\" style=\"width:75%\"; value=\"KABQ CNX CME FST JCT GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/>BV (Ok to File): <input class=\"cdr_input\" style=\"width:75%\"; value=\"KABQ MNZNO3 TXO TURKI VKTRY2 KDFW\" readonly>";
					result += "<br/>VK (Ok to File): <input class=\"cdr_input\" style=\"width:75%\"; value=\"KABQ CNX CME BGS GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>WT (Ok to File): <input class=\"cdr_input\" style=\"width:75%\"; value=\"KABQ CNX J15 JCT CWK TNV STUFT BEREE3 KDFW\" readonly>";
					break;
				case "PHX": // Updated 10-22-24
					...
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>KS (Ok to File): <input class=\"cdr_input\" style=\"width:75%\"; value=\"KABQ BOSQE3 ONM DRRVR PINNG1 KPHX\" readonly>";
					break;
			}
		break; // End of ABQ
		...
		case "ALB":
			switch(arvl) {
				...
				case "CLT": // Updated 10-22-24
					...
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>29 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KALB PAYGE Q822 GONZZ Q29 JHW FOXEE Q145 HVQ LNDIZ PARQR4 KCLT\" readonly>";
					result += "<br/>A4 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KALB ALB ACOVE DBABE Q448 PTW J48 CSN GVE AIROW CHSLY6 KCLT\" readonly>";
					result += "<br/>N4 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KALB HNK J49 PSB Q71 GEFFS HVQ LNDIZ PARQR4 KCLT\" readonly>";
					result += "<br/>T7 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KALB NELIE ORCHA HEADI Q97 SAWED GUILD Q409 OKNEE MLLET3 KCLT\" readonly>";
					break;
				case "ORD": // Updated 10-22-24
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KALB PAYGE Q822 FNT WYNDE2 KORD\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b><br/>"; // TODO
					result += "<br/><br/><b>CDRS</b>";
		...
		case "BDL":
			switch(arvl) {
				...
				case "MIA": // Updated 10-22-24
					...
					result += "<br/><br/>OW: <input style=\"width:75%\"; value=\"KBDL CSTL9 CCC Q97 KALDA BGBRD Q101 SKARP Y313 HOAGG BNFSH2 KMIA\" readonly>";
		...
		case "BFL":
			switch(arvl) {
				...
				case "PHX": // Updated 10-22-24
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODO
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>ME: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBFL EHF V23 GMN LAX TRM BLH HYDRR1 KPHX\" readonly>";
					result += "<br/>SE: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBFL EHF V23 GMN LAX JLI IPL J2 HOGGZ HYDRR1 KPHX\" readonly>";
					break;
			}
		break; // End of BFL
		...
		case "BOS":
			switch(arvl) {
				...
				case "DFW": // Updated 12-22-24
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KBOS BLZZR6 BLZZR BAF Q406 BWZ J6 HVQ Q68 RAMRD ARG FSM KOMMA RRNET SEEVR4 KDFW\" readonly>";
				...
				case "MIA": // Updated 12-22-24
					...
					result += "<br/><br/>OW: <input style=\"width:75%\"; value=\"KBOS SSOXS7 SSOXS Q167 RIFLE HEADI Q97 KALDA BGBRD Q101 SKARP Y313 HOAGG BNFSH2 KMIA\" readonly>";
		...
		case "GSO":
			switch(arvl) {
				case "DFW": // Updated 01-09-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KGSO TRSHA1 BAWDS VXV MEM J66 LIT MEEOW FEWWW SEEVR4 KDFW\" readonly>";
				...
				case "CLT": // Updated 01-09-2025
					...
					result += "<br/><input style=\"width:75%\"; value=\"KGSO SDAIL CHSLY6 KCLT\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>";
					// result += "<br/><br/><b>CDRS</b>";
					break;
			}
		...
		case "JFK": // TODO double check JFK destinations
			switch(arvl) {
				...
				case "MIA": // Updated 01-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KJFK WAVEY EMJAY Q167 KALDA BGBRD Q101 SKARP Y313 HOAGG BNFSH2 KMIA\" readonly>";
				...
				case "PHX": // Updated 01-11-2025
					...
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>1K (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK GAYEL Q818 WOZEE KENPA CESNA ONL LBF ALS GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>1N: <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK GAYEL Q818 WOZEE NOSIK ZOHAN LAAKE ONL LBF ALS GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>1S: <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK GAYEL Q818 WOZEE Q917 SSM APUNY OGSIQ SWTHN DNW FFU BCE CORKR MAIER BRUSR1 KPHX\" readonly>";
					result += "<br/>36 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK COATE Q436 HERBA JHW Q29 CREEP J110 STL BUM ICT TOTOE FTI BUKKO ZUN EAGUL6 KPHX\" readonly>";
					result += "<br/>60: <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK DEEZZ5 CANDR J60 LNK HLC ALS J102 GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>60 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK DEEZZ5 CANDR J60 LNK HLC ALS J102 GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>64: <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK DEEZZ5 CANDR J60 DANNR RAV J64 LMN PWE HLC J64 PUB ALS J102 GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>6F (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK RBV Q430 SAAME J6 HVQ J78 FAM SGF TOTOE FTI J244 ZUN EAGUL6 KPHX\" readonly>";
					result += "<br/>8N (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK RBV Q430 SAAME BRNAN Q42 LCOLN IRK J26 MCI J24 SLN J96 GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>CW (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK COATE Q436 RAAKK Q438 RUBYY DABJU J36 BAE MCW ONL PUB ALS GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>E1 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK DEEZZ5 CANDR J60 DANNR RAV J64 LMN PWE HLC J64 PUB ALS GUP EAGUL6 KPHX\" readonly>";
					result += "<br/>EM (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK RBV Q430 BYRDD J48 CSN FANPO Q40 BFOLO FIBER HRISN Q30 IZAAC EIC J4 ABI J66 EWM DRRVR PINNG1 KPHX\" readonly>";
					result += "<br/>EP (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK RBV Q430 BYRDD J48 CSN FANPO Q40 NIOLA GRGIA ARNNY SJI Q56 HRV KCEEE TKNIQ MOLLR JCT ELP DRRVR PINNG1 KPHX\" readonly>";
					result += "<br/>G1 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK RBV Q430 SAAME J6 HVQ Q68 LITTR TXK BYP UKW HNKER TXO J72 ABQ J78 ZUN EAGUL6 KPHX\" readonly>";
					result += "<br/>P2 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK RBV Q430 BYRDD J48 CSN FANPO Q40 ALEAN Q66 LITTR KOMMA IRW J6 ZUN EAGUL6 KPHX\" readonly>";
					result += "<br/>PH (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK RBV Q430 AIR J110 STL BUM ICT TOTOE FTI J244 ZUN EAGUL6 KPHX\" readonly>";
					break;
...
// TODO MOB
		...
		case "MSP":
			switch(arvl) {
				case "CLT": // Updated 01-16-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KMSP ZMBRO7 ODI J30 JOT VHP J24 FLM TAFTT PARQR4 KCLT\" readonly>";
					...
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KMSP ZMBRO7 ODI J30 JOT VHP J24 FLM GZG BTSEY2 KCLT\" readonly>";
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>E1 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP WLSTN7 GRB PMM FWA FLM TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/>E2 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP COULT7 DLL OBK FLM TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/>E3 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP ZMBRO7 ODI J30 JOT VHP FLM TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/>N2 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP GEP DLH GRB PMM FWA FLM TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/>N3 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP HYR KP06K GRB PMM FWA FLM TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/>P1 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP ZMBRO7 ODI J30 JOT VHP FLM TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/>S2 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP RST1 ALO IRK STL Q19 HITMN TAZZA FILPZ4 KCLT\" readonly>";
					result += "<br/>S3 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP ORSKY3 ONTIJ DABOY DSM IRK STL Q19 HITMN TAZZA FILPZ4 KCLT\" readonly>";
					result += "<br/>W1 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KMSP SCHEP1 RXANN DURWN OVR IRK STL Q19 HITMN TAFTT PARQR4 KCLT\" readonly>";
					break;
...
// TODO RST
		...
		case "SAT":
			switch(arvl) {
				...
				case "DFW": // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KSAT YODUH1 YODUH GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/><br/>West: <input style=\"width:75%\"; value=\"KSAT LEJON4 LEJON J2 JCT SJT GEEKY SOCKK4 KDFW\" readonly>";
					result += "<br/>East: <input style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH BLTWY CRIED WHINY4 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KSAT ALAMO4 GOBBY CWK YEAGR4 KDFW\" readonly>";
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>3N (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH BLTWY CRIED WHINY4 KDFW\" readonly>";
					result += "<br/>3S (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH BLTWY CRIED BEREE3 KDFW\" readonly>";
					result += "<br/>5N (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SLENA1 BRENI IAH CRIED WHINY4 KDFW\" readonly>";
					result += "<br/>5S (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SLENA1 BRENI IAH CRIED BEREE3 KDFW\" readonly>";
					result += "<br/>9N (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT ALISS6 ALISS JCT SJT GEEKY SOCKK4 KDFW\" readonly>";
					result += "<br/>9S (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT ALISS6 ALISS JCT SJT GEEKY BOOVE7 KDFW\" readonly>";
					break;
				case "LAX": // Updated 01-17-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
