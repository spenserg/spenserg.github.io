		...
		case "ATL":
			switch(arvl) {
				...
				case "ORD": // Updated 06-01-2025
					...
					break;
				case "PHL": // Updated 08-22-2025
					result += "<!-- Updated 08-22-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KATL PLMMR3 BURGG Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KATL PHIIL3 HRTWL Q64 SAWED Q97 ZJAAY JIIMS4 KPHL\" readonly>";
					result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KATL SMKEY2 BOBBD Q71 KONGO Q34 GVE PAATS4 KPHL\" readonly>"; // CDR SK
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KATL EAONE SPA GSO RIC SIE KPHL\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-22-2025
					result += "<!-- Verified with ATCSCC on 08-22-2025 -->";
					result += "<br/>PA<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KATL PADGT2 RAFTN FLM J43 ROD J152 JST BOJID4 KPHL\" readonly>";
					result += "<br/>RP<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KATL PLMMR3 BURGG Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
		...
		case "AUS":
			switch(arvl) {
				...
				case "DFW": // Updated 06-02-2025
					...
					result += "<br/>0N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KAUS ELOEL3 FORSS GUTZZ BOOVE7 KDFW\" readonly>";
					...
					result += "<br/>6N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KAUS BNDIA3 BNDIA COT DLF SJT GEEKY BOOVE7 KDFW\" readonly>";
					...
					result += "<br/>7N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KAUS MUCKY3 MUCKY JCT SJT GEEKY BOOVE7 KDFW\" readonly>";
				...
				case "ORD": // Updated 06-04-2025 // Mandatory Routes checked
					...
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KAUS ELOEL3 KLNGR FUZ MLC RZC SGF WELTS SHAIN2 KORD\" readonly>";
		...
		case "BFL":
			switch(arvl) {
				case "DFW": // Updated 06-05-2025
					...
					result += "<br/>ME<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBFL MARIC4 EHF V23 GMN LAX TRM BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>SE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBFL MARIC4 EHF V23 GMN LAX JLI IPL J2 GBN J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					break;
				case "PHX": // Updated 07-29-2025
					result += "<!-- Updated 07-29-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KBFL MARIC4 LHS PDZ J50 BLH HYDRR1 KPHX\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KBFL MARIC4 LHS PMD J6 HEC PRFUM WOTRO BRUSR1 KPHX\" readonly>";
					...
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 06-04-2025
					result += "<!-- Verified with ATCSCC on 06-04-2025 -->";
					result += "<br/>ME<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBFL MARIC4 EHF V23 GMN LAX TRM BLH HYDRR1 KPHX\" readonly>";
					result += "<br/>SE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBFL MARIC4 EHF V23 GMN LAX JLI IPL J2 HOGGZ HYDRR1 KPHX\" readonly>";
					break;
			}
		break; // End of BFL
		...
		case "BOI":
			switch(arvl) {
				...
				case "PHX":  // No faa pref // Updated 07-11-2025
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KBOI BOI3 BOI ROARR LYONS CRITO WINEN Q35 CORKR TENTS BRUSR1 KPHX\" readonly>";
					result += "<br/><br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KBOI GOWEN4 FIMGU HYVAL REO J7 FMG J92 BLD PRFUM WOTRO BRUSR1 KPHX\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KBOI BOI3 BOI J15 TCH J11 DRK COYOT5 KPHX\" readonly>";
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 07-11-2025
					break;
			}
		break; // End of BOI
		...
		case "BWI":
			switch(arvl) {
				...
				case "DFW": // Updated 04-19-2025 // Mandatory Routes checked
					...
					result += "<br/>SW Arr <span style=\"color:red\">(Coord Req)</span>: <input style=\"width:75%\" value=\"KBWI TERPZ8 GLANC COLZI Q52 CHOPZ MGMRY CATLN Q56 HRV KCEEE TKNIQ MOLLR CRGER GUTZZ BOOVE7 KDFW\" readonly>"; // CDR D6
					...
					result += "<br/>D6<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBWI TERPZ8 GLANC COLZI Q52 CHOPZ MGMRY CATLN Q56 HRV KCEEE TKNIQ MOLLR CRGER GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/>D7<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KBWI FOXHL1 OTTTO Q80 ENGRA BNA SQS AEX DAS IAH CRGER GUTZZ BOOVE7 KDFW\" readonly>";
...
// CAK skipped
		...
		case "CHS":
			switch(arvl) {
				case "CLT": // Updated 05-27-2025 // Mandatory Routes checked
					...
					result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCHS PLMTO3 CRE JOHAR OGRAE SDAIL CHSLY6 KCLT\" readonly>";
		...
		case "CID":
			switch(arvl) {
				...
				case "DFW": // Updated 05-30-2025 // Mandatory Routes checked
					...
					result += "<br/><br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCID ROEZZ MCI ICT HOFFF VKTRY2 KDFW\" readonly>"; // CDR W2
					...
					result += "<br/>W0<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCID ROEZZ BUM J87 TUL KLAWW VKTRY2 KDFW\" readonly>";
					result += "<br/>W1<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCID ROEZZ MCI TUL HITUG SEEVR4 KDFW\" readonly>";
					result += "<br/>W2<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCID ROEZZ MCI ICT HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/>W3<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCID ROEZZ MCI ICT IRW IBAKE VKTRY2 KDFW\" readonly>";
					result += "<br/>W4<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCID ROEZZ MCI ICT IFI HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/>W6<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCID LMN PWE ICT HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/>W7<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCID LMN PWE ICT IRW IBAKE VKTRY2 KDFW\" readonly>";
					break;
			}
		break; // End of CID
		...
		case "CLE":
			switch(arvl) {
				...
				case "DFW": // Updated 07-14-2025
					...
					result += "<br/><br/>North via JOT<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCLE GTLKE4 BAGEL JOT J26 MMB HOFFF VKTRY2 KDFW\" readonly>";
					// result += "<br/><br/>DFW BEREE S: <input style=\"width:75%\" value=\"KCLE ZAAPA5 SINKR VHP J110 STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/><br/>DFW EAST 1+2: <input style=\"width:75%\" value=\"KCLE GTLKE4 BAGEL JOT MZV IRK MCI ICT HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/>DFW WEST: <input style=\"width:75%\" value=\"KCLE ZAAPA5 SINKR PXV ARG FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>DFW BEREE:<input style=\"width:75%\" value=\"KCLE ZAAPA5 SINKR VHP J110 STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>DFW SEEVR 1+2+3: <input style=\"width:75%\" value=\"KCLE ZAAPA5 SINKR VHP STL BUM ICT HOFFF VKTRY2 KDFW\" readonly>";
					...
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-14-2025
					result += "<!-- Verified with ATCSCC on 07-14-2025 -->";
					result += "<br/>N1<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLE ZAAPA5 SNNOH VHP STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>P1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLE ZAAPA5 SINKR PXV LIT FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/>S2<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCLE CAVVS4 APE FLM IIU PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>";
					break;
				case "MIA": // Updated 07-14-2025
					result += "<!-- Updated 07-14-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "CVG":
			switch(arvl) {
				case "CLT": // Updated 09-05-2025
					result += "<!-- Updated 09-05-2025 M -->";
					result += "<br/><br/><b>Faa Pref Route (Avg FL290):</b>";
					result += "<br/><input style=\"width:75%\" value=\"KCVG KENLN6 SHIPR TAFTT PARQR4 KCLT\" readonly>"; // CDR KN
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KCVG GIPLE7 HVQ LNDIZ PARQR4 KCLT\" readonly>";
					result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KCVG KENLN6 SHIPR SKYWA FILPZ4 KCLT\" readonly>";
					result += "<br/><br/>SW Arr<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCVG CHCLL6 RAMRD HITMN Q19 TOJXE RMG BESTT JONZE5 KCLT\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "DFW": // Updated 08-21-2025
					...
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCVG CHCLL6 BUSYY IMPEL J8 SGF HITUG SEEVR4 KDFW \" readonly>";
					result += "<br/><b>For NE Arvl: ..STL BUM PER HOFFF VKTRY2 KDFW<\/b>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCVG CHCLL6 BUSYY BNA Q32 CRAMM SQS YUYUN BEREE3 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/>Pref: <input style=\"width:75%\" value=\"KCVG IIU PXV J131 LIT FINGR9 KDFW\" readonly>";
					result += "<br/>NE Arr: <input style=\"width:75%\" value=\"KCVG IIU PXV J78 TUL UKW8 KDFW\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-21-2025
					result += "<!-- Verified with ATCSCC on 08-21-2025 -->";
					result += "<br/>CH<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG CHCLL6 BUSYY PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/>FF<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG RIKLE FWA RBS J19 STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>HG<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG HAGOL5 PLASH FWA RBS J19 STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>LV<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG LOVEY8 HELIS STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>PR<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG IIU PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>";
					...
					break;
				case "PHL": // Updated 08-21-2025
					result += "<!-- Updated 08-21-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KCVG ROCKT3 AHTIY JST BOJID4 KPHL\" readonly>"; // CDR RK
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCVG BNGLE5 RIKLE APE JST BOJID4 KPHL\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCVG GIPLE7 SITTR ASBUR Q34 GVE PAATS4 KPHL\" readonly>"; // CDR GP
					result += "<br/><br/>North via DJB<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KCVG BNGLE5 RIKLE DJB J60 PSB BOJID4 KPHL\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KCVG RIKLE APE JST BOJID4 KPHL\"; readonly>"; // CDR PR
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-21-2025
					result += "<!-- Verified with ATCSCC on 08-21-2025 -->";
					result += "<br/>BN<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG BNGLE5 RIKLE APE JST BOJID4 KPHL\" readonly>";
					result += "<br/>GP<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG GIPLE7 SITTR ASBUR Q34 GVE PAATS4 KPHL\" readonly>";
					result += "<br/>PR<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG RIKLE APE JST BOJID4 KPHL\" readonly>";
					result += "<br/>RK<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KCVG ROCKT3 AHTIY JST BOJID4 KPHL\" readonly>";
					break;
				case "PHX": // Updated 12-30-24
					...
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KCVG CVG7 IIU PXV FAM J78 ZUN BUNTR3 KPHX\" readonly>";
					result += "<br/><br/><b>CDRS</b>";
		...
		case "DAY":
			switch(arvl) {
				...
				case "DFW": // Updated 03-17-2025
					...
					result += "<br/><br/>North: <input style=\"width:75%\"; value=\"KDAY WAMBO VHP J24 STL J8 SGF HITUG SEEVR4 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "DCA":
			switch(arvl) {
				...
				case "DFW": // Updated 05-06-2025 // Mandatory Routes checked
					...
					result += "<br/>D6<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA SCRAM6 GLANC COLZI Q52 CHOPZ MGMRY CATLN Q56 HRV KCEEE TKNIQ MOLLR CRGER GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/>D7<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA REBLL5 OTTTO Q80 ENGRA BNA SQS AEX DAS IAH CRGER GUTZZ BOOVE7 KDFW\" readonly>";
				...
				case "JAX": // Updated 01-04-2025
					result += "<!-- Updated 01-04-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KDCA AMEEE1 SCOOB GUILD Q409 SESUE ESENT LUNNI2 KJAX\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>01: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA AMEEE1 SCOOB GUILD Q409 SESUE ESENT LUNNI2 KJAX\" readonly>";
					result += "<br/>20 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA DOCTR5 AGARD T287 CANNY LAFLN TRPOD Q409 SESUE ESENT LUNNI2 KJAX\" readonly>";
					result += "<br/>38: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA AMEEE1 SCOOB PAACK Q97 ELMSZ JROSS ESENT LUNNI2 KJAX\" readonly>";
					result += "<br/>55 (Coord Req): <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA CLTCH3 MAULS Q40 ALEAN VXV THRSR DUCHY OHDEA2 KJAX\" readonly>";
					result += "<br/>60 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA REBLL5 OTTTO Q80 WISTA NEALS J85 SPA IRQ FINNE OHDEA2 KJAX\" readonly>";
					break;
				...
				case "MSN": // Updated 04-19-2025 // Mandatory Routes checked
					...
					break;
				case "OKC": // Updated 08-05-2025
					result += "<!-- Updated 08-05-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KDCA REBLL5 OTTTO Q68 HVQ J78 FAM SGF DRLER MURAH3 KOKC\" readonly>"; // CDR 00
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDCA BUFFR Q178 LEJOY AIR J80 CREEP J110 STL J8 SGF DRLER MURAH3 KOKC\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDCA CLTCH3 MAULS Q40 BFOLO YAALL J14 KLUBB DWINE RIFFL3 KOKC\" readonly>"; // CDR 55
					result += "<br/><br/>North via JOT<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDCA HORTO4 BUFFR Q178 DJB CPONE JOT J87 BUM LFRED MURAH3 KOKC\" readonly>"; // CDR 18
					result += "<br/>South via THRSR<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDCA SCRAM6 GLANC COLZI Q52 CHOPZ THRSR VLKNN LIT KLUBB DWINE RIFFL3 KOKC\" readonly>"; // CDR 50
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-05-2025
					result += "<!-- Verified with ATCSCC on 08-05-2025 -->";
					result += "<br/>00<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA REBLL5 OTTTO Q68 HVQ J78 FAM SGF DRLER MURAH3 KOKC\" readonly>";
					result += "<br/>18<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA HORTO4 BUFFR Q178 DJB CPONE JOT J87 BUM LFRED MURAH3 KOKC\" readonly>";
					result += "<br/>40<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA AMEEE1 SCOOB GUILD Q409 MRPIT CEELY Q172 YUTEE IRQ THRSR VUZ J14 KLUBB DWINE RIFFL3 KOKC\" readonly>";
					result += "<br/>50<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA SCRAM6 GLANC COLZI Q52 CHOPZ THRSR VLKNN LIT KLUBB DWINE RIFFL3 KOKC\" readonly>";
					result += "<br/>55<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA CLTCH3 MAULS Q40 BFOLO YAALL J14 KLUBB DWINE RIFFL3 KOKC\" readonly>";
					break;
				...
				case "PHX": // Updated 02-28-2025
					...
					break;
				case "PWM": // Updated 08-22-2025
					result += "<!-- Updated 08-22-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KDCA SOOKI5 SWANN BROSS Q419 RBV Q22 LLUND BDR SCOGS3 KPWM\" readonly>"; // CDR 00
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDCA HORTO4 JERES Q221 BIGEO J49 HNK CAM CDOGG4 KPWM\" readonly>"; // CDR 46
					result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDCA DOCTR5 AGARD DONIL DIDIO JODOE HEADI CCC SCOGS3 KPWM\" readonly>"; // CDR 20
					result += "<br/><br/>ZBW MICAH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KDCA HORTO4 JERES Q221 BIGEO J49 HNK CAM CDOGG4 KPWM\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-22-2025
					result += "<!-- Verified with ATCSCC on 08-22-2025 -->";
					result += "<br/>00<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA SOOKI5 SWANN BROSS Q419 RBV Q22 LLUND BDR SCOGS3 KPWM\" readonly>";
					result += "<br/>10<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA HORTO4 JERES Q221 BIGEO J49 HNK CAM CDOGG4 KPWM\" readonly>";
					result += "<br/>11<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDCA HORTO4 JERES J211 LEONI WEVEL ELZ VIEEW ITH ALB CAM CDOGG4 KPWM\" readonly>";
		...
		case "DEN":
			switch(arvl) {
				case "CLT": // Updated 01-04-2025
					...
					break;
				case "DFW": // Updated 07-27-2025
					result += "<!-- Updated 07-27-2025 P -->";
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-27-2025
					result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KDEN SLEEK2 SLEEK EZEEE MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/><br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDEN SABTH2 JOPLN TXO GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDEN EPKEE7 GAETR ICT TUL HITUG SEEVR4 KDFW\" readonly>";
					result += "<br/><br/>West via RSK<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KDEN BAYLR6 TEHRU MTJ RSK J15 ABQ J15 CME GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KDEN PLAIN2 GCK SPS UKW8 KDFW\" readonly>";
					result += "<br/><input style=\"width:75%\" value=\"KDEN PLAIN2 GLD J182 ICT J21 IRW FINGR9 KDFW\" readonly>";
				...
				case "MIA": // Updated 08-22-2025
					...
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KDEN PLAIN2 GCK TUL LIT IGB MGM SZW RSW PALMZ2 KMIA\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-22-2025
					result += "<!-- Verified with ATCSCC on 08-22-2025 -->";
					result += "<br/>E1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDEN EPKEE7 DUUZE PER RZC MERDN DEFUN FROGZ4 KMIA\" readonly>";
					result += "<br/>N1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDEN CHUWY1 CHUWY ONL SGF MERDN DEFUN FROGZ4 KMIA\" readonly>";
				...
				case "PHL": // Updated 01-04-2025
					...
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KDEN PLAIN2 HCT J60 PSB BUNTS3 KPHL\" readonly>";
					result += "<br/><br/><b>CDRS</b>";
		...
		case "DTW":
			switch(arvl) {
				case "DFW": // Updated 02-28-2025
					...
					result += "<br/>P1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDTW BARII3 SINKR PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/>S1<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDTW SNDRS3 BGHRT STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>W1<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KDTW KAYLN3 SMUUV RBS J19 STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
		...
		case "EUG":
			switch(arvl) {
				case "DFW": // Updated 01-09-2025
					...
					result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KEUG LKV BAM ELY MLF DVC CIM PNH MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KEUG DSD BOI PIH J20 LAA TOTOE MMB HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/><br/>Coastal<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KEUG RBG OED SAC AVE J6 PMD J65 DECAS BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
		...
		case "EWR":
			switch(arvl) {
				...
				case "DFW": // Updated 04-11-2025
					...
					result += "<br/>UN<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KEWR NEWEL J60 JOT MZV IRK MCI ICT IRW HOFFF VKTRY2 KDFW\" readonly>";
					break;
				case "MIA":
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// FOE skipped
		...
		case "GEG":
			switch(arvl) {
				case "DFW": // Updated 07-27-2025
					result += "<!-- Updated 07-27-2025 MP -->";
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-27-2025
					result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KGEG LKT J52 OCS J163 CHE PUB J17 PNH MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/><b>via TURKI: .. <\/b><input style=\"width:27em\" value=\"KGEG DNJ TWF J15 JNC KD42U TXO TURKI VKTRY2 KDFW\" readonly>";
					result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KGEG ZATIP Q73 CRITO MLF J58 PNH MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KGEG MLP J136 BIL GCC BFF GLD GCK MMB HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KGEG LKT J52 OCS J163 CHE PUB PNH UKW8 KDFW\" readonly>";
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "ORD": // Updated 07-27-2025
					result += "<!-- Updated 07-27-2025 P -->"
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-27-2025
					result += "<br/><br/>NRP: <input style=\"width:75%\"; value=\"KGEG MLP J136 BIL J16 FSD FOD MYRRS FYTTE7 KORD\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KGEG MLP J36 GEP J70 BAE LYNNI ERNNY8 KORD\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KGEG GEG J52 DBS J175 LAR HCT KP60C STJ IRK SHAIN2 KORD\" readonly>";
				...
				case "PHX": // Updated 04-30-2025
					...
					result += "<br/><b>JUNIPER B Active: <input style=\"width:14em\" value=\"KGEG GEG KS06G POWEL LKV\" readonly> ...<\/b>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 04-30-2025
					break;
			}
		...
		case "HDN":
			switch(arvl) {
				case "DFW": // Updated 03-18-2025
					...
					result += "<br/>West: <input style=\"width:75%\"; value=\"KHDN CHE EKR JNC J15 RSK J58 FTI TXO TXO TURKI VKTRY2 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "IAD":
			switch(arvl) {
				case "DFW": // Updated 06-14-2025 // Mandatory Routes checked
					...
					result += "<br/>D6<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIAD SCRAM6 GLANC COLZI Q52 CHOPZ MGMRY CATLN Q56 HRV KCEEE TKNIQ MOLLR CRGER GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/>D7<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIAD RNLDI4 OTTTO Q80 ENGRA BNA SQS AEX DAS IAH CRGER GUTZZ BOOVE7 KDFW\" readonly>";
		...
		case "IAH":
			switch(arvl) {
				...
				case "DFW": // Updated 08-06-2025
					...
					result += "<br/>SEEVR2: <input style=\"width:75%\" value=\"KIAH BNDTO6 CRGER GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					...
					result += "<br/>1N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIAH INDIE8 TPAKK JRHED SEEVR4 KDFW\" readonly>";
					...
					result += "<br/>6N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIAH RITAA7 PSX THX SAT GUTZZ BOOVE7 KDFW\" readonly>";
					...
					result += "<br/>7N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIAH PITZZ5 CRGER GUTZZ BOOVE7 KDFW\" readonly>";
		...
		case "IND":
			switch(arvl) {
				case "CLT": // Updated 08-25-2025
					...
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-25-2025
					result += "<!-- Verified with ATCSCC on 08-25-2025 -->";
					result += "<br/>AP<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND MAREO5 BDOCK APE GZG BTSEY2 KCLT\" readonly>";
					result += "<br/>PR<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND DAWNN1 IIU VXV LIINN3 KCLT\" readonly>";
					result += "<br/>SL<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND ROCKY1 STL Q19 HITMN VXV LIINN3 KCLT\" readonly>";
					result += "<br/>SW<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND OOM5 PXV HITMN VXV LIINN3 KCLT\" readonly>";
					break;
				...
				case "DFW": // Updated 08-25-2025
					...
					result += "<br/>SE Arr<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KIND DAWNN1 MYS BWG SQS YUYUN BEREE3 KDFW\" readonly>"; // CDR SQ
					...
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-25-2025
					result += "<!-- Verified with ATCSCC on 08-25-2025 -->";
					result += "<br/>BG<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND DAWNN1 MYS RAMRD Q68 LITTR FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/>BT<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND MEARZ7 BVT J89 CADIZ JOT MZV IRK J87 TUL HITUG SEEVR4 KDFW\" readonly>";
					result += "<br/>PR<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND ROCKY1 STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>SQ<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND DAWNN1 MYS BWG SQS YUYUN BEREE3 KDFW\" readonly>";
					result += "<br/>SW<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND OOM5 PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>";
					break;
				...
				case "MIA": // Updated 01-10-2025
					...
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KIND DAWNN1 IIU J99 IRQ FISHO Q93 DEBRL CSTAL3 KMIA\" readonly>"; // CDR PR
					// TODO West route
					result += "<br/><br/>East/OW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KIND MAREO5 BDOCK HVQ BKW ROA RDU ILM WAALT AR17 BAHAA HOAGG BNFSH3 KMIA\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KIND DAWNN1 IIU VXV AMG TAY RSW PALMZ2 KMIA\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-25-2025
					result += "<!-- Verified with ATCSCC on 08-25-2025 -->";
					result += "<br/>DQ<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND DQN FLM J43 VXV THRSR HONID FROGZ4 KMIA\" readonly>";
					result += "<br/>PR<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND DAWNN1 IIU J99 IRQ FISHO Q93 DEBRL CSTAL3 KMIA\" readonly>";
					result += "<br/>SL<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KIND ROCKY1 STL Q19 HITMN ACORI FROGZ4 KMIA\" readonly>";
					break;
				case "ORD": // Updated 01-10-2025
					result += "<!-- Updated 01-10-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "JAC":
			switch(arvl) {
				...
				case "DFW": // Updated 01-10-2025
					result += "<!-- Updated 01-10-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KJAC DIVYD2 DNW BRK EZEEE MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/><br/>NE Arrival: <input style=\"width:75%\" value=\"KJAC DIVYD2 DNW LAR GLD J182 ICT HITUG SEEVR4 KDFW\" readonly>";
...
// JAN skipped
		...
		case "JAX":
			switch(arvl) {
				case "CLT": // Updated 08-22-2025
					result += "<!-- Updated 08-22-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route (Avg FL270):</b>";
					result += "<br/><input style=\"width:75%\" value=\"KJAX BRSTL1 BAXLY PONZE BANKR5 KCLT\" readonly>";
					result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KJAX CROSB2 WISPR CHECR STOCR4 KCLT\" readonly>";
					result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KJAX JETIN2 CAPPS FEONA THRSR BESTT JONZE5 KCLT\" readonly>";
 					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 08-22-2025
					break;
				case "DFW":
					result += "<br/><br/><b>Faa Pref Route:</b>";
				...
				case "DCA": // Updated 01-11-2025
					...
					// result += "<br/><br/><b>CDRS</b>";
					break;
				case "MIA": // Updated 07-26-2025
					result += "<!-- Updated 07-26-2025 -->";
					result += "<br/><br/><b>Faa Pref Route (Avg FL300):</b>";
					result += "<br/><input style=\"width:75%\" value=\"KJAX EXBOX2 EXBOX DEBRL CSTAL3 KMIA\" readonly>";
					result += "<br/><br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KJAX JETIN2 JAYJA BROMO FROGZ4 KMIA\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "PHL": // Updated 07-26-2025
					...
					result += "<br/><br/>West/ZDC Avoid<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KJAX BRSTL1 ALLMA ODF KONGO Q71 EMNEM JST BOJID4 KPHL\" readonly>";
		...
		case "JFK": // TODO double check JFK destinations
			switch(arvl) {
				...
				case "DFW": // Updated 06-02-2025
					...
					result += "<br/>UN<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KJFK DEEZZ5 CANDR J60 JOT MZV IRK MCI ICT IRW HOFFF VKTRY2 KDFW\" readonly>";
					break;
		...
		case "LAS":
			switch(arvl) {
				case "CLT": // Updated 04-08-2025
					...
					result += "<br/>NRP North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC PUB J28 GCK J110 BUM J112 FAM BNA TAZZA FILPZ4 KCLT\" readonly>";
					...
					result += "<br/>North via GLD<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC J146 GLD J80 VHP J24 FLM TAFTT PARQR4 KCLT\" readonly>";
					...
					result += "<br/>VUZ: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC PUB J28 GCK EOS MAW BNA TAZZA FILPZ4 KCLT\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "DCA": // Updated 07-01-2025
					...
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 VHP APE J30 LUISE FRDMM6 KDCA\" readonly>"; // CDR VH
					...
					result += "<br/><br/>North via BAE<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP RWF J34 BAE GIJ J146 WOOST J34 BUCKO FRDMM6 KDCA\" readonly>"; // CDR B1
					...
					// result += "<br/><br/><input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC HBU J28 ICT SGF J98 FAM J78 HVQ TRUPS5 KDCA\" readonly>";
					...
					// result += "<br/><br/>North: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVV J60 JOT J30 LUISE FRDMM6 KDCA\" readonly>";
					...
					result += "<br/>GRB: <input style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP ABR GRB FNT DJB J34 BUCKO FRDMM6 KDCA\" readonly>";
					result += "<br/>JOT 1: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC DVV J60 JOT J30 LUISE FRDMM6 KDCA\" readonly>";
					result += "<br/>JOT 2 ALT: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC PUB J64 HLC PWE LMN MZV JOT J30 LUISE FRDMM6 KDCA\" readonly>";
					...
					result += "<br/>SPI: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 SPI IIU Q108 SITTR TRUPS5 KDCA\" readonly>";
					result += "<br/>VHP: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 VHP APE J30 LUISE FRDMM6 KDCA\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-01-2025
					result += "<!-- Verified with ATCSCC on 07-01-2025 -->";
					result += "<br/>B1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP RWF J34 BAE GIJ J146 WOOST J34 BUCKO FRDMM6 KDCA\" readonly>";
					result += "<br/>B2<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP J82 FSD J16 BAE GIJ J146 WOOST J34 BUCKO FRDMM6 KDCA\" readonly>";
					result += "<br/>BK<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR BFF J94 ONL FOD DBQ J94 OBK GIJ J146 WOOST J34 BUCKO FRDMM6 KDCA\" readonly>";
					...
					result += "<br/>GR<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP ABR GRB FNT DJB J34 BUCKO FRDMM6 KDCA\" readonly>";
					result += "<br/>J1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC DVV J60 JOT J146 WOOST J34 BUCKO FRDMM6 KDCA\" readonly>";
					result += "<br/>J2<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC PUB J64 HLC PWE LMN MZV JOT J146 WOOST J34 BUCKO FRDMM6 KDCA\" readonly>";
					...
					result += "<br/>MC<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J24 STL ENL IIU Q108 SITTR TRUPS5 KDCA\" readonly>";
					...
					result += "<br/>SP<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 SPI IIU Q108 SITTR TRUPS5 KDCA\" readonly>";
					result += "<br/>VH<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 VHP APE J30 LUISE FRDMM6 KDCA\" readonly>";
				...
				case "DFW": // Updated 01-12-2025
					...
					result += "<br/><br/>SW Arrival: <input style=\"width:75%\" value=\"KLAS NIITZ4 SSKEE GUP J72 ABQ J15 CME BGS GEEKY BOOVE7 KDFW\" readonly>";
				...
				case "JFK": // Updated 01-12-2025
					result += "<!-- Updated 01-12-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC HBU TXC HCT OBH FOD DBQ KG75M DAFLU J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>North: <input style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP LORAH DAYYY RUBKI SIKBO AHPAH HANKK EXTOL YODAA IGN IGN1 KJFK\" readonly>";
					...
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>CR (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP LORAH DAYYY RUBKI SIKBO AHPAH HANKK EXTOL YODAA IGN IGN1 KJFK\" readonly>";
					result += "<br/>CW (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP TTAIL NIWRA VURLY ULUTO POLTY BUGSY ALB IGN IGN1 KJFK\" readonly>";
					result += "<br/>CY (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR RAP LORAH DAYYY RUBKI SIKBO OLABA SSENA BUGSY ALB IGN IGN1 KJFK\" readonly>";
					result += "<br/>GR (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP ABR GRB HOCKE Q935 HANKK EXTOL YODAA IGN IGN1 KJFK\" readonly>";
					...
					result += "<br/>VH (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 VHP ROD KLYNE Q29 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>W1: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC SNY J114 GEP DLL HASTE DAFLU J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>W4: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC HBU MCI J80 SPI VHP ROD DJB JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>W5: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR PGA RSK GCK BUM KK54K KI57O ROD DJB JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>W6: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR PGA RSK TOTOE PXV ROD DJB JHW J70 LVZ LENDY8 KJFK\" readonly>";
					break;
				...
				case "ORD": // Updated 2024-12-28
					...
					result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC J197 HGO J24 SLN J96 IRK SHAIN2 KORD\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KLAS VERKN LARVE EKR BFF J94 ONL FOD MYRRS FYTTE7 KORD\" readonly>";
					result += "<br/>South/KDV Avoid<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KLAS NIITZ4 SSKEE GUP J96 IRK BENKY6 KORD\" readonly>";
					result += "<br/><br/>South via IRW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KLAS NIITZ4 SSKEE GUP J72 ABQ J6 IRW J98 SGF WELTS TRTLL6 KORD\" readonly>";
					...
					result += "<br/>F2<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR BFF J94 ONL FOD MYRRS FYTTE7 KORD\" readonly>";
					result += "<br/>JB<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR BFF J94 ONL J114 GEP DLL MSN JAKSA MOOPS FYTTE FYTTE7 KORD\" readonly>";
					...
					result += "<br/>JW<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR BFF J94 ONL J114 GEP TVC WYNDE2 KORD\" readonly>";
					break;
				case "PHL": // Updated 01-12-2025
					result += "<!-- Updated 01-12-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC PUB HYS UIN VHP ROD JST BOJID4 KPHL\" readonly>";
					...
					result += "<br/>VHP: <input style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 VHP ROD J152 JST BOJID4 KPHL\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KLAS PGS J72 GUP FTI EZEEE ICT J26 MCI J80 VHP ROD EWC PSB BUNTS3 KPHL\" readonly>";
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>B2 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP J82 FSD J16 BAE J34 DJB EWC JST BOJID4 KPHL\" readonly>";
					...
					result += "<br/>GR: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 VERKN LARVE EKR MBW RAP ABR GRB FNT DJB EWC JST BOJID4 KPHL\" readonly>";
					result += "<br/>J1: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC J146 HBU DVV J60 JOT J146 WOOST J34 DJB EWC JST BOJID4 KPHL\" readonly>";
					result += "<br/>J1 (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC DVV J60 JOT J146 WOOST J34 DJB EWC JST BOJID4 KPHL\" readonly>";
					...
					result += "<br/>SP: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLAS GIDGT3 TUKRR DVC LAA J102 SLN J24 MCI J80 SPI J80 VHP ROD J152 JST BOJID4 KPHL\" readonly>";
		...
		case "LGA":
			switch(arvl) {
				...
				case "DFW": // Updated 04-17-2025
					...
					result += "<br/>UN<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLGA NEWEL J60 JOT MZV IRK MCI ICT IRW HOFFF VKTRY2 KDFW\" readonly>";
					break;
				case "MCO": // Updated 04-06-2025
					result += "<!-- Updated 04-06-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/>Non OW: <input style=\"width:75%\" value=\"KLGA WHITE Q409 CRPLR Q85 LPERD SNFLD3 KMCO\" readonly>";
					...
					result += "<br/>4C<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KLGA LANNA J48 MOL FLASK GOWBE BURGG QUIWE Q93 GIPPL Q85 LPERD SNFLD3 KMCO\" readonly>";
		...
		case "MCO":
			switch(arvl) {
				...
				case "LAX": // Updated 06-23-2025
					...
					result += "<br/>Non OW via ABQ<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KMCO RDSOX1 JFRYS PATOY Q116 JAWJA CABLO MCB EIC SPS J72 ABQ J6 DRK GABBL HLYWD1 KLAX\" readonly>";
				...
				case "LGA": // Updated 05-07-2025 // Mandatory Routes checked
					...
					result += "<br/><br/>Full OW/ZDC Avoid<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KMCO MZULO3 ETECK PELCN ROWSY Y494 YAALE Y495 OWENZ DPK KLGA\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 05-07-2025
					break;
				case "MIA": // Updated 01-15-2025
				...
				case "ORD": // Updated 05-07-2025 // Mandatory Routes checked
					...
					result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KMCO FATHE4 VIYAP Q69 GURGE Q93 HEVAN BONNT VEECK5 KORD\" readonly>";
					result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KMCO RDSOX1 JFRYS PATOY Q116 JAWJA CABLO ACORI MGM JILLS Q128 MUDHO ARG FTZ TRTLL6 KORD\" readonly>";
					result += "<br/><br/>East/OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KMCO MZULO3 LENDS GRUBR Y299 SEELO OGGRE Y436 DEDDY CAE BENBY Q93 HEVAN BONNT VEECK5 KORD\" readonly>";
					result += "<br/>West/Gulf<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KMCO OSPRY1 REMIS Y280 REDFN Q105 HRV MCB J35 SQS ARG FTZ SHAIN2 KORD\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "MKE":
			switch(arvl) {
				...
				case "DFW": // Updated 09-05-2025
					result += "<!-- Updated 09-05-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KMKE ACCRA5 ACCRA RBS J19 STL RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KMKE ACCRA5 ACCRA RBS J71 ENL FAM J137 LIT FEWWW SEEVR4 KDFW\" readonly>"; // CDR 2S
					// result += "<br/><br/>West: <input style=\"width:75%\" value=\"KMKE GREAS JAYEX DSM J25 TUL KLAWW VKTRY2 KDFW\" readonly>";
					result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KMKE GREAS JAYEX DBQ ROEZZ BUM J87 TUL KLAWW VKTRY2 KDFW\" readonly>"; // CDR 0W
					result += "<br/><br/>East via PXV<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KMKE UECKR6 DELHI PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>"; // CDR 5S
					result += "<br/>West via ICT<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KMKE GREAS JAYEX DBQ ROEZZ MCI ICT HOFFF VKTRY2 KDFW\" readonly>"; // CDR 2W
					result += "<br/><br/>DFW SEEVR 2<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KMKE GREAS JAYEX DBQ IRK MCI ICT IFI HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/>DFW WEST<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KMKE GREAS JAYEX DBQ IRK MCI TUL HITUG SEEVR4 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "PHX": // Updated 03-30-2025
					...
					result += "<br/>1W<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KMKE GREAS JAYEX DBQ IRK J26 ICT TOTOE FTI ZUN EAGUL6 KPHX\" readonly>";
...
// MOB skipped
		...
		case "MRY":
			switch(arvl) {
				case "DFW": // Updated 05-09-2025 // Mandatory Routes checked
					result += "<!-- Updated 05-09-2025 MP -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KMRY AVE J6 PMD J65 KOFFA J169 TFD J50 SSO J4 EWM BGS GEEKY BOOVE7 KDFW\" readonly>";
		...
		case "MSO":
			switch(arvl) {
				case "DFW": // Updated 01-16-2025
					result += "<!-- Updated 01-16-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KMSO MZULA5 LKT J52 DBS CKW PUB J17 PNH MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/><br/>South: <input style=\"width:75%\" value=\"KMSO DLN ELLKK BONGO JNC DRO ABQ CME MAF GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>NE Arrival: <input style=\"width:75%\" value=\"KMSO VICTO1 LKT DNW RIW MBW Q148 BVO HITUG SEEVR4 KDFW\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>";
					// result += "<br/><br/><b>CDRS</b>";
					break;
			}
		...
		case "MSP":
			switch(arvl) {
				...
				case "DFW": // Updated 01-04-2025
					...
					result += "<br/><br/>BEREE: <input style=\"width:75%\" value=\"KMSP ORSKY3 ONTIJ OVR J21 ICT HOFFF VKTRY2 KDFW\" readonly>";
		...
		case "MSY":
			switch(arvl) {
				...
				case "DFW": // Updated 01-16-2025
					...
					result += "<br/><br/>DFW EAST 1/2: <input style=\"width:75%\" value=\"KMSY IAH CRGER GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "OKC":
			switch(arvl) {
				case "CLT": // Updated 08-04-2025
					result += "<!-- Updated 08-04-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KOKC FUNNL3 PHARA ARG BNA TAZZA FILPZ4 KCLT\" readonly>";
					result += "<br/><b>Can use .. PHARA MEM TAZZA .. to get a little farther south<\/b>";
					result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KOKC RDHWK3 HOLLE LIT J14 YAALL VLKNN THRSR BESTT JONZE5 KCLT\" readonly>";
					result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KOKC TRUPR3 DRLER SGF J98 FAM J78 IIU TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KOKC TUL RZC ARG J46 VXV LIINN3 KCLT\" readonly>";
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 08-04-2025
					break;
				case "DCA": // Updated 08-04-2025
					result += "<!-- Updated 08-04-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KOKC TRUPR3 DRLER FAM J78 HVQ TRUPS5 KDCA\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KOKC TRUPR3 DRLER SGF J8 STL J24 VHP ROD APE J30 LUISE FRDMM6 KDCA\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KOKC TEBRD3 ATOKA TXK J52  SQS HRISN Q30 VLKNN THRSR KBLER Q56 KIWII WAVES CAPSS3 KDCA \" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 08-04-2025
				case "DFW":
					...
					result += "<br/><br/>NE Arrival: <input style=\"width:75%\" value=\"KOKC RDHWK3 HOLLE MLC AXXEE SEEVR4 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "OMA":
			switch(arvl) {
				...
				case "DFW":
					...
					result += "<br/><br/>NE Arrival: <input style=\"width:75%\" value=\"KOMA MCI BUM RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					...
					result += "<br/>BEREE SOUTH: <input style=\"width:75%\" value=\"KOMA OVR J21 ICT HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/>BOOVE: <input style=\"width:75%\" value=\"KOMA ICT TUL HITUG SEEVR4 KDFW\" readonly>";
					result += "<br/>DFW EAST 1: <input style=\"width:75%\" value=\"KOMA OVR PWE ICT HOFFF VKTRY2 KDFW\" readonly>";
					result += "<br/>DFW EAST 2: <input style=\"width:75%\" value=\"KOMA OVR PWE ICT HOFFF VKTRY2 KDFW\" readonly>";
		...
		case "ONT":
			switch(arvl) {
				case "CLT": // Updated 02-22-2025
					...
					// result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><br/>HAR: <input style=\"width:75%\"; value=\"KONT RAJEE4 AVRRY PKE J134 DRK J6 PNH IRW ARG J46 BNA TAZZA FILPZ4 KCLT\" readonly>";
		...
		case "ORF":
			switch(arvl) {
				...
				case "DFW": // Updated 04-28-2025 // Mandatory Routes checked
					...
					result += "<br/><br/>SW Arr<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KORF COUPN RDU SHPRD IPTAY CHOPZ MGMRY CATLN Q56 HRV KCEEE TKNIQ MOLLR CRGER GUTZZ BOOVE7 KDFW\" readonly>"; // CDR D6
					result += "<br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KORF HPW FAK MOL J24 HVQ Q68 LITTR MEEOW FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					...
					result += "<br/>D5<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KORF COUPN RDU SHPRD BURGG MEMFS LIT FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/>D6<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KORF COUPN RDU SHPRD IPTAY CHOPZ MGMRY CATLN Q56 HRV KCEEE TKNIQ MOLLR CRGER GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/>D7<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KORF COUPN RDU SHPRD IPTAY CHOPZ THRSR JAMMR MERDN MCB AEX DAS IAH CRGER GUTZZ BOOVE7 KDFW\" readonly>";
		...
		case "PBI":
			switch(arvl) {
				...
				case "DFW": // Updated 01-17-2025
					...
					result += "<br/>North: <input style=\"width:75%\" value=\"KPBI TBIRD6 SMELZ Q116 JAWJA Q116 MEMFS LIT MEEOW FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "PHL": // Updated 06-03-2025 // Mandatory Routes checked
					...
					result += "<br/><br/>WATRS/ZDC Avoid<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPBI SLIDZ2 LENDS PELCN ROWSY Y494 VIRST Y494 SILLY LYNUS B24 DASHA JIIMS4 KPHL\" readonly>";
		...
		case "PDX":
			switch(arvl) {
				case "DFW": // Updated 01-17-2025
					result += "<!-- Updated 01-17-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPDX WHAMY5 IMB J15 JNC ALS PNH MDANO VKTRY2 KDFW\" readonly>";
					...
					result += "<br/>North: <input style=\"width:75%\" value=\"KPDX LAVAA7 PDT J20 DNJ J82 DBS J175 LAR FQF J17 PNH MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "PHL":
			switch(arvl) {
				case "ATL": // Updated 08-22-2025
					result += "<!-- Updated 08-22-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPHL STOEN REEFI EMI J48 MOL FLASK OZZZI1 KATL\" readonly>"; // CDR PH
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPHL OOD TEBEE HAYDO TRPOD Q409 MRPIT CEELY Q172 YUTEE SKWKR JJEDI3 KATL\" readonly>"; // CDR KA
					result += "<br/>West/PTW<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPHL PTW SARAA RAV PSB HVQ HLRRY ONDRE1 KATL\" readonly>"; // CDR PS
					result += "<br/><b style=\"color:orange\">For MXE Dptr: .. KPHL MXE PENSY J110 AIR HVQ ..<\/b>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "CLE": // Updated 03-02-2025
					...
					result += "<br/><br/>North<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPHL DITCH LUIGI HNNAH LAAYK Q436 HERBA THOME TRYBE4 KCLE\" readonly>"; // CDR 36
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KPHL MXE PENSY J110 AIR ROLLN ROLLN2 KCLE\" readonly>"; // CDR 80
				...
				case "DFW": // Updated 08-06-2025
					...
					result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KPHL STOEN REEFI EMI J48 CSN FANPO Q40 ALEAN Q66 LITTR FEWWW SEEVR4 KDFW\" readonly>"; // CDR 48
					result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KPHL MXE PENSY J110 FYLLS PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>"; // CDR 80
					result += "<br/><br/>South/OOD<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPHL OOD TEBEE HAYDO TRPOD Q409 MRPIT CEELY Q172 YUTEE IRQ THRSR VLKNN Q30 IZAAC YUYUN BEREE3 KDFW\" readonly>"; // CDR KA
					result += "<br/>North/DITCH<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPHL DITCH LUIGI HNNAH LAAYK Q436 HERBA JHW Q29 KLYNE PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>"; // CDR 36
					// result += "<br/>DQO/North via STL: <input style=\"width:75%\"; value=\"KPHL DQO BELAY MORTY OTTTO Q176 STL SGF HITUG SEEVR4 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KPHL MXE PENSY J110 FLIRT J6 HVQ J78 PXV J131 LIT WILBR9 KDFW\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-06-2025
					result += "<!-- Verified with ATCSCC on 08-06-2025 -->";
					result += "<br/>36<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL DITCH LUIGI HNNAH LAAYK Q436 HERBA JHW Q29 KLYNE PXV J131 LIT FEWWW SEEVR4 KDFW\" readonly>";
					...
					result += "<br/>U6<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL PTW SARAA RAV PSB J60 DJB CPONE JOT MZV IRK MCI ICT IRW IBAKE VKTRY2 KDFW\" readonly>";
					...
					result += "<br/>UN<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL PTW SARAA RAV PSB J60 DJB CPONE JOT MZV IRK MCI ICT IRW HOFFF VKTRY2 KDFW\" readonly>";
					break;
				...
				case "JAX": // Updated 07-20-2025
					result += "<!-- Updated 07-20-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPHL OOD TEBEE HAYDO TRPOD Q409 SESUE ESENT LUNNI2 KJAX\" readonly>"; // CDR PH
					result += "<br/><br/>STOEN/West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KPHL STOEN REEFI EMI J48 MOL FLASK COREX SPA IRQ FINNE OHDEA2 KJAX\" readonly>";
					result += "<br/>MXE/West via HVQ<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KPHL MXE PENSY J110 FLIRT J6 HVQ J85 SPA IRQ FINNE OHDEA2 KJAX\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPHL OOD GROUT SBY ORF ISO ILM CHS SAV KJAX\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-02-2025
					result += "<!-- Verified with ATCSCC on 03-02-2025 -->";
					result += "<br/>48<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL STOEN REEFI EMI J48 MOL FLASK COREX SPA IRQ FINNE OHDEA2 KJAX\" readonly>";
					result += "<br/>75<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL STOEN Q75 GSO Q83 WURFL ESENT LUNNI2 KJAX\" readonly>";
					result += "<br/>80<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL MXE PENSY J110 AIR HVQ J85 SPA IRQ FINNE OHDEA2 KJAX\" readonly>";
					result += "<br/>J6<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL MXE PENSY J110 FLIRT J6 HVQ J85 SPA IRQ FINNE OHDEA2 KJAX\" readonly>";
					result += "<br/>PH<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPHL OOD TEBEE HAYDO TRPOD Q409 SESUE ESENT LUNNI2 KJAX\" readonly>";
					break;
		...
		case "PIT":
			switch(arvl) {
				...
				case "PHL": // Updated 05-27-2025
					...
					break;
				case "LAX": // Updated 08-25-2025
					result += "<!-- Updated 08-25-2025 P -->";
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA pref route as of 08-25-2025
					result += "<br/><br/>NRP: <input style=\"width:75%\"; value=\"KPIT AIR J80 MCI J24 SLN J102 ALS J44 RSK J64 TBC JASSE Q90 DNERO ANJLL4 KLAX\" readonly>";
					result += "<br/>ZKC Avoid: <input style=\"width:75%\"; value=\"KPIT EWC J64 FWA WHETT DARCY EDENS LMN PWE HLC J64 TBC JASSE Q90 DNERO ANJLL4 KLAX\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KPIT APE ROD JOT J60 IOW LEONG Q114 AYOLE SNY J100 EKR KIMMR Q96 GUNTR LAKRR Q88 HAKMN ANJLL4 KLAX\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KPIT AIR J80 VHP J110 STL J134 ICT J26 ELP J50 SSO J4 WLVRN ESTWD HLYWD1 KLAX\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-25-2025
					result += "<!-- Verified with ATCSCC on 08-25-2025 -->";
					result += "<br/>N1<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPIT EWC ERI SVM J70 PMM OBK IOW J60 HVE PROMT Q88 HAKMN ANJLL4 KLAX\" readonly>";
					result += "<br/>P1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPIT BSV MAYZE CPONE JOT J60 HVE PROMT Q88 HAKMN ANJLL4 KLAX\" readonly>";
					result += "<br/>S1<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPIT AHTIY BURGS HNN BICKS Q176 BUM J110 RSK J64 TBC JASSE Q90 DNERO ANJLL4 KLAX\" readonly>";
					break;
				case "PHX": // Updated 01-17-2025
					result += "<!-- Updated 01-17-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
		...
		case "PNS":
			switch(arvl) {
				...
				case "DFW": // Updated 01-17-2025
					...
					result += "<br/><br/>North: <input style=\"width:75%\" value=\"KPNS MEI SQS FEWWW SEEVR4 KDFW\" readonly>";
		...
		case "PSP":
			switch(arvl) {
				case "DFW": // Updated 01-17-2025
					result += "<!-- Updated 01-17-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPSP CATH1 PSP V137 TRM BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
		...
		case "PWM":
			switch(arvl) {
				case "CLT": // Updated 08-22-2025
					...
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KPWM NUBLE4 NELIE Q75 GVE AIROW CHSLY6 KCLT\" readonly>"; // CDR PJ
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPWM NUBLE4 CCC Q97 SAWED GUILD Q409 OKNEE MLLET3 KCLT\" readonly>"; // CDR T7
					result += "<br/>West/ZDC Avoid<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPWM HSKEL3 BAUER HNK J49 PSB HACKS HVQ LNDIZ PARQR4 KCLT\" readonly>"; // CDR N4
					result += "<br/><br/>NE TO ATL CLT<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPWM HSKEL3 BAUER HNK J49 PSB HACKS HVQ LNDIZ PARQR4 KCLT\" readonly>";
					result += "<br/>NO Q75 3<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPWM HSKEL3 CAM Q822 GONZZ Q29 JHW FOXEE Q145 HVQ LNDIZ PARQR4 KCLT\" readonly>";
					result += "<br/>ZBW VIA HTO ESCAPE<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KPWM NUBLE4 CCC Q97 SAWED GUILD Q409 OKNEE MLLET3 KCLT\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KPWM CAM ALB BIZEX Q75 GVE LYH MAJIC4 KCLT\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 08-22-2025
					result += "<!-- Verified with ATCSCC on 08-22-2025 -->";
					result += "<br/>29<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPWM HSKEL3 CAM Q822 GONZZ Q29 JHW FOXEE Q145 HVQ LNDIZ PARQR4 KCLT\" readonly>";
					result += "<br/>A4<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPWM NUBLE4 BAF Q448 PTW J48 CSN GVE AIROW CHSLY6 KCLT\" readonly>";
					result += "<br/>AB<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPWM HSKEL3 BAUER ALB BIZEX Q75 GVE AIROW CHSLY6 KCLT\" readonly>";
					result += "<br/>N4<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KPWM HSKEL3 BAUER HNK J49 PSB HACKS HVQ LNDIZ PARQR4 KCLT\" readonly>";
		...
		case "RDU":
			switch(arvl) {
				...
				case "DCA": // Updated 07-20-2025
					result += "<!-- Updated 07-20-2025 MP -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KRDU BEXGO5 BOUSY WAVES CAPSS3 KDCA\" readonly>"; // CDR 00
					result += "<br/><br/>East<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KRDU HURIC4 FEBEL ORF TRPOD T335 LAFLN DEALE3 KDCA\" readonly>"; // CDR HR
					result += "<br/>West<span style=\"color:red\"> (Coord Req)</span>: <input style=\"width:75%\" value=\"KRDU LWOOD5 DBRAH DEBZZ TRUPS5 KDCA\" readonly>"; // CDR LW
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-20-2025
					result += "<!-- Verified with ATCSCC on 07-20-2025 -->";
					result += "<br/>00<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KRDU BEXGO5 BOUSY WAVES CAPSS3 KDCA\" readonly>";
					result += "<br/>HR<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KRDU HURIC4 FEBEL ORF TRPOD T335 LAFLN DEALE3 KDCA\" readonly>";
					result += "<br/>LW<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KRDU LWOOD5 DBRAH DEBZZ TRUPS5 KDCA\" readonly>";
					result += "<br/>SH<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KRDU SHPRD4 SHPRD CLAWD SITTR TRUPS5 KDCA\" readonly>";
					result += "<br/>XF<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KRDU OXFRD5 CARML WAVES CAPSS3 KDCA\" readonly>";
					break;
				case "DFW": // Updated 01-17-2025
					result += "<!-- Updated 01-17-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
...
// RST skipped
		...
		case "SAN":
			switch(arvl) {
				case "CLT": // Updated 03-17-2025
					...
					result += "<br/>North: <input style=\"width:75%\" value=\"KSAN ZZOOO4 MTBAL EED J236 TBC J64 RSK J110 BUM J112 FAM TINGS RAMRD SKYWA FILPZ4 KCLT\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 03-17-2025
					result += "<!-- Verified with ATCSCC on 03-17-2025 -->";
					result += "<br/>NF<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 GBN J50 SSO EWM J66 ABI J4 FUZ UIM ELD IZAAC Q30 VLKNN THRSR BESTT JONZE5 KCLT\" readonly>";
					result += "<br/>NJ<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 TGOLD PXR J18 ABQ J6 IRW FSM MEMFS Q34 HITMN TAZZA FILPZ4 KCLT\" readonly>";
					break;
				case "DFW": // Updated 05-29-2025
					...
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 05-29-2025
					result += "<!-- Verified with ATCSCC on 05-29-2025 -->";
					result += "<br/>DG<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 GBN J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>JE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 GBN J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>JU<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 GBN J50 ELP FST JCT GUTZZ BOOVE7 KDFW\" readonly>";
				...
				case "ORD": // Updated 07-29-2025
					...
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-29-2025
					result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KSAN ZZOOO4 TGOLD PXR J18 SLN J96 IRK BENKY6 KORD\" readonly>"; // CDR JV
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSAN ZZOOO4 MTBAL CADEZ HAKMN Q73 LAKRR Q88 PROMT EKR BFF J94 ONL FOD MYRRS FYTTE7 KORD\" readonly>"; // CDR F2
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSAN ZZOOO4 TGOLD PXR J18 ABQ J6 IRW J98 SGF WELTS TRTLL6 KORD\" readonly>"; // CDR F1
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSAN BRDR7 IPL J18 GBN J18 SLN J96 IRK BDF8 KORD\" readonly>";
					result += "<br/><br/><b>CDRS</b>"; // Verified with ATCSCC on 07-29-2025
					result += "<!-- Verified with ATCSCC on 07-29-2025 -->";
					result += "<br/>F1<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 TGOLD PXR J18 ABQ J6 IRW J98 SGF WELTS TRTLL6 KORD\" readonly>";
					result += "<br/>F2<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 MTBAL CADEZ HAKMN Q73 LAKRR Q88 PROMT EKR BFF J94 ONL FOD MYRRS FYTTE7 KORD\" readonly>";
					result += "<br/>JB<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 MTBAL CADEZ HAKMN Q73 LAKRR Q88 PROMT EKR BFF J94 ONL J114 GEP DLL MSN JAKSA MOOPS FYTTE FYTTE7 KORD\" readonly>";
					result += "<br/>JV<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 TGOLD PXR J18 SLN J96 IRK BENKY6 KORD\" readonly>";
					result += "<br/>JW<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAN ZZOOO4 MTBAL CADEZ HAKMN Q73 LAKRR Q88 PROMT EKR BFF J94 ONL J114 GEP TVC WYNDE2 KORD\" readonly>";
					break;
				case "PHL": // Updated 07-08-2025
		...
		case "SAT":
			switch(arvl) {
				...
				case "DFW": // Updated 06-29-2025
					...
					result += "<br/>0N<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 YODUH GUTZZ BOOVE7 KDFW\" readonly>";
				...
				case "ORD": // Updated 06-17-2025
					...
					result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH J101 LIT J180 FTZ TRTLL6 KORD\" readonly>";
				...
				case "PHL": // Updated 07-26-2025
					result += "<!-- Updated 07-26-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH J101 LFK SUTTN J29 CARIN MEMFS Q34 GVE PAATS4 KPHL\" readonly>"; // CDR 0B
					result += "<br/><b>For north dptr: <input style=\"width:19em\" value=\"KSAT YODUH1 KLNGR FUZ J42 TXK Q34\" readonly> ...<\/b>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH J101 LFK SUTTN J29 CARIN MEMFS Q29 CREEP BLISS J152 JST BOJID4 KPHL\" readonly>"; // CDR 0F
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSAT SNIDR1 MOLLR Q56 CATLN Q22 BEARI BBDOL PAATS4 KPHL\" readonly>"; // CDR 0M
					// result += "<br/>TXK/MEM<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ J42 TXK Q34 GVE PAATS4 KPHL\" readonly>"; // CDR 1B
					...
					result += "<br/>0B<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH J101 LFK SUTTN J29 CARIN MEMFS Q34 GVE PAATS4 KPHL\" readonly>";
					result += "<br/>0C<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 MOLLR Q56 SJI J2 CEW ALLMA TEEEM Q99 PEETT BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>0D<span style=\"color:red\"> (Coord Req)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ TUL J87 JOT J30 TRAKK J152 JST BOJID4 KPHL\" readonly>";
					result += "<br/>0E<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ TUL J87 JOT J146 WOOST J34 DJB EWC JST BOJID4 KPHL\" readonly>";
					result += "<br/>0F<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH J101 LFK SUTTN J29 CARIN MEMFS Q29 CREEP BLISS J152 JST BOJID4 KPHL\" readonly>";
					result += "<br/>0G<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 MOLLR Q56 CATLN FRDDO NOKIE TWINS BLAAN Q99 PEETT BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>0M<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 MOLLR Q56 CATLN Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>0T<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ MLC RZC STL VHP RINTE JST BOJID4 KPHL\" readonly>";
					result += "<br/>0V<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 MOLLR Q56 CATLN Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>1B<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ J42 TXK Q34 GVE PAATS4 KPHL\" readonly>";
					result += "<br/>1F<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ J42 TXK Q34 MEMFS Q29 CREEP BLISS J152 JST BOJID4 KPHL\" readonly>";
					result += "<br/>1G<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ Q184 ARNNY FRDDO TWOUP Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>1M<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ Q184 ARNNY FRDDO TWOUP Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>1V<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ TXK IZAAC Q30 VLKNN THRSR TWOUP Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>1X<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT YODUH1 KLNGR FUZ J42 TXK Q34 GVE PAATS4 KPHL\" readonly>";
					result += "<br/>3E<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS WYLSN BYP TUL J87 JOT J146 WOOST J34 DJB EWC JST BOJID4 KPHL\" readonly>";
					result += "<br/>3X<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SNIDR1 BLUMS IAH J101 LFK SUTTN J29 CARIN MEMFS Q34 GVE PAATS4 KPHL\" readonly>";
					result += "<br/>5B<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SLENA1 BRENI PSX J29 CARIN MEMFS Q34 GVE PAATS4 KPHL\" readonly>";
					result += "<br/>5F<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SLENA1 BRENI PSX J29 CARIN MEMFS Q29 CREEP BLISS J152 JST BOJID4 KPHL\" readonly>";
					result += "<br/>5G<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SLENA1 BRENI PSX SBIRD HRV Q56 CATLN Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
					result += "<br/>5M<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSAT SLENA1 BRENI PSX SBIRD HRV Q56 CATLN Q22 BEARI BBDOL PAATS4 KPHL\" readonly>";
		...
		case "SBA":
			switch(arvl) {
				case "DFW": // Updated 08-23-2025
					...
					result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSBA MISHN4 SXC TRM BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSBA MISHN4 NNAVY PGS J64 RSK CIM PNH MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "PHX": // Updated 05-16-2025
					...
					// result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSBA MISHN4 BOILE BLH HYDRR1 KPHX\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSBA MISHN4 NNAVY WOTRO BRUSR1 KPHX\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSBA MISHN4 SXC CARDI IPL J2 HOGGZ HYDRR1 KPHX\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "SBP":
			switch(arvl) {
				case "DFW": // Updated 05-18-2025
					...
					break;
				case "PHX": // Updated 07-28-2025
					result += "<!-- Updated 07-28-2025 MP -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSBP DERBB MARIC PMD J65 BLH HYDRR1 KPHX\" readonly>";
					result += "<br/><br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSBP WYNNR4 RZS J126 LAX J78 SLI WESIN JLI AMMOR IPL J2 HOGGZ HYDRR1 KPHX\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // toddo
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 07-28-2025
					break;
			}
		break; // End of SBP
		...
		case "SEA":
			switch(arvl) {
				case "CLT": // Updated 08-23-2025
					result += "<!-- Updated 08-23-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSEA MONTN2 SEA NORMY J90 HLN HEXOL Q156 ZZIPR DBQ RBS VHP J24 FLM TAFTT PARQR4 KCLT\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSEA MONTN2 SEA ZADON Q144 LEWIT Q140 WISCN GRB VIO J34 DJB J85 HVQ LNDIZ PARQR4 KCLT\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSEA SUMMA2 SUMMA PDT J20 DNJ J82 DBS BOY DDY BFF LBF KP60C MCI FAM BNA TAZZA FILPZ4 KCLT\" readonly>";
					result += "<br/><br/>South/Avoid ZLC<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSEA SUMMA2 LKV J5 FMG J92 BLD J72 ABQ J6 IRW ARG J46 BNA TAZZA FILPZ4 KCLT\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
				...
				case "DFW": // Updated 01-18-2025
					result += "<!-- Updated 01-18-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSEA SUMMA2 SUMMA J54 BOI J15 JNC ALS PNH MDANO VKTRY2 KDFW\" readonly>";
				...
				case "ORD": // Updated 07-27-2025
					result += "<!-- Updated 07-27-2025 P -->"
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-27-2025
					result += "<br/><br/>NRP: <input style=\"width:75%\"; value=\"KSEA MONTN2 SEA NORMY J90 HLN J34 BIL J16 FSD ZZIPR FYTTE7 KORD\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSEA MONTN2 SEA NORMY J70 DIK J36 GEP J70 BAE LYNNI ERNNY8 KORD\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSEA SUMMA2 SUMMA J54 BKE PIH J20 FQF J80 MCI J26 IRK BENKY6 KORD \" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KSEA MONTN2 SEA NORMY J90 MLS J204 DPR J16 MCW JVL1 KORD\" readonly>";
					// result += "<br/><br/><b>CDRS</b>";  // No CDRs as of 07-27-2025
					break; 
				case "PHL": // Updated 07-17-2025
					...
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KSEA MONTN2 SEA NORMY J90 MWH J34 DJB PSB BUNTS3 KPHL\" readonly>";
					// result += "<br/><br/><b>CDRS</b>";  // No CDRs as of 07-17-2025
					break;
			}
		break; // End of SEA
		...
		case "SFO":
			switch(arvl) {
				...
				case "DFW": // Updated 07-29-2025
					...
					result += "<br/><b>After 2200L use NIITE4 dptr: KSFO NIITE4 SYRAH...<\/b>";
				...
				case "JFK": // Updated 08-28-2025
					...
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 MOGEE Q122 ONL KATES DBQ KG75M DAFLU J70 LVZ LENDY8 KJFK \" readonly>";
					...
					result += "<br/><br/>North via GEP<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 ORRCA Q120 PROXI BOY J32 DPR ABR GEP DLL HASTE DAFLU JHW J70 LVZ LENDY8 KJFK \" readonly>";
					...
					result += "<br/><br/>BAE<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 ORRCA Q120 UFFDA RWF J34 BAE SVM J70 LVZ LENDY8 KJFK \" readonly>";
					result += "<br/>BAE-2<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 ORRCA Q120 JASTI FSD J16 BAE J70 LVZ LENDY8 KJFK \" readonly>";
					result += "<br/>JOT<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 TIPRE Q126 BRAFF HCT LNK J146 GIJ J554 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>ICT<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 SYRAH JSICA MLF J28 ICT J134 STL VHP ROD KLYNE Q29 JHW J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>PUB<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 SYRAH Q128 FLOOD PUB J64 HLC PWE LMN MZV JOT ELX SVM J70 LVZ LENDY8 KJFK\" readonly>";
					result += "<br/>SPI<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSFO TRUKN2 TIPRE Q126 BRAFF AKO PWE UIN SPI KOLTS WWODD RINTE KLYNE Q29 WWSHR JHW J70 LVZ LENDY8 KJFK \" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KSFO LIN J84 EKR AKO PWE UIN SPI VHP ROD DJB JHW J70 LVZ LENDY8 KJFK\" readonly>";
...
// SHV skipped
		...
		case "SLC":
			switch(arvl) {
				case "CLT": // Updated 07-20-2025
					...
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSLC RUGGD3 KIERA BONGO Q154 NOSEW IRW ARG J46 BNA TAZZA FILPZ4 KCLT\" readonly>";
		...
		case "SMF":
			switch(arvl) {
				...
				case "DFW": // Updated 07-27-2025
					result += "<!-- Updated 07-27-2025 P -->";
					// result += "<br/><br/><b>Faa Pref Route:</b>"; // No FAA Pref route as of 07-27-2025
					result += "<br/><br/>NRP: <input style=\"width:75%\" value=\"KSMF RVRCT4 RALEY KITTN Q164 ROCCY Q130 PNH MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSMF RVRCT4 MACUS Q124 BVL J154 TCH BONGO Q154 NOSEW MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSMF FTHIL3 FRA EHF J65 DECAS BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "SNA":
			switch(arvl) {
				case "CLT": // Updated 01-18-2025
					...
					break;
				case "DFW": // Updated 09-06-2025
					result += "<!-- Updated 09-06-2025 P -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSNA PIGGN3 CNERY BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSNA PIGGN3 AVRRY LANCY J78 ABQ J72 TXO TURKI VKTRY2 KDFW\" readonly>"; // CDR UK
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSNA PIGGN3 TCATE IPL J2 GBN J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>"; // CDR SE
					// result += "<br/>Weekend/Holiday: <input style=\"width:75%\" value=\"KSNA PIGGN3 CNERY BLH WLVRN KA24Q JETOS TURKI VKTRY2 KDFW\" readonly>";
					result += "<br/><br/>North via ALS<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSNA PIGGN3 AVRRY LANCY J78 DRK RSK J110 ALS TBE EZEEE MDANO VKTRY2 KDFW\" readonly>";
					result += "<br/>South via JCT<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSNA PIGGN3 TCATE IPL J2 GBN J50 ELP FST JCT GUTZZ BOOVE7 KDFW\" readonly>"; // CDR JU
					result += "<br/><br/><b>Non RNAV</b>";
					...
					result += "<br/>JE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>JU<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 ELP FST JCT GUTZZ BOOVE7 KDFW\" readonly>";
					result += "<br/>ME<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH J169 TFD J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>SE<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA TCATE IPL J2 GBN J50 SSO J4 INK GEEKY BOOVE7 KDFW\" readonly>";
					result += "<br/>TN<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA CNERY BLH TFD J50 ELP J86 JCT CWK TNV STUFT BEREE3 KDFW\" readonly>";
					result += "<br/>UK<span style=\"color:green\"> (Ok to File)</span>: <input class=\"cdr_input\" style=\"width:75%\" value=\"KSNA AVRRY LANCY ABQ J72 TXO TURKI VKTRY2 KDFW\" readonly>";
					break;
		...
		case "SRQ":
			switch(arvl) {
				case "CLT": // Updated 07-20-2025
					result += "<!-- Updated 07-20-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSRQ TIDES1 CAMJO TWINS PONZE BANKR5 KCLT\" readonly>";
					result += "<br/><br/>East<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSRQ SRQ6 LAL ZERBO Q87 VIYAP Q69 ISUZO SAV FLO RASLN3 KCLT\" readonly>";
					result += "<br/>West<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSRQ TIDES1 MOMIE BRUTS Q118 JOHNN BESTT JONZE5 KCLT\" readonly>";
					result += "<br/><br/>East/OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSRQ SRQ6 LAL ORL AR6 HIBAC BAHAA Y289 OGGRE OKNEE MLLET3 KCLT\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSRQ SRQ6 LAL CRG SAV FLO RASLN3 KCLT\" readonly>";
					// result += "<br/><br/><b>CDRS</b>"; // No CDRs as of 07-20-2025
					break;
				case "DFW": // Updated 07-20-2025
					result += "<!-- Updated 07-20-2025 -->";
					...
					result += "<br/><br/>Non OW<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSRQ TIDES1 MOMIE PATOY Q116 JAWJA CABLO DEFUN J2 CEW J50 MCB AEX PNUTS BEREE3 KDFW\" readonly>";
					result += "<br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSRQ TIDES1 MOMIE PATOY Q116 VLKNN YAALL J14 LIT MEEOW FEWWW SEEVR4 KDFW\" readonly>";
					result += "<br/>South via IAH<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSRQ TIDES1 FROOT ROZZI Y280 REDFN BOWFN VUH IAH CRIED BEREE3 KDFW\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
		...
		case "STL":
			switch(arvl) {
				...
				case "DFW": // Updated 01-19-2025
					result += "<!-- Updated 01-19-2025 -->";
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\" value=\"KSTL JAHNY6 MAP RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/><br/>West: <input style=\"width:75%\" value=\"KSTL BRAKK5 HLV BUM ICT HOFFF VKTRY2 KDFW\" readonly>";
					...
					result += "<br/><br/><b>CDRS</b>";
					result += "<br/>LY (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSTL JAHNY6 MAP RZC FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>PL (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSTL CHUUC6 ARG FSM RRNET SEEVR4 KDFW\" readonly>";
					result += "<br/>ZA (Ok to File): <input class=\"cdr_input\" style=\"width:75%\" value=\"KSTL BRAKK5 HLV BUM HITUG SEEVR4 KDFW\" readonly>";
					break;
				case "LAX": // Updated 01-19-2025
					...
					break;
				case "LGA": // Updated 09-06-2025
					result += "<!-- Updated 09-06-2025 P -->"
					result += "<br/><br/><b>Faa Pref Route:</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KSTL GATWY1 ROD KLYNE Q29 WWSHR TEESY J146 ETG MIP4 KLGA\" readonly>";
					result += "<br/><br/>North<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSTL NATCA5 SPI JOT J146 ETG MIP4 KLGA \" readonly>";
					result += "<br/>South<span style=\"color:green\"> (Ok to File)</span>: <input style=\"width:75%\" value=\"KSTL TEDDD5 IIU Q108 SITTR Q34 GVE PROUD2 KLGA\" readonly>";
					// result += "<br/><br/><b>Non RNAV</b>"; // TODDO
		...
		case "STS":
			switch(arvl) {
				case "DFW": // Updated 05-30-2025
					...
					result += "<br/><br/>North: <input style=\"width:75%\"; value=\"KSTS CHRRO1 RALEY JSICA MLF J28 PUB J17 PNH MDANO VKTRY2 KDFW\" readonly>";
		...
		case "SYR":
			...
			case "DFW": // Updated 01-19-2025
				...
				case "LGA": // Updated 09-06-2025
					...
					result += "<br/><input style=\"width:75%\"; value=\"KSYR RKA HAARP4 KLGA\" readonly>";
					result += "<br/><br/><b>Non RNAV</b>";
					result += "<br/><input style=\"width:75%\"; value=\"KSYR SYR J63 HUO KLGA\" readonly>";
					break;
			}
		break; // End of SYR
		...
		case "YYZ":
			switch(arvl) {
				...
				case "DFW": // Updated 04-14-2025
					...
					result += "<br/><br/>North/HARP: <input style=\"width:75%\"; value=\"CYYZ MIXUT7 GNTRY CRL J554 GIJ SPI RZC FSM RRNET SEEVR4 KDFW\" readonly>";
