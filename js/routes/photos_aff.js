get_actions_photos_aff = function (a = [], d = 3, g = 300, is_sunny = 1) {
	...
	if (is_festival(d) || d == 175) {
		...
		if (is_sunny == 1 && (dow == "MON" || (d % 120 > 30 && d % 120 < 41))) {
			// MARIA
		...
		// Dog Karen to Pink
		if (d > 29 && aff[karen_id] < _PHOTO_MIN) {
			if (is_sunny == 1) {
